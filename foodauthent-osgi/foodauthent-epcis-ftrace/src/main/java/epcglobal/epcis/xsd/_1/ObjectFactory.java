...
public class ObjectFactory {
    ...
    private final static QName _IlmdType_QNAME = new QName("urn:epcglobal:epcis:xsd:1", "ilmdType");
    private final static QName _EPCISDocument_QNAME = new QName("urn:epcglobal:epcis:xsd:1", "EPCISDocument");
    private final static QName _EpcisDocumentType_QNAME = new QName("urn:epcglobal:epcis:xsd:1", "epcisDocumentType");
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ILMDType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "urn:epcglobal:epcis:xsd:1", name = "ilmdType")
    public JAXBElement<ILMDType> createIlmdType(ILMDType value) {
        return new JAXBElement<ILMDType>(_IlmdType_QNAME, ILMDType.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:epcglobal:epcis:xsd:1", name = "epcisDocumentType")
    public JAXBElement<EPCISDocumentType> createEpcisDocumentType(EPCISDocumentType value) {
        return new JAXBElement<EPCISDocumentType>(_EpcisDocumentType_QNAME, EPCISDocumentType.class, null, value);
    }
