...
import org.foodauthent.oneworldsync.client.model.MarketingInformationModule;
import org.foodauthent.oneworldsync.client.model.Recipient;

/**
 * MarketingInformationModuleGroup
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-07-25T20:10:55.785Z")
public class MarketingInformationModuleGroup {
	@JsonProperty("marketingInformationModule")
	private MarketingInformationModule marketingInformationModule = null;

	@JsonProperty("recipient")
	private Recipient recipient = null;

	public MarketingInformationModuleGroup marketingInformationModule(
	...
	/**
	 * Get marketingInformationModule
	 * 
	...
	public MarketingInformationModuleGroup recipient(Recipient recipient) {
	...
	public boolean equals(java.lang.Object o) {
		...
		MarketingInformationModuleGroup marketingInformationModuleGroup = (MarketingInformationModuleGroup) o;
		return Objects.equals(this.marketingInformationModule,
				marketingInformationModuleGroup.marketingInformationModule)
				&& Objects.equals(this.recipient, marketingInformationModuleGroup.recipient);
	}

	@Override
	public int hashCode() {
		return Objects.hash(marketingInformationModule, recipient);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class MarketingInformationModuleGroup {\n");

		sb.append("    marketingInformationModule: ").append(toIndentedString(marketingInformationModule)).append("\n");
