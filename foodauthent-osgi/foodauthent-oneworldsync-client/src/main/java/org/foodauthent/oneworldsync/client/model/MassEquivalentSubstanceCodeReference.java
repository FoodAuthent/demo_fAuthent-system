...
public class MassEquivalentSubstanceCodeReference {
	...
	@JsonProperty("massEquivalentSubstanceCodeReferenceValue")
	private String massEquivalentSubstanceCodeReferenceValue = null;

	public MassEquivalentSubstanceCodeReference codeDescription(String codeDescription) {
	...
	public MassEquivalentSubstanceCodeReference codeListAgencyCode(String codeListAgencyCode) {
	...
	public MassEquivalentSubstanceCodeReference codeListAgencyCodeListVersion(String codeListAgencyCodeListVersion) {
	...
	public MassEquivalentSubstanceCodeReference codeListAgencyName(String codeListAgencyName) {
	...
	public MassEquivalentSubstanceCodeReference codeListName(String codeListName) {
	...
	public MassEquivalentSubstanceCodeReference codeListURI(String codeListURI) {
	...
	public MassEquivalentSubstanceCodeReference codeListVersion(String codeListVersion) {
	...
	public MassEquivalentSubstanceCodeReference massEquivalentSubstanceCodeReferenceValue(
			String massEquivalentSubstanceCodeReferenceValue) {
		this.massEquivalentSubstanceCodeReferenceValue = massEquivalentSubstanceCodeReferenceValue;
		return this;
	}

	/**
	 * Get massEquivalentSubstanceCodeReferenceValue
	 * 
	 * @return massEquivalentSubstanceCodeReferenceValue
	 **/
	@ApiModelProperty(value = "")
	public String getMassEquivalentSubstanceCodeReferenceValue() {
		return massEquivalentSubstanceCodeReferenceValue;
	}

	public void setMassEquivalentSubstanceCodeReferenceValue(String massEquivalentSubstanceCodeReferenceValue) {
		this.massEquivalentSubstanceCodeReferenceValue = massEquivalentSubstanceCodeReferenceValue;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		MassEquivalentSubstanceCodeReference massEquivalentSubstanceCodeReference = (MassEquivalentSubstanceCodeReference) o;
		return Objects.equals(this.codeDescription, massEquivalentSubstanceCodeReference.codeDescription)
				&& Objects.equals(this.codeListAgencyCode, massEquivalentSubstanceCodeReference.codeListAgencyCode)
				&& Objects.equals(this.codeListAgencyCodeListVersion,
						massEquivalentSubstanceCodeReference.codeListAgencyCodeListVersion)
				&& Objects.equals(this.codeListAgencyName, massEquivalentSubstanceCodeReference.codeListAgencyName)
				&& Objects.equals(this.codeListName, massEquivalentSubstanceCodeReference.codeListName)
				&& Objects.equals(this.codeListURI, massEquivalentSubstanceCodeReference.codeListURI)
				&& Objects.equals(this.codeListVersion, massEquivalentSubstanceCodeReference.codeListVersion)
				&& Objects.equals(this.massEquivalentSubstanceCodeReferenceValue,
						massEquivalentSubstanceCodeReference.massEquivalentSubstanceCodeReferenceValue);
	}

	@Override
	public int hashCode() {
		return Objects.hash(codeDescription, codeListAgencyCode, codeListAgencyCodeListVersion, codeListAgencyName,
				codeListName, codeListURI, codeListVersion, massEquivalentSubstanceCodeReferenceValue);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class MassEquivalentSubstanceCodeReference {\n");
		...
		sb.append("    massEquivalentSubstanceCodeReferenceValue: ")
				.append(toIndentedString(massEquivalentSubstanceCodeReferenceValue)).append("\n");
		sb.append("}");
		return sb.toString();
	}
