...
public class PHInformation {
	@JsonProperty("exactPH")
	private String exactPH = null;

	@JsonProperty("maximumPH")
	private String maximumPH = null;

	@JsonProperty("minimumPH")
	private String minimumPH = null;

	public PHInformation exactPH(String exactPH) {
		this.exactPH = exactPH;
		return this;
	}
	...
	public String getExactPH() {
		return exactPH;
	}

	public void setExactPH(String exactPH) {
		this.exactPH = exactPH;
	}

	public PHInformation maximumPH(String maximumPH) {
	 ...
	 **/
	@ApiModelProperty(value = "")
	public String getMaximumPH() {
		return maximumPH;
	}

	public void setMaximumPH(String maximumPH) {
		this.maximumPH = maximumPH;
	}

	public PHInformation minimumPH(String minimumPH) {
	 ...
	 **/
	@ApiModelProperty(value = "")
	public String getMinimumPH() {
		return minimumPH;
	}

	public void setMinimumPH(String minimumPH) {
		this.minimumPH = minimumPH;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		PHInformation pHInformation = (PHInformation) o;
		return Objects.equals(this.exactPH, pHInformation.exactPH)
				&& Objects.equals(this.maximumPH, pHInformation.maximumPH)
				&& Objects.equals(this.minimumPH, pHInformation.minimumPH);
	}

	@Override
	public int hashCode() {
		return Objects.hash(exactPH, maximumPH, minimumPH);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class PHInformation {\n");

		sb.append("    exactPH: ").append(toIndentedString(exactPH)).append("\n");
		sb.append("    maximumPH: ").append(toIndentedString(maximumPH)).append("\n");
		sb.append("    minimumPH: ").append(toIndentedString(minimumPH)).append("\n");
		sb.append("}");
		return sb.toString();
	}
