...
import org.foodauthent.oneworldsync.client.model.AudioVisualMediaProductionInformation;

/**
 * AudioVisualMediaProductionInformationModule
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-07-25T20:10:55.785Z")
public class AudioVisualMediaProductionInformationModule {
	@JsonProperty("audioVisualMediaProductionInformation")
	private AudioVisualMediaProductionInformation audioVisualMediaProductionInformation = null;

	public AudioVisualMediaProductionInformationModule audioVisualMediaProductionInformation(
			AudioVisualMediaProductionInformation audioVisualMediaProductionInformation) {
		this.audioVisualMediaProductionInformation = audioVisualMediaProductionInformation;
		return this;
	}

	/**
	 * Get audioVisualMediaProductionInformation
	 * 
	 * @return audioVisualMediaProductionInformation
	 **/
	@ApiModelProperty(value = "")
	public AudioVisualMediaProductionInformation getAudioVisualMediaProductionInformation() {
		return audioVisualMediaProductionInformation;
	}

	public void setAudioVisualMediaProductionInformation(
			AudioVisualMediaProductionInformation audioVisualMediaProductionInformation) {
		this.audioVisualMediaProductionInformation = audioVisualMediaProductionInformation;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		AudioVisualMediaProductionInformationModule audioVisualMediaProductionInformationModule = (AudioVisualMediaProductionInformationModule) o;
		return Objects.equals(this.audioVisualMediaProductionInformation,
				audioVisualMediaProductionInformationModule.audioVisualMediaProductionInformation);
	}

	@Override
	public int hashCode() {
		return Objects.hash(audioVisualMediaProductionInformation);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class AudioVisualMediaProductionInformationModule {\n");

		sb.append("    audioVisualMediaProductionInformation: ")
				.append(toIndentedString(audioVisualMediaProductionInformation)).append("\n");
		sb.append("}");
		return sb.toString();
	}
