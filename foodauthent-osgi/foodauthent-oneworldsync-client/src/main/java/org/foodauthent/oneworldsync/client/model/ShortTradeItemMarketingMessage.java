...
public class ShortTradeItemMarketingMessage {
	...
	private LanguageLabels shortTradeItemMarketingMessage = null;

	public ShortTradeItemMarketingMessage formattingPattern(String formattingPattern) {
	...
	public ShortTradeItemMarketingMessage sequenceNumber(String sequenceNumber) {
	...
	public ShortTradeItemMarketingMessage shortTradeItemMarketingMessage(
			LanguageLabels shortTradeItemMarketingMessage) {
	 ...
	 **/
	@ApiModelProperty(value = "")
	public LanguageLabels getShortTradeItemMarketingMessage() {
		return shortTradeItemMarketingMessage;
	}

	public void setShortTradeItemMarketingMessage(LanguageLabels shortTradeItemMarketingMessage) {
		this.shortTradeItemMarketingMessage = shortTradeItemMarketingMessage;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		ShortTradeItemMarketingMessage shortTradeItemMarketingMessage = (ShortTradeItemMarketingMessage) o;
		return Objects.equals(this.formattingPattern, shortTradeItemMarketingMessage.formattingPattern)
				&& Objects.equals(this.sequenceNumber, shortTradeItemMarketingMessage.sequenceNumber)
				&& Objects.equals(this.shortTradeItemMarketingMessage,
						shortTradeItemMarketingMessage.shortTradeItemMarketingMessage);
	}

	@Override
	public int hashCode() {
		return Objects.hash(formattingPattern, sequenceNumber, shortTradeItemMarketingMessage);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class ShortTradeItemMarketingMessage {\n");
