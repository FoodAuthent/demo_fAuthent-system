...
import org.foodauthent.oneworldsync.client.model.ProductCharacteristics;
...
public class ProductCharacteristicsModule {
	...
	private List<ProductCharacteristics> productCharacteristics = null;

	public ProductCharacteristicsModule productCharacteristics(List<ProductCharacteristics> productCharacteristics) {
		this.productCharacteristics = productCharacteristics;
		return this;
	}

	public ProductCharacteristicsModule addProductCharacteristicsItem(
			ProductCharacteristics productCharacteristicsItem) {
		if (this.productCharacteristics == null) {
			this.productCharacteristics = new ArrayList<ProductCharacteristics>();
		}
	...
	public void setProductCharacteristics(List<ProductCharacteristics> productCharacteristics) {
		this.productCharacteristics = productCharacteristics;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		ProductCharacteristicsModule productCharacteristicsModule = (ProductCharacteristicsModule) o;
		return Objects.equals(this.productCharacteristics, productCharacteristicsModule.productCharacteristics);
	}

	@Override
	public int hashCode() {
		return Objects.hash(productCharacteristics);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class ProductCharacteristicsModule {\n");
