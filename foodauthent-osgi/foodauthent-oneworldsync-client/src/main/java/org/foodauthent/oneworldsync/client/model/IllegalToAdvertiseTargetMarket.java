...
public class IllegalToAdvertiseTargetMarket {
	@JsonProperty("targetMarketCountryCode")
	private CodifiedValue targetMarketCountryCode = null;

	@JsonProperty("targetMarketSubdivisionCode")
	private String targetMarketSubdivisionCode = null;

	public IllegalToAdvertiseTargetMarket targetMarketCountryCode(CodifiedValue targetMarketCountryCode) {
		this.targetMarketCountryCode = targetMarketCountryCode;
		return this;
	}

	/**
	 * Get targetMarketCountryCode
	 * 
	 * @return targetMarketCountryCode
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getTargetMarketCountryCode() {
		return targetMarketCountryCode;
	}

	public void setTargetMarketCountryCode(CodifiedValue targetMarketCountryCode) {
		this.targetMarketCountryCode = targetMarketCountryCode;
	}

	public IllegalToAdvertiseTargetMarket targetMarketSubdivisionCode(String targetMarketSubdivisionCode) {
		this.targetMarketSubdivisionCode = targetMarketSubdivisionCode;
		return this;
	}

	/**
	 * Get targetMarketSubdivisionCode
	 * 
	...
	public void setTargetMarketSubdivisionCode(String targetMarketSubdivisionCode) {
		this.targetMarketSubdivisionCode = targetMarketSubdivisionCode;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		IllegalToAdvertiseTargetMarket illegalToAdvertiseTargetMarket = (IllegalToAdvertiseTargetMarket) o;
		return Objects.equals(this.targetMarketCountryCode, illegalToAdvertiseTargetMarket.targetMarketCountryCode)
				&& Objects.equals(this.targetMarketSubdivisionCode,
						illegalToAdvertiseTargetMarket.targetMarketSubdivisionCode);
	}

	@Override
	public int hashCode() {
		return Objects.hash(targetMarketCountryCode, targetMarketSubdivisionCode);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class IllegalToAdvertiseTargetMarket {\n");

		sb.append("    targetMarketCountryCode: ").append(toIndentedString(targetMarketCountryCode)).append("\n");
		sb.append("    targetMarketSubdivisionCode: ").append(toIndentedString(targetMarketSubdivisionCode))
				.append("\n");
		sb.append("}");
		return sb.toString();
	}
