...
public class PackagingMaterialClassificationCodeReference {
	...
	@JsonProperty("packagingMaterialClassificationCodeReferenceValue")
	private String packagingMaterialClassificationCodeReferenceValue = null;

	public PackagingMaterialClassificationCodeReference codeDescription(String codeDescription) {
	...
	public PackagingMaterialClassificationCodeReference codeListAgencyCode(String codeListAgencyCode) {
	...
	public PackagingMaterialClassificationCodeReference codeListAgencyCodeListVersion(
	...
	public PackagingMaterialClassificationCodeReference codeListAgencyName(String codeListAgencyName) {
	...
	public PackagingMaterialClassificationCodeReference codeListName(String codeListName) {
	...
	public PackagingMaterialClassificationCodeReference codeListURI(String codeListURI) {
	...
	public PackagingMaterialClassificationCodeReference codeListVersion(String codeListVersion) {
	...
	public PackagingMaterialClassificationCodeReference packagingMaterialClassificationCodeReferenceValue(
			String packagingMaterialClassificationCodeReferenceValue) {
		this.packagingMaterialClassificationCodeReferenceValue = packagingMaterialClassificationCodeReferenceValue;
		return this;
	}

	/**
	 * Get packagingMaterialClassificationCodeReferenceValue
	 * 
	 * @return packagingMaterialClassificationCodeReferenceValue
	 **/
	@ApiModelProperty(value = "")
	public String getPackagingMaterialClassificationCodeReferenceValue() {
		return packagingMaterialClassificationCodeReferenceValue;
	}

	public void setPackagingMaterialClassificationCodeReferenceValue(
			String packagingMaterialClassificationCodeReferenceValue) {
		this.packagingMaterialClassificationCodeReferenceValue = packagingMaterialClassificationCodeReferenceValue;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		PackagingMaterialClassificationCodeReference packagingMaterialClassificationCodeReference = (PackagingMaterialClassificationCodeReference) o;
		return Objects.equals(this.codeDescription, packagingMaterialClassificationCodeReference.codeDescription)
				&& Objects.equals(this.codeListAgencyCode,
						packagingMaterialClassificationCodeReference.codeListAgencyCode)
				&& Objects.equals(this.codeListAgencyCodeListVersion,
						packagingMaterialClassificationCodeReference.codeListAgencyCodeListVersion)
				&& Objects.equals(this.codeListAgencyName,
						packagingMaterialClassificationCodeReference.codeListAgencyName)
				&& Objects.equals(this.codeListName, packagingMaterialClassificationCodeReference.codeListName)
				&& Objects.equals(this.codeListURI, packagingMaterialClassificationCodeReference.codeListURI)
				&& Objects.equals(this.codeListVersion, packagingMaterialClassificationCodeReference.codeListVersion)
				&& Objects.equals(this.packagingMaterialClassificationCodeReferenceValue,
						packagingMaterialClassificationCodeReference.packagingMaterialClassificationCodeReferenceValue);
	}

	@Override
	public int hashCode() {
		return Objects.hash(codeDescription, codeListAgencyCode, codeListAgencyCodeListVersion, codeListAgencyName,
				codeListName, codeListURI, codeListVersion, packagingMaterialClassificationCodeReferenceValue);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class PackagingMaterialClassificationCodeReference {\n");
		...
		sb.append("    packagingMaterialClassificationCodeReferenceValue: ")
				.append(toIndentedString(packagingMaterialClassificationCodeReferenceValue)).append("\n");
		sb.append("}");
		return sb.toString();
	}
