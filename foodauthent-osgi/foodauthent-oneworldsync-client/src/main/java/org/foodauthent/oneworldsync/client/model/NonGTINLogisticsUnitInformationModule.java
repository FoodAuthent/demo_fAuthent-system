...
import org.foodauthent.oneworldsync.client.model.NonGTINLogisticsUnitInformation;
...
public class NonGTINLogisticsUnitInformationModule {
	@JsonProperty("nonGTINLogisticsUnitInformation")
	private NonGTINLogisticsUnitInformation nonGTINLogisticsUnitInformation = null;

	public NonGTINLogisticsUnitInformationModule nonGTINLogisticsUnitInformation(
			NonGTINLogisticsUnitInformation nonGTINLogisticsUnitInformation) {
		this.nonGTINLogisticsUnitInformation = nonGTINLogisticsUnitInformation;
		return this;
	}

	/**
	 * Get nonGTINLogisticsUnitInformation
	 * 
	 * @return nonGTINLogisticsUnitInformation
	 **/
	@ApiModelProperty(value = "")
	public NonGTINLogisticsUnitInformation getNonGTINLogisticsUnitInformation() {
		return nonGTINLogisticsUnitInformation;
	}

	public void setNonGTINLogisticsUnitInformation(NonGTINLogisticsUnitInformation nonGTINLogisticsUnitInformation) {
		this.nonGTINLogisticsUnitInformation = nonGTINLogisticsUnitInformation;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		NonGTINLogisticsUnitInformationModule nonGTINLogisticsUnitInformationModule = (NonGTINLogisticsUnitInformationModule) o;
		return Objects.equals(this.nonGTINLogisticsUnitInformation,
				nonGTINLogisticsUnitInformationModule.nonGTINLogisticsUnitInformation);
	}

	@Override
	public int hashCode() {
		return Objects.hash(nonGTINLogisticsUnitInformation);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class NonGTINLogisticsUnitInformationModule {\n");

		sb.append("    nonGTINLogisticsUnitInformation: ").append(toIndentedString(nonGTINLogisticsUnitInformation))
				.append("\n");
		sb.append("}");
		return sb.toString();
	}
