...
import org.foodauthent.oneworldsync.client.model.TradeItemMeasurements;
...
public class TradeItemMeasurementsModule {
	...
	private TradeItemMeasurements tradeItemMeasurements = null;

	public TradeItemMeasurementsModule tradeItemMeasurements(TradeItemMeasurements tradeItemMeasurements) {
		this.tradeItemMeasurements = tradeItemMeasurements;
		return this;
	}

	/**
	 * Get tradeItemMeasurements
	 * 
	...
	public boolean equals(java.lang.Object o) {
		...
		TradeItemMeasurementsModule tradeItemMeasurementsModule = (TradeItemMeasurementsModule) o;
		return Objects.equals(this.tradeItemMeasurements, tradeItemMeasurementsModule.tradeItemMeasurements);
	}

	@Override
	public int hashCode() {
		return Objects.hash(tradeItemMeasurements);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class TradeItemMeasurementsModule {\n");

		sb.append("    tradeItemMeasurements: ").append(toIndentedString(tradeItemMeasurements)).append("\n");
		sb.append("}");
		return sb.toString();
	}
