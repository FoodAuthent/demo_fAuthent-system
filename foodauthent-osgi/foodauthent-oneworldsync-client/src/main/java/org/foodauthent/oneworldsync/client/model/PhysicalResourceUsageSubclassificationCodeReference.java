...
public class PhysicalResourceUsageSubclassificationCodeReference {
	...
	@JsonProperty("physicalResourceUsageSubclassificationCodeReferenceValue")
	private String physicalResourceUsageSubclassificationCodeReferenceValue = null;

	public PhysicalResourceUsageSubclassificationCodeReference codeDescription(String codeDescription) {
	...
	public PhysicalResourceUsageSubclassificationCodeReference codeListAgencyCode(String codeListAgencyCode) {
	...
	public PhysicalResourceUsageSubclassificationCodeReference codeListAgencyCodeListVersion(
	...
	public PhysicalResourceUsageSubclassificationCodeReference codeListAgencyName(String codeListAgencyName) {
	...
	public PhysicalResourceUsageSubclassificationCodeReference codeListName(String codeListName) {
	...
	public PhysicalResourceUsageSubclassificationCodeReference codeListURI(String codeListURI) {
	...
	public PhysicalResourceUsageSubclassificationCodeReference codeListVersion(String codeListVersion) {
	...
	public PhysicalResourceUsageSubclassificationCodeReference physicalResourceUsageSubclassificationCodeReferenceValue(
			String physicalResourceUsageSubclassificationCodeReferenceValue) {
		this.physicalResourceUsageSubclassificationCodeReferenceValue = physicalResourceUsageSubclassificationCodeReferenceValue;
		return this;
	}

	/**
	 * Get physicalResourceUsageSubclassificationCodeReferenceValue
	 * 
	 * @return physicalResourceUsageSubclassificationCodeReferenceValue
	 **/
	@ApiModelProperty(value = "")
	public String getPhysicalResourceUsageSubclassificationCodeReferenceValue() {
		return physicalResourceUsageSubclassificationCodeReferenceValue;
	}

	public void setPhysicalResourceUsageSubclassificationCodeReferenceValue(
			String physicalResourceUsageSubclassificationCodeReferenceValue) {
		this.physicalResourceUsageSubclassificationCodeReferenceValue = physicalResourceUsageSubclassificationCodeReferenceValue;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		PhysicalResourceUsageSubclassificationCodeReference physicalResourceUsageSubclassificationCodeReference = (PhysicalResourceUsageSubclassificationCodeReference) o;
		return Objects.equals(this.codeDescription, physicalResourceUsageSubclassificationCodeReference.codeDescription)
				&& Objects.equals(this.codeListAgencyCode,
						physicalResourceUsageSubclassificationCodeReference.codeListAgencyCode)
				&& Objects.equals(this.codeListAgencyCodeListVersion,
						physicalResourceUsageSubclassificationCodeReference.codeListAgencyCodeListVersion)
				&& Objects.equals(this.codeListAgencyName,
						physicalResourceUsageSubclassificationCodeReference.codeListAgencyName)
				&& Objects.equals(this.codeListName, physicalResourceUsageSubclassificationCodeReference.codeListName)
				&& Objects.equals(this.codeListURI, physicalResourceUsageSubclassificationCodeReference.codeListURI)
				&& Objects.equals(this.codeListVersion,
						physicalResourceUsageSubclassificationCodeReference.codeListVersion)
				&& Objects.equals(this.physicalResourceUsageSubclassificationCodeReferenceValue,
						physicalResourceUsageSubclassificationCodeReference.physicalResourceUsageSubclassificationCodeReferenceValue);
	}

	@Override
	public int hashCode() {
		return Objects.hash(codeDescription, codeListAgencyCode, codeListAgencyCodeListVersion, codeListAgencyName,
				codeListName, codeListURI, codeListVersion, physicalResourceUsageSubclassificationCodeReferenceValue);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class PhysicalResourceUsageSubclassificationCodeReference {\n");
		...
		sb.append("    physicalResourceUsageSubclassificationCodeReferenceValue: ")
				.append(toIndentedString(physicalResourceUsageSubclassificationCodeReferenceValue)).append("\n");
		sb.append("}");
		return sb.toString();
	}
