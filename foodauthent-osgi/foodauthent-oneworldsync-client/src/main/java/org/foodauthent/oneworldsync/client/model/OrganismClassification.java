...
public class OrganismClassification {
	...
	@JsonProperty("rankBelowSpecies")
	private String rankBelowSpecies = null;

	@JsonProperty("species")
	private String species = null;

	public OrganismClassification genus(String genus) {
		this.genus = genus;
		return this;
	}
	...
	public OrganismClassification rankBelowSpecies(String rankBelowSpecies) {
		this.rankBelowSpecies = rankBelowSpecies;
		return this;
	}

	/**
	 * Get rankBelowSpecies
	 * 
	 * @return rankBelowSpecies
	 **/
	@ApiModelProperty(value = "")
	public String getRankBelowSpecies() {
		return rankBelowSpecies;
	}

	public void setRankBelowSpecies(String rankBelowSpecies) {
		this.rankBelowSpecies = rankBelowSpecies;
	}

	public OrganismClassification species(String species) {
	...
	public boolean equals(java.lang.Object o) {
		...
		OrganismClassification organismClassification = (OrganismClassification) o;
		return Objects.equals(this.genus, organismClassification.genus)
				&& Objects.equals(this.rankBelowSpecies, organismClassification.rankBelowSpecies)
				&& Objects.equals(this.species, organismClassification.species);
	}

	@Override
	public int hashCode() {
		return Objects.hash(genus, rankBelowSpecies, species);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class OrganismClassification {\n");

		sb.append("    genus: ").append(toIndentedString(genus)).append("\n");
		sb.append("    rankBelowSpecies: ").append(toIndentedString(rankBelowSpecies)).append("\n");
