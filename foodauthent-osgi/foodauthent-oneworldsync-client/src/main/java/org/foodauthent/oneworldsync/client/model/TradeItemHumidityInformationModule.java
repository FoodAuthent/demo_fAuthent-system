...
import org.foodauthent.oneworldsync.client.model.TradeItemHumidityInformation;
...
public class TradeItemHumidityInformationModule {
	@JsonProperty("tradeItemHumidityInformation")
	private List<TradeItemHumidityInformation> tradeItemHumidityInformation = null;

	public TradeItemHumidityInformationModule tradeItemHumidityInformation(
			List<TradeItemHumidityInformation> tradeItemHumidityInformation) {
		this.tradeItemHumidityInformation = tradeItemHumidityInformation;
		return this;
	}

	public TradeItemHumidityInformationModule addTradeItemHumidityInformationItem(
			TradeItemHumidityInformation tradeItemHumidityInformationItem) {
		if (this.tradeItemHumidityInformation == null) {
			this.tradeItemHumidityInformation = new ArrayList<TradeItemHumidityInformation>();
		}
		this.tradeItemHumidityInformation.add(tradeItemHumidityInformationItem);
		return this;
	}

	/**
	 * Get tradeItemHumidityInformation
	 * 
	 * @return tradeItemHumidityInformation
	 **/
	@ApiModelProperty(value = "")
	public List<TradeItemHumidityInformation> getTradeItemHumidityInformation() {
		return tradeItemHumidityInformation;
	}

	public void setTradeItemHumidityInformation(List<TradeItemHumidityInformation> tradeItemHumidityInformation) {
		this.tradeItemHumidityInformation = tradeItemHumidityInformation;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		TradeItemHumidityInformationModule tradeItemHumidityInformationModule = (TradeItemHumidityInformationModule) o;
		return Objects.equals(this.tradeItemHumidityInformation,
				tradeItemHumidityInformationModule.tradeItemHumidityInformation);
	}

	@Override
	public int hashCode() {
		return Objects.hash(tradeItemHumidityInformation);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class TradeItemHumidityInformationModule {\n");

		sb.append("    tradeItemHumidityInformation: ").append(toIndentedString(tradeItemHumidityInformation))
				.append("\n");
		sb.append("}");
		return sb.toString();
	}
