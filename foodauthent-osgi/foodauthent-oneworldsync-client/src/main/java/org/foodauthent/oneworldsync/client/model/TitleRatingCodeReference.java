...
public class TitleRatingCodeReference {
	...
	@JsonProperty("titleRatingCodeReferenceValue")
	private String titleRatingCodeReferenceValue = null;

	public TitleRatingCodeReference codeDescription(String codeDescription) {
	...
	public TitleRatingCodeReference codeListAgencyCode(String codeListAgencyCode) {
	...
	public TitleRatingCodeReference codeListAgencyCodeListVersion(String codeListAgencyCodeListVersion) {
	...
	public TitleRatingCodeReference codeListAgencyName(String codeListAgencyName) {
	...
	public TitleRatingCodeReference codeListName(String codeListName) {
	...
	public TitleRatingCodeReference codeListURI(String codeListURI) {
	...
	public TitleRatingCodeReference codeListVersion(String codeListVersion) {
	...
	public TitleRatingCodeReference titleRatingCodeReferenceValue(String titleRatingCodeReferenceValue) {
		this.titleRatingCodeReferenceValue = titleRatingCodeReferenceValue;
		return this;
	}

	/**
	 * Get titleRatingCodeReferenceValue
	 * 
	 * @return titleRatingCodeReferenceValue
	 **/
	@ApiModelProperty(value = "")
	public String getTitleRatingCodeReferenceValue() {
		return titleRatingCodeReferenceValue;
	}

	public void setTitleRatingCodeReferenceValue(String titleRatingCodeReferenceValue) {
		this.titleRatingCodeReferenceValue = titleRatingCodeReferenceValue;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		TitleRatingCodeReference titleRatingCodeReference = (TitleRatingCodeReference) o;
		return Objects.equals(this.codeDescription, titleRatingCodeReference.codeDescription)
				&& Objects.equals(this.codeListAgencyCode, titleRatingCodeReference.codeListAgencyCode)
				&& Objects.equals(this.codeListAgencyCodeListVersion,
						titleRatingCodeReference.codeListAgencyCodeListVersion)
				&& Objects.equals(this.codeListAgencyName, titleRatingCodeReference.codeListAgencyName)
				&& Objects.equals(this.codeListName, titleRatingCodeReference.codeListName)
				&& Objects.equals(this.codeListURI, titleRatingCodeReference.codeListURI)
				&& Objects.equals(this.codeListVersion, titleRatingCodeReference.codeListVersion) && Objects.equals(
						this.titleRatingCodeReferenceValue, titleRatingCodeReference.titleRatingCodeReferenceValue);
	}

	@Override
	public int hashCode() {
		return Objects.hash(codeDescription, codeListAgencyCode, codeListAgencyCodeListVersion, codeListAgencyName,
				codeListName, codeListURI, codeListVersion, titleRatingCodeReferenceValue);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class TitleRatingCodeReference {\n");
		...
		sb.append("    titleRatingCodeReferenceValue: ").append(toIndentedString(titleRatingCodeReferenceValue))
				.append("\n");
		sb.append("}");
		return sb.toString();
	}
