...
public class ItemReferenceIdInformation {
	@JsonProperty("itemReferenceId")
	private String itemReferenceId = null;

	public ItemReferenceIdInformation itemReferenceId(String itemReferenceId) {
	...
	public boolean equals(java.lang.Object o) {
		...
		ItemReferenceIdInformation itemReferenceIdInformation = (ItemReferenceIdInformation) o;
		return Objects.equals(this.itemReferenceId, itemReferenceIdInformation.itemReferenceId);
	}

	@Override
	public int hashCode() {
		return Objects.hash(itemReferenceId);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class ItemReferenceIdInformation {\n");

		sb.append("    itemReferenceId: ").append(toIndentedString(itemReferenceId)).append("\n");
		sb.append("}");
		return sb.toString();
	}
