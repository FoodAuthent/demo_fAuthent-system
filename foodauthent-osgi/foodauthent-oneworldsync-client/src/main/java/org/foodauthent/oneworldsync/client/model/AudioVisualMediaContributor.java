...
public class AudioVisualMediaContributor {
	@JsonProperty("audioVisualMediaItemContributorName")
	private String audioVisualMediaItemContributorName = null;

	@JsonProperty("audioVisualMediaItemContributorTypeCode")
	private CodifiedValue audioVisualMediaItemContributorTypeCode = null;

	public AudioVisualMediaContributor audioVisualMediaItemContributorName(String audioVisualMediaItemContributorName) {
		this.audioVisualMediaItemContributorName = audioVisualMediaItemContributorName;
		return this;
	}

	/**
	 * Get audioVisualMediaItemContributorName
	 * 
	...
	public void setAudioVisualMediaItemContributorName(String audioVisualMediaItemContributorName) {
		this.audioVisualMediaItemContributorName = audioVisualMediaItemContributorName;
	}

	public AudioVisualMediaContributor audioVisualMediaItemContributorTypeCode(
			CodifiedValue audioVisualMediaItemContributorTypeCode) {
		this.audioVisualMediaItemContributorTypeCode = audioVisualMediaItemContributorTypeCode;
		return this;
	}

	/**
	 * Get audioVisualMediaItemContributorTypeCode
	 * 
	 * @return audioVisualMediaItemContributorTypeCode
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getAudioVisualMediaItemContributorTypeCode() {
		return audioVisualMediaItemContributorTypeCode;
	}

	public void setAudioVisualMediaItemContributorTypeCode(CodifiedValue audioVisualMediaItemContributorTypeCode) {
		this.audioVisualMediaItemContributorTypeCode = audioVisualMediaItemContributorTypeCode;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		AudioVisualMediaContributor audioVisualMediaContributor = (AudioVisualMediaContributor) o;
		return Objects.equals(this.audioVisualMediaItemContributorName,
				audioVisualMediaContributor.audioVisualMediaItemContributorName)
				&& Objects.equals(this.audioVisualMediaItemContributorTypeCode,
						audioVisualMediaContributor.audioVisualMediaItemContributorTypeCode);
	}

	@Override
	public int hashCode() {
		return Objects.hash(audioVisualMediaItemContributorName, audioVisualMediaItemContributorTypeCode);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class AudioVisualMediaContributor {\n");

		sb.append("    audioVisualMediaItemContributorName: ")
				.append(toIndentedString(audioVisualMediaItemContributorName)).append("\n");
		sb.append("    audioVisualMediaItemContributorTypeCode: ")
				.append(toIndentedString(audioVisualMediaItemContributorTypeCode)).append("\n");
		sb.append("}");
		return sb.toString();
	}
