...
public class TradeItemWeight {
	...
	private QualifiedValue drainedWeight = null;
	...
	public TradeItemWeight drainedWeight(QualifiedValue drainedWeight) {
	...
	public QualifiedValue getDrainedWeight() {
		return drainedWeight;
	}

	public void setDrainedWeight(QualifiedValue drainedWeight) {
		this.drainedWeight = drainedWeight;
	}

	public TradeItemWeight grossWeight(QualifiedValue grossWeight) {
	...
	public TradeItemWeight netWeight(QualifiedValue netWeight) {
	...
	public boolean equals(java.lang.Object o) {
		...
		TradeItemWeight tradeItemWeight = (TradeItemWeight) o;
		return Objects.equals(this.drainedWeight, tradeItemWeight.drainedWeight)
				&& Objects.equals(this.grossWeight, tradeItemWeight.grossWeight)
				&& Objects.equals(this.netWeight, tradeItemWeight.netWeight);
	}

	@Override
	public int hashCode() {
		return Objects.hash(drainedWeight, grossWeight, netWeight);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class TradeItemWeight {\n");

		sb.append("    drainedWeight: ").append(toIndentedString(drainedWeight)).append("\n");
