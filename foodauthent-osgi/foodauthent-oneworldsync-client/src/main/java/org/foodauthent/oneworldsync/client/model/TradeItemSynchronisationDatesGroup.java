...
import org.foodauthent.oneworldsync.client.model.TradeItemSynchronisationDates;

/**
 * TradeItemSynchronisationDatesGroup
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-07-25T20:10:55.785Z")
public class TradeItemSynchronisationDatesGroup {
	@JsonProperty("recipient")
	private Recipient recipient = null;

	@JsonProperty("tradeItemSynchronisationDates")
	private TradeItemSynchronisationDates tradeItemSynchronisationDates = null;

	public TradeItemSynchronisationDatesGroup recipient(Recipient recipient) {
	...
	public TradeItemSynchronisationDatesGroup tradeItemSynchronisationDates(
			TradeItemSynchronisationDates tradeItemSynchronisationDates) {
		this.tradeItemSynchronisationDates = tradeItemSynchronisationDates;
		return this;
	}

	/**
	 * Get tradeItemSynchronisationDates
	 * 
	 * @return tradeItemSynchronisationDates
	 **/
	@ApiModelProperty(value = "")
	public TradeItemSynchronisationDates getTradeItemSynchronisationDates() {
		return tradeItemSynchronisationDates;
	}

	public void setTradeItemSynchronisationDates(TradeItemSynchronisationDates tradeItemSynchronisationDates) {
		this.tradeItemSynchronisationDates = tradeItemSynchronisationDates;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		TradeItemSynchronisationDatesGroup tradeItemSynchronisationDatesGroup = (TradeItemSynchronisationDatesGroup) o;
		return Objects.equals(this.recipient, tradeItemSynchronisationDatesGroup.recipient) && Objects.equals(
				this.tradeItemSynchronisationDates, tradeItemSynchronisationDatesGroup.tradeItemSynchronisationDates);
	}

	@Override
	public int hashCode() {
		return Objects.hash(recipient, tradeItemSynchronisationDates);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class TradeItemSynchronisationDatesGroup {\n");

		sb.append("    recipient: ").append(toIndentedString(recipient)).append("\n");
		sb.append("    tradeItemSynchronisationDates: ").append(toIndentedString(tradeItemSynchronisationDates))
				.append("\n");
		sb.append("}");
		return sb.toString();
	}
