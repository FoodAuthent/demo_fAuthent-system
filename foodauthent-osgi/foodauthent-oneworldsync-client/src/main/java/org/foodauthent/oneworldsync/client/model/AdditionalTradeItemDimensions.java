...
public class AdditionalTradeItemDimensions {
	@JsonProperty("depth")
	private QualifiedValue depth = null;

	@JsonProperty("dimensionTypeCode")
	private CodifiedValue dimensionTypeCode = null;
	...
	public AdditionalTradeItemDimensions depth(QualifiedValue depth) {
		this.depth = depth;
		return this;
	}
	...
	public AdditionalTradeItemDimensions dimensionTypeCode(CodifiedValue dimensionTypeCode) {
		this.dimensionTypeCode = dimensionTypeCode;
		return this;
	}

	/**
	 * Get dimensionTypeCode
	 * 
	 * @return dimensionTypeCode
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getDimensionTypeCode() {
		return dimensionTypeCode;
	}

	public void setDimensionTypeCode(CodifiedValue dimensionTypeCode) {
		this.dimensionTypeCode = dimensionTypeCode;
	}

	public AdditionalTradeItemDimensions height(QualifiedValue height) {
		this.height = height;
		return this;
	}
	...
	public AdditionalTradeItemDimensions width(QualifiedValue width) {
		this.width = width;
		return this;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		AdditionalTradeItemDimensions additionalTradeItemDimensions = (AdditionalTradeItemDimensions) o;
		return Objects.equals(this.depth, additionalTradeItemDimensions.depth)
				&& Objects.equals(this.dimensionTypeCode, additionalTradeItemDimensions.dimensionTypeCode)
				&& Objects.equals(this.height, additionalTradeItemDimensions.height)
				&& Objects.equals(this.width, additionalTradeItemDimensions.width);
	}

	@Override
	public int hashCode() {
		return Objects.hash(depth, dimensionTypeCode, height, width);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class AdditionalTradeItemDimensions {\n");

		sb.append("    depth: ").append(toIndentedString(depth)).append("\n");
		sb.append("    dimensionTypeCode: ").append(toIndentedString(dimensionTypeCode)).append("\n");
