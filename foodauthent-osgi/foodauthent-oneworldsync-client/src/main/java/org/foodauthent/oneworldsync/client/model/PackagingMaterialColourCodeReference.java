...
public class PackagingMaterialColourCodeReference {
	...
	@JsonProperty("packagingMaterialColourCodeReferenceValue")
	private String packagingMaterialColourCodeReferenceValue = null;

	public PackagingMaterialColourCodeReference codeDescription(String codeDescription) {
	...
	public PackagingMaterialColourCodeReference codeListAgencyCode(String codeListAgencyCode) {
	...
	public PackagingMaterialColourCodeReference codeListAgencyCodeListVersion(String codeListAgencyCodeListVersion) {
	...
	public PackagingMaterialColourCodeReference codeListAgencyName(String codeListAgencyName) {
	...
	public PackagingMaterialColourCodeReference codeListName(String codeListName) {
	...
	public PackagingMaterialColourCodeReference codeListURI(String codeListURI) {
	...
	public PackagingMaterialColourCodeReference codeListVersion(String codeListVersion) {
	...
	public PackagingMaterialColourCodeReference packagingMaterialColourCodeReferenceValue(
			String packagingMaterialColourCodeReferenceValue) {
		this.packagingMaterialColourCodeReferenceValue = packagingMaterialColourCodeReferenceValue;
		return this;
	}

	/**
	 * Get packagingMaterialColourCodeReferenceValue
	 * 
	 * @return packagingMaterialColourCodeReferenceValue
	 **/
	@ApiModelProperty(value = "")
	public String getPackagingMaterialColourCodeReferenceValue() {
		return packagingMaterialColourCodeReferenceValue;
	}

	public void setPackagingMaterialColourCodeReferenceValue(String packagingMaterialColourCodeReferenceValue) {
		this.packagingMaterialColourCodeReferenceValue = packagingMaterialColourCodeReferenceValue;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		PackagingMaterialColourCodeReference packagingMaterialColourCodeReference = (PackagingMaterialColourCodeReference) o;
		return Objects.equals(this.codeDescription, packagingMaterialColourCodeReference.codeDescription)
				&& Objects.equals(this.codeListAgencyCode, packagingMaterialColourCodeReference.codeListAgencyCode)
				&& Objects.equals(this.codeListAgencyCodeListVersion,
						packagingMaterialColourCodeReference.codeListAgencyCodeListVersion)
				&& Objects.equals(this.codeListAgencyName, packagingMaterialColourCodeReference.codeListAgencyName)
				&& Objects.equals(this.codeListName, packagingMaterialColourCodeReference.codeListName)
				&& Objects.equals(this.codeListURI, packagingMaterialColourCodeReference.codeListURI)
				&& Objects.equals(this.codeListVersion, packagingMaterialColourCodeReference.codeListVersion)
				&& Objects.equals(this.packagingMaterialColourCodeReferenceValue,
						packagingMaterialColourCodeReference.packagingMaterialColourCodeReferenceValue);
	}

	@Override
	public int hashCode() {
		return Objects.hash(codeDescription, codeListAgencyCode, codeListAgencyCodeListVersion, codeListAgencyName,
				codeListName, codeListURI, codeListVersion, packagingMaterialColourCodeReferenceValue);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class PackagingMaterialColourCodeReference {\n");
		...
		sb.append("    packagingMaterialColourCodeReferenceValue: ")
				.append(toIndentedString(packagingMaterialColourCodeReferenceValue)).append("\n");
		sb.append("}");
		return sb.toString();
	}
