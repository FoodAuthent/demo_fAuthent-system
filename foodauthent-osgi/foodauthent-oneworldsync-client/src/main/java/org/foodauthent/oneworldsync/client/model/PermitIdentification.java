...
public class PermitIdentification {
	@JsonProperty("permitEndDateTime")
	private String permitEndDateTime = null;

	@JsonProperty("permitStartDateTime")
	private String permitStartDateTime = null;

	@JsonProperty("regulatoryPermitIdentification")
	private String regulatoryPermitIdentification = null;

	public PermitIdentification permitEndDateTime(String permitEndDateTime) {
		this.permitEndDateTime = permitEndDateTime;
		return this;
	}

	/**
	 * Get permitEndDateTime
	 * 
	 * @return permitEndDateTime
	 **/
	@ApiModelProperty(value = "")
	public String getPermitEndDateTime() {
		return permitEndDateTime;
	}

	public void setPermitEndDateTime(String permitEndDateTime) {
		this.permitEndDateTime = permitEndDateTime;
	}

	public PermitIdentification permitStartDateTime(String permitStartDateTime) {
		this.permitStartDateTime = permitStartDateTime;
		return this;
	}

	/**
	 * Get permitStartDateTime
	 * 
	 * @return permitStartDateTime
	 **/
	@ApiModelProperty(value = "")
	public String getPermitStartDateTime() {
		return permitStartDateTime;
	}

	public void setPermitStartDateTime(String permitStartDateTime) {
		this.permitStartDateTime = permitStartDateTime;
	}

	public PermitIdentification regulatoryPermitIdentification(String regulatoryPermitIdentification) {
		this.regulatoryPermitIdentification = regulatoryPermitIdentification;
		return this;
	}
	...
	public void setRegulatoryPermitIdentification(String regulatoryPermitIdentification) {
		this.regulatoryPermitIdentification = regulatoryPermitIdentification;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		PermitIdentification permitIdentification = (PermitIdentification) o;
		return Objects.equals(this.permitEndDateTime, permitIdentification.permitEndDateTime)
				&& Objects.equals(this.permitStartDateTime, permitIdentification.permitStartDateTime) && Objects.equals(
						this.regulatoryPermitIdentification, permitIdentification.regulatoryPermitIdentification);
	}

	@Override
	public int hashCode() {
		return Objects.hash(permitEndDateTime, permitStartDateTime, regulatoryPermitIdentification);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class PermitIdentification {\n");

		sb.append("    permitEndDateTime: ").append(toIndentedString(permitEndDateTime)).append("\n");
		sb.append("    permitStartDateTime: ").append(toIndentedString(permitStartDateTime)).append("\n");
		sb.append("    regulatoryPermitIdentification: ").append(toIndentedString(regulatoryPermitIdentification))
				.append("\n");
		sb.append("}");
		return sb.toString();
	}
