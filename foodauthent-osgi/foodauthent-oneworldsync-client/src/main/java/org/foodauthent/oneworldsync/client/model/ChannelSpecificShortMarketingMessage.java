...
public class ChannelSpecificShortMarketingMessage {
	@JsonProperty("channelSpecificShortMarketingMessage")
	private LanguageLabels channelSpecificShortMarketingMessage = null;

	@JsonProperty("formattingPattern")
	private String formattingPattern = null;

	@JsonProperty("sequenceNumber")
	private String sequenceNumber = null;

	public ChannelSpecificShortMarketingMessage channelSpecificShortMarketingMessage(
			LanguageLabels channelSpecificShortMarketingMessage) {
	...
	public LanguageLabels getChannelSpecificShortMarketingMessage() {
		return channelSpecificShortMarketingMessage;
	}

	public void setChannelSpecificShortMarketingMessage(LanguageLabels channelSpecificShortMarketingMessage) {
		this.channelSpecificShortMarketingMessage = channelSpecificShortMarketingMessage;
	}

	public ChannelSpecificShortMarketingMessage formattingPattern(String formattingPattern) {
		this.formattingPattern = formattingPattern;
		return this;
	}

	/**
	 * Get formattingPattern
	 * 
	...
	public ChannelSpecificShortMarketingMessage sequenceNumber(String sequenceNumber) {
	...
	public boolean equals(java.lang.Object o) {
		...
		ChannelSpecificShortMarketingMessage channelSpecificShortMarketingMessage = (ChannelSpecificShortMarketingMessage) o;
		return Objects.equals(this.channelSpecificShortMarketingMessage,
				channelSpecificShortMarketingMessage.channelSpecificShortMarketingMessage)
				&& Objects.equals(this.formattingPattern, channelSpecificShortMarketingMessage.formattingPattern)
				&& Objects.equals(this.sequenceNumber, channelSpecificShortMarketingMessage.sequenceNumber);
	}

	@Override
	public int hashCode() {
		return Objects.hash(channelSpecificShortMarketingMessage, formattingPattern, sequenceNumber);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class ChannelSpecificShortMarketingMessage {\n");

		sb.append("    channelSpecificShortMarketingMessage: ")
				.append(toIndentedString(channelSpecificShortMarketingMessage)).append("\n");
		sb.append("    formattingPattern: ").append(toIndentedString(formattingPattern)).append("\n");
