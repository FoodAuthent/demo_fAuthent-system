...
import org.foodauthent.oneworldsync.client.model.VariableTradeItemInformation;
...
public class VariableTradeItemInformationModule {
	...
	private VariableTradeItemInformation variableTradeItemInformation = null;

	public VariableTradeItemInformationModule variableTradeItemInformation(
			VariableTradeItemInformation variableTradeItemInformation) {
		this.variableTradeItemInformation = variableTradeItemInformation;
		return this;
	}

	/**
	 * Get variableTradeItemInformation
	 * 
	 * @return variableTradeItemInformation
	 **/
	@ApiModelProperty(value = "")
	public VariableTradeItemInformation getVariableTradeItemInformation() {
		return variableTradeItemInformation;
	}

	public void setVariableTradeItemInformation(VariableTradeItemInformation variableTradeItemInformation) {
		this.variableTradeItemInformation = variableTradeItemInformation;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		VariableTradeItemInformationModule variableTradeItemInformationModule = (VariableTradeItemInformationModule) o;
		return Objects.equals(this.variableTradeItemInformation,
				variableTradeItemInformationModule.variableTradeItemInformation);
	}

	@Override
	public int hashCode() {
		return Objects.hash(variableTradeItemInformation);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class VariableTradeItemInformationModule {\n");

		sb.append("    variableTradeItemInformation: ").append(toIndentedString(variableTradeItemInformation))
				.append("\n");
		sb.append("}");
		return sb.toString();
	}
