...
import org.foodauthent.oneworldsync.client.model.SafetyDataSheetInformation;

/**
 * SafetyDataSheetModule
 */
...
public class SafetyDataSheetModule {
	@JsonProperty("safetyDataSheetInformation")
	private List<SafetyDataSheetInformation> safetyDataSheetInformation = null;

	public SafetyDataSheetModule safetyDataSheetInformation(
			List<SafetyDataSheetInformation> safetyDataSheetInformation) {
		this.safetyDataSheetInformation = safetyDataSheetInformation;
		return this;
	}

	public SafetyDataSheetModule addSafetyDataSheetInformationItem(
			SafetyDataSheetInformation safetyDataSheetInformationItem) {
		if (this.safetyDataSheetInformation == null) {
			this.safetyDataSheetInformation = new ArrayList<SafetyDataSheetInformation>();
		}
		this.safetyDataSheetInformation.add(safetyDataSheetInformationItem);
		return this;
	}

	/**
	 * Get safetyDataSheetInformation
	 * 
	 * @return safetyDataSheetInformation
	 **/
	@ApiModelProperty(value = "")
	public List<SafetyDataSheetInformation> getSafetyDataSheetInformation() {
		return safetyDataSheetInformation;
	}

	public void setSafetyDataSheetInformation(List<SafetyDataSheetInformation> safetyDataSheetInformation) {
		this.safetyDataSheetInformation = safetyDataSheetInformation;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		SafetyDataSheetModule safetyDataSheetModule = (SafetyDataSheetModule) o;
		return Objects.equals(this.safetyDataSheetInformation, safetyDataSheetModule.safetyDataSheetInformation);
	}

	@Override
	public int hashCode() {
		return Objects.hash(safetyDataSheetInformation);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class SafetyDataSheetModule {\n");

		sb.append("    safetyDataSheetInformation: ").append(toIndentedString(safetyDataSheetInformation)).append("\n");
		sb.append("}");
		return sb.toString();
	}
