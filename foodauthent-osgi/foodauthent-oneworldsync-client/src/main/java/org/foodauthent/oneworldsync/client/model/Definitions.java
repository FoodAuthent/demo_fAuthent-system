...
import org.foodauthent.oneworldsync.client.model.DefinitionValues;
...
public class Definitions {
	@JsonProperty("values")
	private List<DefinitionValues> values = null;
	...
	public Definitions values(List<DefinitionValues> values) {
		this.values = values;
		return this;
	}

	public Definitions addValuesItem(DefinitionValues valuesItem) {
		if (this.values == null) {
			this.values = new ArrayList<DefinitionValues>();
		}
	...
	public List<DefinitionValues> getValues() {
		return values;
	}

	public void setValues(List<DefinitionValues> values) {
		this.values = values;
	}

	public Definitions name(String name) {
		this.name = name;
		return this;
	}
	...
	public Definitions type(String type) {
		this.type = type;
		return this;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.values, definitions.values) && Objects.equals(this.name, definitions.name)
				&& Objects.equals(this.type, definitions.type);
	}

	@Override
	public int hashCode() {
		return Objects.hash(values, name, type);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class Definitions {\n");
