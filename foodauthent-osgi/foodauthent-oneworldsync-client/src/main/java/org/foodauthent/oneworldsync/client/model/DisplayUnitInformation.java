...
public class DisplayUnitInformation {
	@JsonProperty("displayTypeCode")
	private CodifiedValue displayTypeCode = null;

	@JsonProperty("hasDisplayReadyPackaging")
	private CodifiedValue hasDisplayReadyPackaging = null;

	@JsonProperty("isTradeItemADisplayUnit")
	private CodifiedValue isTradeItemADisplayUnit = null;

	public DisplayUnitInformation displayTypeCode(CodifiedValue displayTypeCode) {
	...
	public CodifiedValue getDisplayTypeCode() {
		return displayTypeCode;
	}

	public void setDisplayTypeCode(CodifiedValue displayTypeCode) {
		this.displayTypeCode = displayTypeCode;
	}

	public DisplayUnitInformation hasDisplayReadyPackaging(CodifiedValue hasDisplayReadyPackaging) {
		this.hasDisplayReadyPackaging = hasDisplayReadyPackaging;
		return this;
	}

	/**
	 * Get hasDisplayReadyPackaging
	 * 
	 * @return hasDisplayReadyPackaging
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getHasDisplayReadyPackaging() {
		return hasDisplayReadyPackaging;
	}

	public void setHasDisplayReadyPackaging(CodifiedValue hasDisplayReadyPackaging) {
		this.hasDisplayReadyPackaging = hasDisplayReadyPackaging;
	}

	public DisplayUnitInformation isTradeItemADisplayUnit(CodifiedValue isTradeItemADisplayUnit) {
		this.isTradeItemADisplayUnit = isTradeItemADisplayUnit;
		return this;
	}

	/**
	 * Get isTradeItemADisplayUnit
	 * 
	 * @return isTradeItemADisplayUnit
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getIsTradeItemADisplayUnit() {
		return isTradeItemADisplayUnit;
	}

	public void setIsTradeItemADisplayUnit(CodifiedValue isTradeItemADisplayUnit) {
		this.isTradeItemADisplayUnit = isTradeItemADisplayUnit;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		DisplayUnitInformation displayUnitInformation = (DisplayUnitInformation) o;
		return Objects.equals(this.displayTypeCode, displayUnitInformation.displayTypeCode)
				&& Objects.equals(this.hasDisplayReadyPackaging, displayUnitInformation.hasDisplayReadyPackaging)
				&& Objects.equals(this.isTradeItemADisplayUnit, displayUnitInformation.isTradeItemADisplayUnit);
	}

	@Override
	public int hashCode() {
		return Objects.hash(displayTypeCode, hasDisplayReadyPackaging, isTradeItemADisplayUnit);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class DisplayUnitInformation {\n");

		sb.append("    displayTypeCode: ").append(toIndentedString(displayTypeCode)).append("\n");
		sb.append("    hasDisplayReadyPackaging: ").append(toIndentedString(hasDisplayReadyPackaging)).append("\n");
		sb.append("    isTradeItemADisplayUnit: ").append(toIndentedString(isTradeItemADisplayUnit)).append("\n");
		sb.append("}");
		return sb.toString();
	}
