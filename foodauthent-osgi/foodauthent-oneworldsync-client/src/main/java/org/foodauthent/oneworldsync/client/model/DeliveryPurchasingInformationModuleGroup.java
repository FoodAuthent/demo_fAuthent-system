...
import org.foodauthent.oneworldsync.client.model.DeliveryPurchasingInformationModule;
import org.foodauthent.oneworldsync.client.model.Recipient;

/**
 * DeliveryPurchasingInformationModuleGroup
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-07-25T20:10:55.785Z")
public class DeliveryPurchasingInformationModuleGroup {
	@JsonProperty("deliveryPurchasingInformationModule")
	private List<DeliveryPurchasingInformationModule> deliveryPurchasingInformationModule = null;

	@JsonProperty("recipient")
	private Recipient recipient = null;

	public DeliveryPurchasingInformationModuleGroup deliveryPurchasingInformationModule(
			List<DeliveryPurchasingInformationModule> deliveryPurchasingInformationModule) {
		this.deliveryPurchasingInformationModule = deliveryPurchasingInformationModule;
		return this;
	}

	public DeliveryPurchasingInformationModuleGroup addDeliveryPurchasingInformationModuleItem(
			DeliveryPurchasingInformationModule deliveryPurchasingInformationModuleItem) {
		if (this.deliveryPurchasingInformationModule == null) {
			this.deliveryPurchasingInformationModule = new ArrayList<DeliveryPurchasingInformationModule>();
		}
		this.deliveryPurchasingInformationModule.add(deliveryPurchasingInformationModuleItem);
		return this;
	}

	/**
	 * Get deliveryPurchasingInformationModule
	 * 
	 * @return deliveryPurchasingInformationModule
	 **/
	@ApiModelProperty(value = "")
	public List<DeliveryPurchasingInformationModule> getDeliveryPurchasingInformationModule() {
		return deliveryPurchasingInformationModule;
	}

	public void setDeliveryPurchasingInformationModule(
			List<DeliveryPurchasingInformationModule> deliveryPurchasingInformationModule) {
		this.deliveryPurchasingInformationModule = deliveryPurchasingInformationModule;
	}

	public DeliveryPurchasingInformationModuleGroup recipient(Recipient recipient) {
	...
	public boolean equals(java.lang.Object o) {
		...
		DeliveryPurchasingInformationModuleGroup deliveryPurchasingInformationModuleGroup = (DeliveryPurchasingInformationModuleGroup) o;
		return Objects.equals(this.deliveryPurchasingInformationModule,
				deliveryPurchasingInformationModuleGroup.deliveryPurchasingInformationModule)
				&& Objects.equals(this.recipient, deliveryPurchasingInformationModuleGroup.recipient);
	}

	@Override
	public int hashCode() {
		return Objects.hash(deliveryPurchasingInformationModule, recipient);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class DeliveryPurchasingInformationModuleGroup {\n");

		sb.append("    deliveryPurchasingInformationModule: ")
				.append(toIndentedString(deliveryPurchasingInformationModule)).append("\n");
