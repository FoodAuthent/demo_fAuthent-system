...
import org.foodauthent.oneworldsync.client.model.TradeItemHierarchy;
...
public class TradeItemHierarchyModule {
	...
	private TradeItemHierarchy tradeItemHierarchy = null;

	public TradeItemHierarchyModule tradeItemHierarchy(TradeItemHierarchy tradeItemHierarchy) {
		this.tradeItemHierarchy = tradeItemHierarchy;
		return this;
	}

	/**
	 * Get tradeItemHierarchy
	 * 
	...
	public void setTradeItemHierarchy(TradeItemHierarchy tradeItemHierarchy) {
		this.tradeItemHierarchy = tradeItemHierarchy;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		TradeItemHierarchyModule tradeItemHierarchyModule = (TradeItemHierarchyModule) o;
		return Objects.equals(this.tradeItemHierarchy, tradeItemHierarchyModule.tradeItemHierarchy);
	}

	@Override
	public int hashCode() {
		return Objects.hash(tradeItemHierarchy);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class TradeItemHierarchyModule {\n");

		sb.append("    tradeItemHierarchy: ").append(toIndentedString(tradeItemHierarchy)).append("\n");
		sb.append("}");
		return sb.toString();
	}
