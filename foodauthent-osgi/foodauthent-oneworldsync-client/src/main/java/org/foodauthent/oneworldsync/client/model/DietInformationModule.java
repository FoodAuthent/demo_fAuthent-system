...
import org.foodauthent.oneworldsync.client.model.DietInformation;
...
public class DietInformationModule {
	...
	private List<DietInformation> dietInformation = null;

	public DietInformationModule dietInformation(List<DietInformation> dietInformation) {
		this.dietInformation = dietInformation;
		return this;
	}

	public DietInformationModule addDietInformationItem(DietInformation dietInformationItem) {
		if (this.dietInformation == null) {
			this.dietInformation = new ArrayList<DietInformation>();
		}
		this.dietInformation.add(dietInformationItem);
		return this;
	}
	...
	public List<DietInformation> getDietInformation() {
		return dietInformation;
	}

	public void setDietInformation(List<DietInformation> dietInformation) {
		this.dietInformation = dietInformation;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		DietInformationModule dietInformationModule = (DietInformationModule) o;
		return Objects.equals(this.dietInformation, dietInformationModule.dietInformation);
	}

	@Override
	public int hashCode() {
		return Objects.hash(dietInformation);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class DietInformationModule {\n");

		sb.append("    dietInformation: ").append(toIndentedString(dietInformation)).append("\n");
		sb.append("}");
		return sb.toString();
	}
