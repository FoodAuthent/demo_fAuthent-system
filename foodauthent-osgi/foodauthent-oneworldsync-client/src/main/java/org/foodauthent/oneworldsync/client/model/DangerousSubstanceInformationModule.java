...
import org.foodauthent.oneworldsync.client.model.DangerousSubstanceInformation;

/**
 * DangerousSubstanceInformationModule
 */
...
public class DangerousSubstanceInformationModule {
	@JsonProperty("dangerousSubstanceInformation")
	private List<DangerousSubstanceInformation> dangerousSubstanceInformation = null;

	public DangerousSubstanceInformationModule dangerousSubstanceInformation(
			List<DangerousSubstanceInformation> dangerousSubstanceInformation) {
		this.dangerousSubstanceInformation = dangerousSubstanceInformation;
		return this;
	}

	public DangerousSubstanceInformationModule addDangerousSubstanceInformationItem(
			DangerousSubstanceInformation dangerousSubstanceInformationItem) {
		if (this.dangerousSubstanceInformation == null) {
			this.dangerousSubstanceInformation = new ArrayList<DangerousSubstanceInformation>();
		}
		this.dangerousSubstanceInformation.add(dangerousSubstanceInformationItem);
		return this;
	}

	/**
	 * Get dangerousSubstanceInformation
	 * 
	 * @return dangerousSubstanceInformation
	 **/
	@ApiModelProperty(value = "")
	public List<DangerousSubstanceInformation> getDangerousSubstanceInformation() {
		return dangerousSubstanceInformation;
	}

	public void setDangerousSubstanceInformation(List<DangerousSubstanceInformation> dangerousSubstanceInformation) {
		this.dangerousSubstanceInformation = dangerousSubstanceInformation;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		DangerousSubstanceInformationModule dangerousSubstanceInformationModule = (DangerousSubstanceInformationModule) o;
		return Objects.equals(this.dangerousSubstanceInformation,
				dangerousSubstanceInformationModule.dangerousSubstanceInformation);
	}

	@Override
	public int hashCode() {
		return Objects.hash(dangerousSubstanceInformation);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class DangerousSubstanceInformationModule {\n");

		sb.append("    dangerousSubstanceInformation: ").append(toIndentedString(dangerousSubstanceInformation))
				.append("\n");
		sb.append("}");
		return sb.toString();
	}
