...
public class ImageDeviceResolutionInformation {
	@JsonProperty("maximumResolution")
	private QualifiedValues maximumResolution = null;

	@JsonProperty("resolutionTypeCode")
	private CodifiedValue resolutionTypeCode = null;

	public ImageDeviceResolutionInformation maximumResolution(QualifiedValues maximumResolution) {
	...
	public QualifiedValues getMaximumResolution() {
		return maximumResolution;
	}

	public void setMaximumResolution(QualifiedValues maximumResolution) {
		this.maximumResolution = maximumResolution;
	}

	public ImageDeviceResolutionInformation resolutionTypeCode(CodifiedValue resolutionTypeCode) {
		this.resolutionTypeCode = resolutionTypeCode;
		return this;
	}

	/**
	 * Get resolutionTypeCode
	 * 
	 * @return resolutionTypeCode
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getResolutionTypeCode() {
		return resolutionTypeCode;
	}

	public void setResolutionTypeCode(CodifiedValue resolutionTypeCode) {
		this.resolutionTypeCode = resolutionTypeCode;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		ImageDeviceResolutionInformation imageDeviceResolutionInformation = (ImageDeviceResolutionInformation) o;
		return Objects.equals(this.maximumResolution, imageDeviceResolutionInformation.maximumResolution)
				&& Objects.equals(this.resolutionTypeCode, imageDeviceResolutionInformation.resolutionTypeCode);
	}

	@Override
	public int hashCode() {
		return Objects.hash(maximumResolution, resolutionTypeCode);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class ImageDeviceResolutionInformation {\n");

		sb.append("    maximumResolution: ").append(toIndentedString(maximumResolution)).append("\n");
		sb.append("    resolutionTypeCode: ").append(toIndentedString(resolutionTypeCode)).append("\n");
		sb.append("}");
		return sb.toString();
	}
