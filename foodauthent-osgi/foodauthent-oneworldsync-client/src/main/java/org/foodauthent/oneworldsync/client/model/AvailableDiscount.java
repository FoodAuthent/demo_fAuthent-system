...
public class AvailableDiscount {
	...
	private QualifiedValue discountAmount = null;

	@JsonProperty("discountDescription")
	private CodifiedValues discountDescription = null;
	...
	public AvailableDiscount discountAmount(QualifiedValue discountAmount) {
	...
	public QualifiedValue getDiscountAmount() {
		return discountAmount;
	}

	public void setDiscountAmount(QualifiedValue discountAmount) {
		this.discountAmount = discountAmount;
	}

	public AvailableDiscount discountDescription(CodifiedValues discountDescription) {
	 ...
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValues getDiscountDescription() {
		return discountDescription;
	}

	public void setDiscountDescription(CodifiedValues discountDescription) {
		this.discountDescription = discountDescription;
	}

	public AvailableDiscount discountPercent(String discountPercent) {
	...
	public AvailableDiscount discountType(String discountType) {
	...
	public boolean equals(java.lang.Object o) {
		...
		AvailableDiscount availableDiscount = (AvailableDiscount) o;
		return Objects.equals(this.discountAmount, availableDiscount.discountAmount)
				&& Objects.equals(this.discountDescription, availableDiscount.discountDescription)
				&& Objects.equals(this.discountPercent, availableDiscount.discountPercent)
				&& Objects.equals(this.discountType, availableDiscount.discountType);
	}

	@Override
	public int hashCode() {
		return Objects.hash(discountAmount, discountDescription, discountPercent, discountType);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class AvailableDiscount {\n");
