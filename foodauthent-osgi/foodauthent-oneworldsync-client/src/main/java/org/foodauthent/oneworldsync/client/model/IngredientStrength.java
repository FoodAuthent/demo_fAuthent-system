...
public class IngredientStrength {
	...
	private QualifiedValue ingredientStrength = null;

	@JsonProperty("ingredientStrengthBasis")
	private QualifiedValue ingredientStrengthBasis = null;

	public IngredientStrength ingredientStrength(QualifiedValue ingredientStrength) {
	...
	public QualifiedValue getIngredientStrength() {
		return ingredientStrength;
	}

	public void setIngredientStrength(QualifiedValue ingredientStrength) {
		this.ingredientStrength = ingredientStrength;
	}

	public IngredientStrength ingredientStrengthBasis(QualifiedValue ingredientStrengthBasis) {
		this.ingredientStrengthBasis = ingredientStrengthBasis;
		return this;
	}

	/**
	 * Get ingredientStrengthBasis
	 * 
	 * @return ingredientStrengthBasis
	 **/
	@ApiModelProperty(value = "")
	public QualifiedValue getIngredientStrengthBasis() {
		return ingredientStrengthBasis;
	}

	public void setIngredientStrengthBasis(QualifiedValue ingredientStrengthBasis) {
		this.ingredientStrengthBasis = ingredientStrengthBasis;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		IngredientStrength ingredientStrength = (IngredientStrength) o;
		return Objects.equals(this.ingredientStrength, ingredientStrength.ingredientStrength)
				&& Objects.equals(this.ingredientStrengthBasis, ingredientStrength.ingredientStrengthBasis);
	}

	@Override
	public int hashCode() {
		return Objects.hash(ingredientStrength, ingredientStrengthBasis);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class IngredientStrength {\n");

		sb.append("    ingredientStrength: ").append(toIndentedString(ingredientStrength)).append("\n");
		sb.append("    ingredientStrengthBasis: ").append(toIndentedString(ingredientStrengthBasis)).append("\n");
		sb.append("}");
		return sb.toString();
	}
