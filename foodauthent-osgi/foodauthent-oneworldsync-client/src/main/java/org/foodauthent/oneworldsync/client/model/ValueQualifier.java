...
public class ValueQualifier {
	...
	public ValueQualifier value(String value) {
		this.value = value;
		return this;
	}
	...
	public ValueQualifier qual(String qual) {
		this.qual = qual;
		return this;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		ValueQualifier valueQualifier = (ValueQualifier) o;
		return Objects.equals(this.value, valueQualifier.value) && Objects.equals(this.qual, valueQualifier.qual);
	}

	@Override
	public int hashCode() {
		return Objects.hash(value, qual);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class ValueQualifier {\n");
