...
public class NonfoodIngredientStatement {
	@JsonProperty("formattingPattern")
	private String formattingPattern = null;

	@JsonProperty("nonfoodIngredientStatement")
	private LanguageLabels nonfoodIngredientStatement = null;

	@JsonProperty("sequenceNumber")
	private String sequenceNumber = null;

	public NonfoodIngredientStatement formattingPattern(String formattingPattern) {
	...
	public NonfoodIngredientStatement nonfoodIngredientStatement(LanguageLabels nonfoodIngredientStatement) {
	 ...
	 **/
	@ApiModelProperty(value = "")
	public LanguageLabels getNonfoodIngredientStatement() {
		return nonfoodIngredientStatement;
	}

	public void setNonfoodIngredientStatement(LanguageLabels nonfoodIngredientStatement) {
		this.nonfoodIngredientStatement = nonfoodIngredientStatement;
	}

	public NonfoodIngredientStatement sequenceNumber(String sequenceNumber) {
	...
	public boolean equals(java.lang.Object o) {
		...
		NonfoodIngredientStatement nonfoodIngredientStatement = (NonfoodIngredientStatement) o;
		return Objects.equals(this.formattingPattern, nonfoodIngredientStatement.formattingPattern)
				&& Objects.equals(this.nonfoodIngredientStatement,
						nonfoodIngredientStatement.nonfoodIngredientStatement)
				&& Objects.equals(this.sequenceNumber, nonfoodIngredientStatement.sequenceNumber);
	}

	@Override
	public int hashCode() {
		return Objects.hash(formattingPattern, nonfoodIngredientStatement, sequenceNumber);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class NonfoodIngredientStatement {\n");
