...
import org.foodauthent.oneworldsync.client.model.TradeItemLifespanModule;

/**
 * TradeItemLifespanModuleGroup
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-07-25T20:10:55.785Z")
public class TradeItemLifespanModuleGroup {
	@JsonProperty("recipient")
	private Recipient recipient = null;

	@JsonProperty("tradeItemLifespanModule")
	private List<TradeItemLifespanModule> tradeItemLifespanModule = null;

	public TradeItemLifespanModuleGroup recipient(Recipient recipient) {
	...
	public TradeItemLifespanModuleGroup tradeItemLifespanModule(List<TradeItemLifespanModule> tradeItemLifespanModule) {
		this.tradeItemLifespanModule = tradeItemLifespanModule;
		return this;
	}

	public TradeItemLifespanModuleGroup addTradeItemLifespanModuleItem(
			TradeItemLifespanModule tradeItemLifespanModuleItem) {
		if (this.tradeItemLifespanModule == null) {
			this.tradeItemLifespanModule = new ArrayList<TradeItemLifespanModule>();
		}
		this.tradeItemLifespanModule.add(tradeItemLifespanModuleItem);
		return this;
	}

	/**
	 * Get tradeItemLifespanModule
	 * 
	 * @return tradeItemLifespanModule
	 **/
	@ApiModelProperty(value = "")
	public List<TradeItemLifespanModule> getTradeItemLifespanModule() {
		return tradeItemLifespanModule;
	}

	public void setTradeItemLifespanModule(List<TradeItemLifespanModule> tradeItemLifespanModule) {
		this.tradeItemLifespanModule = tradeItemLifespanModule;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		TradeItemLifespanModuleGroup tradeItemLifespanModuleGroup = (TradeItemLifespanModuleGroup) o;
		return Objects.equals(this.recipient, tradeItemLifespanModuleGroup.recipient)
				&& Objects.equals(this.tradeItemLifespanModule, tradeItemLifespanModuleGroup.tradeItemLifespanModule);
	}

	@Override
	public int hashCode() {
		return Objects.hash(recipient, tradeItemLifespanModule);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class TradeItemLifespanModuleGroup {\n");

		sb.append("    recipient: ").append(toIndentedString(recipient)).append("\n");
		sb.append("    tradeItemLifespanModule: ").append(toIndentedString(tradeItemLifespanModule)).append("\n");
		sb.append("}");
		return sb.toString();
	}
