...
public class AudioVisualMediaDateInformation {
	@JsonProperty("audioVisualMediaDateTime")
	private String audioVisualMediaDateTime = null;

	@JsonProperty("audioVisualMediaDateTypeCode")
	private CodifiedValue audioVisualMediaDateTypeCode = null;

	public AudioVisualMediaDateInformation audioVisualMediaDateTime(String audioVisualMediaDateTime) {
		this.audioVisualMediaDateTime = audioVisualMediaDateTime;
		return this;
	}

	/**
	 * Get audioVisualMediaDateTime
	 * 
	 * @return audioVisualMediaDateTime
	 **/
	@ApiModelProperty(value = "")
	public String getAudioVisualMediaDateTime() {
		return audioVisualMediaDateTime;
	}

	public void setAudioVisualMediaDateTime(String audioVisualMediaDateTime) {
		this.audioVisualMediaDateTime = audioVisualMediaDateTime;
	}

	public AudioVisualMediaDateInformation audioVisualMediaDateTypeCode(CodifiedValue audioVisualMediaDateTypeCode) {
		this.audioVisualMediaDateTypeCode = audioVisualMediaDateTypeCode;
		return this;
	}

	/**
	 * Get audioVisualMediaDateTypeCode
	 * 
	 * @return audioVisualMediaDateTypeCode
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getAudioVisualMediaDateTypeCode() {
		return audioVisualMediaDateTypeCode;
	}

	public void setAudioVisualMediaDateTypeCode(CodifiedValue audioVisualMediaDateTypeCode) {
		this.audioVisualMediaDateTypeCode = audioVisualMediaDateTypeCode;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		AudioVisualMediaDateInformation audioVisualMediaDateInformation = (AudioVisualMediaDateInformation) o;
		return Objects.equals(this.audioVisualMediaDateTime, audioVisualMediaDateInformation.audioVisualMediaDateTime)
				&& Objects.equals(this.audioVisualMediaDateTypeCode,
						audioVisualMediaDateInformation.audioVisualMediaDateTypeCode);
	}

	@Override
	public int hashCode() {
		return Objects.hash(audioVisualMediaDateTime, audioVisualMediaDateTypeCode);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class AudioVisualMediaDateInformation {\n");

		sb.append("    audioVisualMediaDateTime: ").append(toIndentedString(audioVisualMediaDateTime)).append("\n");
		sb.append("    audioVisualMediaDateTypeCode: ").append(toIndentedString(audioVisualMediaDateTypeCode))
				.append("\n");
		sb.append("}");
		return sb.toString();
	}
