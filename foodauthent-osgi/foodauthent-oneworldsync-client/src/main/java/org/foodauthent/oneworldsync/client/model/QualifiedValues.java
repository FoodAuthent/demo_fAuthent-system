...
public class QualifiedValues {
	...
	public QualifiedValues values(List<ValueQualifier> values) {
		this.values = values;
		return this;
	}

	public QualifiedValues addValuesItem(ValueQualifier valuesItem) {
		if (this.values == null) {
	...
	public QualifiedValues qualDefinition(String qualDefinition) {
	...
	public boolean equals(java.lang.Object o) {
		...
		QualifiedValues qualifiedValues = (QualifiedValues) o;
		return Objects.equals(this.values, qualifiedValues.values)
				&& Objects.equals(this.qualDefinition, qualifiedValues.qualDefinition);
	}

	@Override
	public int hashCode() {
		return Objects.hash(values, qualDefinition);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class QualifiedValues {\n");
