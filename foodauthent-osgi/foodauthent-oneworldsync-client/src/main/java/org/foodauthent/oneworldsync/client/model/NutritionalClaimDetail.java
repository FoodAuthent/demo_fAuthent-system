...
public class NutritionalClaimDetail {
	...
	private CodifiedValue nutritionalClaimNutrientElementCode = null;

	@JsonProperty("nutritionalClaimTypeCode")
	private CodifiedValue nutritionalClaimTypeCode = null;

	public NutritionalClaimDetail nutritionalClaimNutrientElementCode(
			CodifiedValue nutritionalClaimNutrientElementCode) {
		this.nutritionalClaimNutrientElementCode = nutritionalClaimNutrientElementCode;
		return this;
	}

	/**
	 * Get nutritionalClaimNutrientElementCode
	 * 
	 * @return nutritionalClaimNutrientElementCode
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getNutritionalClaimNutrientElementCode() {
		return nutritionalClaimNutrientElementCode;
	}

	public void setNutritionalClaimNutrientElementCode(CodifiedValue nutritionalClaimNutrientElementCode) {
		this.nutritionalClaimNutrientElementCode = nutritionalClaimNutrientElementCode;
	}

	public NutritionalClaimDetail nutritionalClaimTypeCode(CodifiedValue nutritionalClaimTypeCode) {
		this.nutritionalClaimTypeCode = nutritionalClaimTypeCode;
		return this;
	}

	/**
	 * Get nutritionalClaimTypeCode
	 * 
	 * @return nutritionalClaimTypeCode
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getNutritionalClaimTypeCode() {
		return nutritionalClaimTypeCode;
	}

	public void setNutritionalClaimTypeCode(CodifiedValue nutritionalClaimTypeCode) {
		this.nutritionalClaimTypeCode = nutritionalClaimTypeCode;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		NutritionalClaimDetail nutritionalClaimDetail = (NutritionalClaimDetail) o;
		return Objects.equals(this.nutritionalClaimNutrientElementCode,
				nutritionalClaimDetail.nutritionalClaimNutrientElementCode)
				&& Objects.equals(this.nutritionalClaimTypeCode, nutritionalClaimDetail.nutritionalClaimTypeCode);
	}

	@Override
	public int hashCode() {
		return Objects.hash(nutritionalClaimNutrientElementCode, nutritionalClaimTypeCode);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class NutritionalClaimDetail {\n");

		sb.append("    nutritionalClaimNutrientElementCode: ")
				.append(toIndentedString(nutritionalClaimNutrientElementCode)).append("\n");
		sb.append("    nutritionalClaimTypeCode: ").append(toIndentedString(nutritionalClaimTypeCode)).append("\n");
		sb.append("}");
		return sb.toString();
	}
