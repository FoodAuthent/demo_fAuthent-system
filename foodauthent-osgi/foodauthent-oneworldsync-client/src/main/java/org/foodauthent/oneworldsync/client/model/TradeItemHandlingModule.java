...
import org.foodauthent.oneworldsync.client.model.TradeItemHandlingInformation;
...
public class TradeItemHandlingModule {
	@JsonProperty("tradeItemHandlingInformation")
	private TradeItemHandlingInformation tradeItemHandlingInformation = null;

	public TradeItemHandlingModule tradeItemHandlingInformation(
			TradeItemHandlingInformation tradeItemHandlingInformation) {
		this.tradeItemHandlingInformation = tradeItemHandlingInformation;
		return this;
	}

	/**
	 * Get tradeItemHandlingInformation
	 * 
	 * @return tradeItemHandlingInformation
	 **/
	@ApiModelProperty(value = "")
	public TradeItemHandlingInformation getTradeItemHandlingInformation() {
		return tradeItemHandlingInformation;
	}

	public void setTradeItemHandlingInformation(TradeItemHandlingInformation tradeItemHandlingInformation) {
		this.tradeItemHandlingInformation = tradeItemHandlingInformation;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		TradeItemHandlingModule tradeItemHandlingModule = (TradeItemHandlingModule) o;
		return Objects.equals(this.tradeItemHandlingInformation, tradeItemHandlingModule.tradeItemHandlingInformation);
	}

	@Override
	public int hashCode() {
		return Objects.hash(tradeItemHandlingInformation);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class TradeItemHandlingModule {\n");

		sb.append("    tradeItemHandlingInformation: ").append(toIndentedString(tradeItemHandlingInformation))
				.append("\n");
		sb.append("}");
		return sb.toString();
	}
