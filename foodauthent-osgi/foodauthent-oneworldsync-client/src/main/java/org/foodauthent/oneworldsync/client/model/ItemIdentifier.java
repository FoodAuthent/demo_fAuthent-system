...
public class ItemIdentifier {
	...
	private CodifiedValue itemIdType = null;

	public ItemIdentifier isPrimary(String isPrimary) {
	...
	public ItemIdentifier itemId(String itemId) {
		this.itemId = itemId;
		return this;
	}
	...
	public ItemIdentifier itemIdType(CodifiedValue itemIdType) {
	 ...
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getItemIdType() {
		return itemIdType;
	}

	public void setItemIdType(CodifiedValue itemIdType) {
		this.itemIdType = itemIdType;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.isPrimary, itemIdentifier.isPrimary)
				&& Objects.equals(this.itemId, itemIdentifier.itemId)
				&& Objects.equals(this.itemIdType, itemIdentifier.itemIdType);
	}

	@Override
	public int hashCode() {
		return Objects.hash(isPrimary, itemId, itemIdType);
	}
	...
	public String toString() {
		...
		sb.append("    itemIdType: ").append(toIndentedString(itemIdType)).append("\n");
		sb.append("}");
		return sb.toString();
	}
