...
public class CodifiedValues {
	...
	public CodifiedValues values(List<String> values) {
		this.values = values;
		return this;
	}

	public CodifiedValues addValuesItem(String valuesItem) {
		if (this.values == null) {
	...
	public CodifiedValues valueDefinition(String valueDefinition) {
	...
	public boolean equals(java.lang.Object o) {
		...
		CodifiedValues codifiedValues = (CodifiedValues) o;
		return Objects.equals(this.values, codifiedValues.values)
				&& Objects.equals(this.valueDefinition, codifiedValues.valueDefinition);
	}

	@Override
	public int hashCode() {
		return Objects.hash(values, valueDefinition);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class CodifiedValues {\n");
