...
import org.foodauthent.oneworldsync.client.model.ProductAcivityDetails;
...
public class PlaceOfProductActivity {
	...
	@JsonProperty("productAcivityDetails")
	private List<ProductAcivityDetails> productAcivityDetails = null;

	@JsonProperty("provenanceStatement")
	private LanguageLabels provenanceStatement = null;

	public PlaceOfProductActivity countryOfOrigin(List<CountryOfOrigin> countryOfOrigin) {
		this.countryOfOrigin = countryOfOrigin;
		return this;
	}

	public PlaceOfProductActivity addCountryOfOriginItem(CountryOfOrigin countryOfOriginItem) {
	...
	public PlaceOfProductActivity countryOfOriginStatement(LanguageLabels countryOfOriginStatement) {
	...
	public PlaceOfProductActivity productAcivityDetails(List<ProductAcivityDetails> productAcivityDetails) {
		this.productAcivityDetails = productAcivityDetails;
		return this;
	}

	public PlaceOfProductActivity addProductAcivityDetailsItem(ProductAcivityDetails productAcivityDetailsItem) {
		if (this.productAcivityDetails == null) {
			this.productAcivityDetails = new ArrayList<ProductAcivityDetails>();
		}
		this.productAcivityDetails.add(productAcivityDetailsItem);
		return this;
	}

	/**
	 * Get productAcivityDetails
	 * 
	 * @return productAcivityDetails
	 **/
	@ApiModelProperty(value = "")
	public List<ProductAcivityDetails> getProductAcivityDetails() {
		return productAcivityDetails;
	}

	public void setProductAcivityDetails(List<ProductAcivityDetails> productAcivityDetails) {
		this.productAcivityDetails = productAcivityDetails;
	}

	public PlaceOfProductActivity provenanceStatement(LanguageLabels provenanceStatement) {
	...
	public boolean equals(java.lang.Object o) {
		...
		PlaceOfProductActivity placeOfProductActivity = (PlaceOfProductActivity) o;
		return Objects.equals(this.countryOfOrigin, placeOfProductActivity.countryOfOrigin)
				&& Objects.equals(this.countryOfOriginStatement, placeOfProductActivity.countryOfOriginStatement)
				&& Objects.equals(this.productAcivityDetails, placeOfProductActivity.productAcivityDetails)
				&& Objects.equals(this.provenanceStatement, placeOfProductActivity.provenanceStatement);
	}

	@Override
	public int hashCode() {
		return Objects.hash(countryOfOrigin, countryOfOriginStatement, productAcivityDetails, provenanceStatement);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class PlaceOfProductActivity {\n");
		...
		sb.append("    productAcivityDetails: ").append(toIndentedString(productAcivityDetails)).append("\n");
