...
public class ConsumerWarningInformation {
	@JsonProperty("consumerWarningDescription")
	private LanguageLabels consumerWarningDescription = null;

	@JsonProperty("consumerWarningTypeCode")
	private CodifiedValue consumerWarningTypeCode = null;

	public ConsumerWarningInformation consumerWarningDescription(LanguageLabels consumerWarningDescription) {
		this.consumerWarningDescription = consumerWarningDescription;
		return this;
	}

	/**
	 * Get consumerWarningDescription
	 * 
	 * @return consumerWarningDescription
	 **/
	@ApiModelProperty(value = "")
	public LanguageLabels getConsumerWarningDescription() {
		return consumerWarningDescription;
	}

	public void setConsumerWarningDescription(LanguageLabels consumerWarningDescription) {
		this.consumerWarningDescription = consumerWarningDescription;
	}

	public ConsumerWarningInformation consumerWarningTypeCode(CodifiedValue consumerWarningTypeCode) {
		this.consumerWarningTypeCode = consumerWarningTypeCode;
		return this;
	}

	/**
	 * Get consumerWarningTypeCode
	 * 
	 * @return consumerWarningTypeCode
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getConsumerWarningTypeCode() {
		return consumerWarningTypeCode;
	}

	public void setConsumerWarningTypeCode(CodifiedValue consumerWarningTypeCode) {
		this.consumerWarningTypeCode = consumerWarningTypeCode;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		ConsumerWarningInformation consumerWarningInformation = (ConsumerWarningInformation) o;
		return Objects.equals(this.consumerWarningDescription, consumerWarningInformation.consumerWarningDescription)
				&& Objects.equals(this.consumerWarningTypeCode, consumerWarningInformation.consumerWarningTypeCode);
	}

	@Override
	public int hashCode() {
		return Objects.hash(consumerWarningDescription, consumerWarningTypeCode);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class ConsumerWarningInformation {\n");

		sb.append("    consumerWarningDescription: ").append(toIndentedString(consumerWarningDescription)).append("\n");
		sb.append("    consumerWarningTypeCode: ").append(toIndentedString(consumerWarningTypeCode)).append("\n");
		sb.append("}");
		return sb.toString();
	}
