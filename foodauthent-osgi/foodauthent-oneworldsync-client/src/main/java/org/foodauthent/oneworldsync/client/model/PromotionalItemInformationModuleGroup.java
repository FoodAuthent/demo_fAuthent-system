...
import org.foodauthent.oneworldsync.client.model.PromotionalItemInformationModule;
import org.foodauthent.oneworldsync.client.model.Recipient;

/**
 * PromotionalItemInformationModuleGroup
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-07-25T20:10:55.785Z")
public class PromotionalItemInformationModuleGroup {
	@JsonProperty("promotionalItemInformationModule")
	private PromotionalItemInformationModule promotionalItemInformationModule = null;

	@JsonProperty("recipient")
	private Recipient recipient = null;

	public PromotionalItemInformationModuleGroup promotionalItemInformationModule(
			PromotionalItemInformationModule promotionalItemInformationModule) {
		this.promotionalItemInformationModule = promotionalItemInformationModule;
		return this;
	}

	/**
	 * Get promotionalItemInformationModule
	 * 
	 * @return promotionalItemInformationModule
	 **/
	@ApiModelProperty(value = "")
	public PromotionalItemInformationModule getPromotionalItemInformationModule() {
		return promotionalItemInformationModule;
	}

	public void setPromotionalItemInformationModule(PromotionalItemInformationModule promotionalItemInformationModule) {
		this.promotionalItemInformationModule = promotionalItemInformationModule;
	}

	public PromotionalItemInformationModuleGroup recipient(Recipient recipient) {
	...
	public boolean equals(java.lang.Object o) {
		...
		PromotionalItemInformationModuleGroup promotionalItemInformationModuleGroup = (PromotionalItemInformationModuleGroup) o;
		return Objects.equals(this.promotionalItemInformationModule,
				promotionalItemInformationModuleGroup.promotionalItemInformationModule)
				&& Objects.equals(this.recipient, promotionalItemInformationModuleGroup.recipient);
	}

	@Override
	public int hashCode() {
		return Objects.hash(promotionalItemInformationModule, recipient);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class PromotionalItemInformationModuleGroup {\n");

		sb.append("    promotionalItemInformationModule: ").append(toIndentedString(promotionalItemInformationModule))
				.append("\n");
