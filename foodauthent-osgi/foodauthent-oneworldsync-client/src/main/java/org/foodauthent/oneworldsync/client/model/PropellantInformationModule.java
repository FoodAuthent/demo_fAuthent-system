...
import org.foodauthent.oneworldsync.client.model.PropellantInformation;

/**
 * PropellantInformationModule
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-07-25T20:10:55.785Z")
public class PropellantInformationModule {
	@JsonProperty("propellantInformation")
	private PropellantInformation propellantInformation = null;

	public PropellantInformationModule propellantInformation(PropellantInformation propellantInformation) {
		this.propellantInformation = propellantInformation;
		return this;
	}

	/**
	 * Get propellantInformation
	 * 
	 * @return propellantInformation
	 **/
	@ApiModelProperty(value = "")
	public PropellantInformation getPropellantInformation() {
		return propellantInformation;
	}

	public void setPropellantInformation(PropellantInformation propellantInformation) {
		this.propellantInformation = propellantInformation;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		PropellantInformationModule propellantInformationModule = (PropellantInformationModule) o;
		return Objects.equals(this.propellantInformation, propellantInformationModule.propellantInformation);
	}

	@Override
	public int hashCode() {
		return Objects.hash(propellantInformation);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class PropellantInformationModule {\n");

		sb.append("    propellantInformation: ").append(toIndentedString(propellantInformation)).append("\n");
		sb.append("}");
		return sb.toString();
	}
