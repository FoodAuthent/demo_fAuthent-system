...
import org.foodauthent.oneworldsync.client.model.SecurityTagInformation;

/**
 * SecurityTagInformationModule
 */
...
public class SecurityTagInformationModule {
	@JsonProperty("securityTagInformation")
	private List<SecurityTagInformation> securityTagInformation = null;

	public SecurityTagInformationModule securityTagInformation(List<SecurityTagInformation> securityTagInformation) {
		this.securityTagInformation = securityTagInformation;
		return this;
	}

	public SecurityTagInformationModule addSecurityTagInformationItem(
			SecurityTagInformation securityTagInformationItem) {
		if (this.securityTagInformation == null) {
			this.securityTagInformation = new ArrayList<SecurityTagInformation>();
		}
		this.securityTagInformation.add(securityTagInformationItem);
		return this;
	}

	/**
	 * Get securityTagInformation
	 * 
	 * @return securityTagInformation
	 **/
	@ApiModelProperty(value = "")
	public List<SecurityTagInformation> getSecurityTagInformation() {
		return securityTagInformation;
	}

	public void setSecurityTagInformation(List<SecurityTagInformation> securityTagInformation) {
		this.securityTagInformation = securityTagInformation;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		SecurityTagInformationModule securityTagInformationModule = (SecurityTagInformationModule) o;
		return Objects.equals(this.securityTagInformation, securityTagInformationModule.securityTagInformation);
	}

	@Override
	public int hashCode() {
		return Objects.hash(securityTagInformation);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class SecurityTagInformationModule {\n");

		sb.append("    securityTagInformation: ").append(toIndentedString(securityTagInformation)).append("\n");
		sb.append("}");
		return sb.toString();
	}
