...
public class OrganicCertification {
	@JsonProperty("organicCertificationEffectiveEndDateTime")
	private String organicCertificationEffectiveEndDateTime = null;

	@JsonProperty("organicCertificationEffectiveStartDateTime")
	private String organicCertificationEffectiveStartDateTime = null;

	@JsonProperty("organicCertificationIdentification")
	private String organicCertificationIdentification = null;

	public OrganicCertification organicCertificationEffectiveEndDateTime(
			String organicCertificationEffectiveEndDateTime) {
		this.organicCertificationEffectiveEndDateTime = organicCertificationEffectiveEndDateTime;
		return this;
	}

	/**
	 * Get organicCertificationEffectiveEndDateTime
	 * 
	 * @return organicCertificationEffectiveEndDateTime
	 **/
	@ApiModelProperty(value = "")
	public String getOrganicCertificationEffectiveEndDateTime() {
		return organicCertificationEffectiveEndDateTime;
	}

	public void setOrganicCertificationEffectiveEndDateTime(String organicCertificationEffectiveEndDateTime) {
		this.organicCertificationEffectiveEndDateTime = organicCertificationEffectiveEndDateTime;
	}

	public OrganicCertification organicCertificationEffectiveStartDateTime(
			String organicCertificationEffectiveStartDateTime) {
		this.organicCertificationEffectiveStartDateTime = organicCertificationEffectiveStartDateTime;
		return this;
	}

	/**
	 * Get organicCertificationEffectiveStartDateTime
	 * 
	 * @return organicCertificationEffectiveStartDateTime
	 **/
	@ApiModelProperty(value = "")
	public String getOrganicCertificationEffectiveStartDateTime() {
		return organicCertificationEffectiveStartDateTime;
	}

	public void setOrganicCertificationEffectiveStartDateTime(String organicCertificationEffectiveStartDateTime) {
		this.organicCertificationEffectiveStartDateTime = organicCertificationEffectiveStartDateTime;
	}

	public OrganicCertification organicCertificationIdentification(String organicCertificationIdentification) {
		this.organicCertificationIdentification = organicCertificationIdentification;
		return this;
	}

	/**
	 * Get organicCertificationIdentification
	 * 
	...
	public void setOrganicCertificationIdentification(String organicCertificationIdentification) {
		this.organicCertificationIdentification = organicCertificationIdentification;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		OrganicCertification organicCertification = (OrganicCertification) o;
		return Objects.equals(this.organicCertificationEffectiveEndDateTime,
				organicCertification.organicCertificationEffectiveEndDateTime)
				&& Objects.equals(this.organicCertificationEffectiveStartDateTime,
						organicCertification.organicCertificationEffectiveStartDateTime)
				&& Objects.equals(this.organicCertificationIdentification,
						organicCertification.organicCertificationIdentification);
	}

	@Override
	public int hashCode() {
		return Objects.hash(organicCertificationEffectiveEndDateTime, organicCertificationEffectiveStartDateTime,
	...
	public String toString() {
		...
		sb.append("class OrganicCertification {\n");

		sb.append("    organicCertificationEffectiveEndDateTime: ")
				.append(toIndentedString(organicCertificationEffectiveEndDateTime)).append("\n");
		sb.append("    organicCertificationEffectiveStartDateTime: ")
				.append(toIndentedString(organicCertificationEffectiveStartDateTime)).append("\n");
		sb.append("    organicCertificationIdentification: ")
				.append(toIndentedString(organicCertificationIdentification)).append("\n");
		sb.append("}");
		return sb.toString();
	}
