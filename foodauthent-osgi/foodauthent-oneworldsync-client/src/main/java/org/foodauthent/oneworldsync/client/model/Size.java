...
import org.foodauthent.oneworldsync.client.model.SizeCode;
...
public class Size {
	...
	private LanguageLabels descriptiveSize = null;

	@JsonProperty("sizeCode")
	private SizeCode sizeCode = null;

	public Size descriptiveSize(LanguageLabels descriptiveSize) {
	...
	public LanguageLabels getDescriptiveSize() {
		return descriptiveSize;
	}

	public void setDescriptiveSize(LanguageLabels descriptiveSize) {
		this.descriptiveSize = descriptiveSize;
	}

	public Size sizeCode(SizeCode sizeCode) {
	...
	public boolean equals(java.lang.Object o) {
		...
		Size size = (Size) o;
		return Objects.equals(this.descriptiveSize, size.descriptiveSize)
				&& Objects.equals(this.sizeCode, size.sizeCode);
	}

	@Override
	public int hashCode() {
		return Objects.hash(descriptiveSize, sizeCode);
	}
	...
	public String toString() {
		...
		sb.append("    descriptiveSize: ").append(toIndentedString(descriptiveSize)).append("\n");
