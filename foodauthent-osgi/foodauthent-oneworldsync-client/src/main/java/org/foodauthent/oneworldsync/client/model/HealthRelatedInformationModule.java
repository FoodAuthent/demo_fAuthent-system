...
import org.foodauthent.oneworldsync.client.model.HealthRelatedInformation;
...
public class HealthRelatedInformationModule {
	@JsonProperty("healthRelatedInformation")
	private List<HealthRelatedInformation> healthRelatedInformation = null;

	public HealthRelatedInformationModule healthRelatedInformation(
			List<HealthRelatedInformation> healthRelatedInformation) {
		this.healthRelatedInformation = healthRelatedInformation;
		return this;
	}

	public HealthRelatedInformationModule addHealthRelatedInformationItem(
			HealthRelatedInformation healthRelatedInformationItem) {
		if (this.healthRelatedInformation == null) {
			this.healthRelatedInformation = new ArrayList<HealthRelatedInformation>();
		}
		this.healthRelatedInformation.add(healthRelatedInformationItem);
		return this;
	}

	/**
	 * Get healthRelatedInformation
	 * 
	 * @return healthRelatedInformation
	 **/
	@ApiModelProperty(value = "")
	public List<HealthRelatedInformation> getHealthRelatedInformation() {
		return healthRelatedInformation;
	}

	public void setHealthRelatedInformation(List<HealthRelatedInformation> healthRelatedInformation) {
		this.healthRelatedInformation = healthRelatedInformation;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		HealthRelatedInformationModule healthRelatedInformationModule = (HealthRelatedInformationModule) o;
		return Objects.equals(this.healthRelatedInformation, healthRelatedInformationModule.healthRelatedInformation);
	}

	@Override
	public int hashCode() {
		return Objects.hash(healthRelatedInformation);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class HealthRelatedInformationModule {\n");

		sb.append("    healthRelatedInformation: ").append(toIndentedString(healthRelatedInformation)).append("\n");
		sb.append("}");
		return sb.toString();
	}
