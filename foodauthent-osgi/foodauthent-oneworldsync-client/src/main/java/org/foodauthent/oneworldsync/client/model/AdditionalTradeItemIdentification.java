...
public class AdditionalTradeItemIdentification {
	...
	private CodifiedValue additionalTradeItemIdentificationTypeCode = null;

	@JsonProperty("additionalTradeItemIdentificationValue")
	private String additionalTradeItemIdentificationValue = null;
	...
	public AdditionalTradeItemIdentification additionalTradeItemIdentificationTypeCode(
			CodifiedValue additionalTradeItemIdentificationTypeCode) {
		this.additionalTradeItemIdentificationTypeCode = additionalTradeItemIdentificationTypeCode;
		return this;
	}

	/**
	 * Get additionalTradeItemIdentificationTypeCode
	 * 
	 * @return additionalTradeItemIdentificationTypeCode
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getAdditionalTradeItemIdentificationTypeCode() {
		return additionalTradeItemIdentificationTypeCode;
	}

	public void setAdditionalTradeItemIdentificationTypeCode(CodifiedValue additionalTradeItemIdentificationTypeCode) {
		this.additionalTradeItemIdentificationTypeCode = additionalTradeItemIdentificationTypeCode;
	}

	public AdditionalTradeItemIdentification additionalTradeItemIdentificationValue(
			String additionalTradeItemIdentificationValue) {
		this.additionalTradeItemIdentificationValue = additionalTradeItemIdentificationValue;
		return this;
	}

	/**
	 * Get additionalTradeItemIdentificationValue
	 * 
	...
	public void setAdditionalTradeItemIdentificationValue(String additionalTradeItemIdentificationValue) {
		this.additionalTradeItemIdentificationValue = additionalTradeItemIdentificationValue;
	}

	public AdditionalTradeItemIdentification tradeItemId(String tradeItemId) {
	...
	public AdditionalTradeItemIdentification tradeItemIdType(CodifiedValue tradeItemIdType) {
	...
	public boolean equals(java.lang.Object o) {
		...
		AdditionalTradeItemIdentification additionalTradeItemIdentification = (AdditionalTradeItemIdentification) o;
		return Objects.equals(this.additionalTradeItemIdentificationTypeCode,
				additionalTradeItemIdentification.additionalTradeItemIdentificationTypeCode)
				&& Objects.equals(this.additionalTradeItemIdentificationValue,
						additionalTradeItemIdentification.additionalTradeItemIdentificationValue)
				&& Objects.equals(this.tradeItemId, additionalTradeItemIdentification.tradeItemId)
				&& Objects.equals(this.tradeItemIdType, additionalTradeItemIdentification.tradeItemIdType);
	}

	@Override
	public int hashCode() {
		return Objects.hash(additionalTradeItemIdentificationTypeCode, additionalTradeItemIdentificationValue,
				tradeItemId, tradeItemIdType);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class AdditionalTradeItemIdentification {\n");

		sb.append("    additionalTradeItemIdentificationTypeCode: ")
				.append(toIndentedString(additionalTradeItemIdentificationTypeCode)).append("\n");
		sb.append("    additionalTradeItemIdentificationValue: ")
				.append(toIndentedString(additionalTradeItemIdentificationValue)).append("\n");
