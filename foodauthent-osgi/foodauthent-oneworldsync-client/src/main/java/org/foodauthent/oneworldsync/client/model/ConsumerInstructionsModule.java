...
import org.foodauthent.oneworldsync.client.model.ConsumerInstructions;
import org.foodauthent.oneworldsync.client.model.ConsumerUsageLabelCode;
...
public class ConsumerInstructionsModule {
	...
	private ConsumerInstructions consumerInstructions = null;

	@JsonProperty("consumerUsageLabelCode")
	private List<ConsumerUsageLabelCode> consumerUsageLabelCode = null;

	public ConsumerInstructionsModule consumerInstructions(ConsumerInstructions consumerInstructions) {
		this.consumerInstructions = consumerInstructions;
		return this;
	}

	/**
	 * Get consumerInstructions
	 * 
	 * @return consumerInstructions
	 **/
	@ApiModelProperty(value = "")
	public ConsumerInstructions getConsumerInstructions() {
		return consumerInstructions;
	}

	public void setConsumerInstructions(ConsumerInstructions consumerInstructions) {
		this.consumerInstructions = consumerInstructions;
	}

	public ConsumerInstructionsModule consumerUsageLabelCode(List<ConsumerUsageLabelCode> consumerUsageLabelCode) {
		this.consumerUsageLabelCode = consumerUsageLabelCode;
		return this;
	}

	public ConsumerInstructionsModule addConsumerUsageLabelCodeItem(ConsumerUsageLabelCode consumerUsageLabelCodeItem) {
		if (this.consumerUsageLabelCode == null) {
			this.consumerUsageLabelCode = new ArrayList<ConsumerUsageLabelCode>();
		}
		this.consumerUsageLabelCode.add(consumerUsageLabelCodeItem);
		return this;
	}

	/**
	 * Get consumerUsageLabelCode
	 * 
	 * @return consumerUsageLabelCode
	 **/
	@ApiModelProperty(value = "")
	public List<ConsumerUsageLabelCode> getConsumerUsageLabelCode() {
		return consumerUsageLabelCode;
	}

	public void setConsumerUsageLabelCode(List<ConsumerUsageLabelCode> consumerUsageLabelCode) {
		this.consumerUsageLabelCode = consumerUsageLabelCode;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		ConsumerInstructionsModule consumerInstructionsModule = (ConsumerInstructionsModule) o;
		return Objects.equals(this.consumerInstructions, consumerInstructionsModule.consumerInstructions)
				&& Objects.equals(this.consumerUsageLabelCode, consumerInstructionsModule.consumerUsageLabelCode);
	}

	@Override
	public int hashCode() {
		return Objects.hash(consumerInstructions, consumerUsageLabelCode);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class ConsumerInstructionsModule {\n");

		sb.append("    consumerInstructions: ").append(toIndentedString(consumerInstructions)).append("\n");
		sb.append("    consumerUsageLabelCode: ").append(toIndentedString(consumerUsageLabelCode)).append("\n");
		sb.append("}");
		return sb.toString();
	}
