...
public class MarketingCampaign {
	@JsonProperty("campaignEndDateTime")
	private String campaignEndDateTime = null;

	@JsonProperty("campaignMediaTypeDescription")
	private LanguageLabels campaignMediaTypeDescription = null;

	@JsonProperty("campaignName")
	private LanguageLabels campaignName = null;

	@JsonProperty("campaignStartDateTime")
	private String campaignStartDateTime = null;

	public MarketingCampaign campaignEndDateTime(String campaignEndDateTime) {
		this.campaignEndDateTime = campaignEndDateTime;
		return this;
	}

	/**
	 * Get campaignEndDateTime
	 * 
	...
	public MarketingCampaign campaignMediaTypeDescription(LanguageLabels campaignMediaTypeDescription) {
		this.campaignMediaTypeDescription = campaignMediaTypeDescription;
		return this;
	}

	/**
	 * Get campaignMediaTypeDescription
	 * 
	 * @return campaignMediaTypeDescription
	 **/
	@ApiModelProperty(value = "")
	public LanguageLabels getCampaignMediaTypeDescription() {
		return campaignMediaTypeDescription;
	}

	public void setCampaignMediaTypeDescription(LanguageLabels campaignMediaTypeDescription) {
		this.campaignMediaTypeDescription = campaignMediaTypeDescription;
	}

	public MarketingCampaign campaignName(LanguageLabels campaignName) {
	 ...
	 **/
	@ApiModelProperty(value = "")
	public LanguageLabels getCampaignName() {
		return campaignName;
	}

	public void setCampaignName(LanguageLabels campaignName) {
		this.campaignName = campaignName;
	}

	public MarketingCampaign campaignStartDateTime(String campaignStartDateTime) {
		this.campaignStartDateTime = campaignStartDateTime;
		return this;
	}

	/**
	 * Get campaignStartDateTime
	 * 
	...
	public boolean equals(java.lang.Object o) {
		...
		MarketingCampaign marketingCampaign = (MarketingCampaign) o;
		return Objects.equals(this.campaignEndDateTime, marketingCampaign.campaignEndDateTime)
				&& Objects.equals(this.campaignMediaTypeDescription, marketingCampaign.campaignMediaTypeDescription)
				&& Objects.equals(this.campaignName, marketingCampaign.campaignName)
				&& Objects.equals(this.campaignStartDateTime, marketingCampaign.campaignStartDateTime);
	}

	@Override
	public int hashCode() {
		return Objects.hash(campaignEndDateTime, campaignMediaTypeDescription, campaignName, campaignStartDateTime);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class MarketingCampaign {\n");

		sb.append("    campaignEndDateTime: ").append(toIndentedString(campaignEndDateTime)).append("\n");
		sb.append("    campaignMediaTypeDescription: ").append(toIndentedString(campaignMediaTypeDescription))
				.append("\n");
		sb.append("    campaignName: ").append(toIndentedString(campaignName)).append("\n");
		sb.append("    campaignStartDateTime: ").append(toIndentedString(campaignStartDateTime)).append("\n");
		sb.append("}");
		return sb.toString();
	}
