...
import org.foodauthent.oneworldsync.client.model.CommunicationChannel;
...
public class TargetMarketCommunicationChannel {
	...
	public TargetMarketCommunicationChannel communicationChannel(List<CommunicationChannel> communicationChannel) {
		this.communicationChannel = communicationChannel;
		return this;
	}

	public TargetMarketCommunicationChannel addCommunicationChannelItem(CommunicationChannel communicationChannelItem) {
		if (this.communicationChannel == null) {
			this.communicationChannel = new ArrayList<CommunicationChannel>();
		}
	...
	public TargetMarketCommunicationChannel targetMarket(List<TargetMarket> targetMarket) {
		this.targetMarket = targetMarket;
		return this;
	}

	public TargetMarketCommunicationChannel addTargetMarketItem(TargetMarket targetMarketItem) {
	...
	public boolean equals(java.lang.Object o) {
		...
		TargetMarketCommunicationChannel targetMarketCommunicationChannel = (TargetMarketCommunicationChannel) o;
		return Objects.equals(this.communicationChannel, targetMarketCommunicationChannel.communicationChannel)
				&& Objects.equals(this.targetMarket, targetMarketCommunicationChannel.targetMarket);
	}

	@Override
	public int hashCode() {
		return Objects.hash(communicationChannel, targetMarket);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class TargetMarketCommunicationChannel {\n");
