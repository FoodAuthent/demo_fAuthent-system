...
public class ChannelSpecificMarketingMessage {
	@JsonProperty("channelSpecificMarketingMessage")
	private LanguageLabels channelSpecificMarketingMessage = null;
	...
	public ChannelSpecificMarketingMessage channelSpecificMarketingMessage(
			LanguageLabels channelSpecificMarketingMessage) {
	...
	public LanguageLabels getChannelSpecificMarketingMessage() {
		return channelSpecificMarketingMessage;
	}

	public void setChannelSpecificMarketingMessage(LanguageLabels channelSpecificMarketingMessage) {
		this.channelSpecificMarketingMessage = channelSpecificMarketingMessage;
	}

	public ChannelSpecificMarketingMessage formattingPattern(String formattingPattern) {
	...
	public ChannelSpecificMarketingMessage sequenceNumber(String sequenceNumber) {
	...
	public boolean equals(java.lang.Object o) {
		...
		ChannelSpecificMarketingMessage channelSpecificMarketingMessage = (ChannelSpecificMarketingMessage) o;
		return Objects.equals(this.channelSpecificMarketingMessage,
				channelSpecificMarketingMessage.channelSpecificMarketingMessage)
				&& Objects.equals(this.formattingPattern, channelSpecificMarketingMessage.formattingPattern)
				&& Objects.equals(this.sequenceNumber, channelSpecificMarketingMessage.sequenceNumber);
	}

	@Override
	public int hashCode() {
		return Objects.hash(channelSpecificMarketingMessage, formattingPattern, sequenceNumber);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class ChannelSpecificMarketingMessage {\n");
