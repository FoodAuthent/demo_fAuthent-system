...
public class ProductCategoryCodes {
	...
	private CodifiedValue productCategoryCode = null;

	@JsonProperty("productCategoryComponent")
	private CodifiedValue productCategoryComponent = null;

	public ProductCategoryCodes productCategoryCode(CodifiedValue productCategoryCode) {
	...
	public CodifiedValue getProductCategoryCode() {
		return productCategoryCode;
	}

	public void setProductCategoryCode(CodifiedValue productCategoryCode) {
		this.productCategoryCode = productCategoryCode;
	}

	public ProductCategoryCodes productCategoryComponent(CodifiedValue productCategoryComponent) {
		this.productCategoryComponent = productCategoryComponent;
		return this;
	}

	/**
	 * Get productCategoryComponent
	 * 
	 * @return productCategoryComponent
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getProductCategoryComponent() {
		return productCategoryComponent;
	}

	public void setProductCategoryComponent(CodifiedValue productCategoryComponent) {
		this.productCategoryComponent = productCategoryComponent;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		ProductCategoryCodes productCategoryCodes = (ProductCategoryCodes) o;
		return Objects.equals(this.productCategoryCode, productCategoryCodes.productCategoryCode)
				&& Objects.equals(this.productCategoryComponent, productCategoryCodes.productCategoryComponent);
	}

	@Override
	public int hashCode() {
		return Objects.hash(productCategoryCode, productCategoryComponent);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class ProductCategoryCodes {\n");

		sb.append("    productCategoryCode: ").append(toIndentedString(productCategoryCode)).append("\n");
		sb.append("    productCategoryComponent: ").append(toIndentedString(productCategoryComponent)).append("\n");
		sb.append("}");
		return sb.toString();
	}
