...
public class FoodBeverageComposition {
	@JsonProperty("foodBeverageCompositionCode")
	private String foodBeverageCompositionCode = null;

	@JsonProperty("foodBeverageCompositionDatabaseCode")
	private CodifiedValue foodBeverageCompositionDatabaseCode = null;

	@JsonProperty("foodBeverageCompositionDescription")
	private String foodBeverageCompositionDescription = null;

	public FoodBeverageComposition foodBeverageCompositionCode(String foodBeverageCompositionCode) {
		this.foodBeverageCompositionCode = foodBeverageCompositionCode;
		return this;
	}

	/**
	 * Get foodBeverageCompositionCode
	 * 
	...
	public void setFoodBeverageCompositionCode(String foodBeverageCompositionCode) {
		this.foodBeverageCompositionCode = foodBeverageCompositionCode;
	}

	public FoodBeverageComposition foodBeverageCompositionDatabaseCode(
			CodifiedValue foodBeverageCompositionDatabaseCode) {
		this.foodBeverageCompositionDatabaseCode = foodBeverageCompositionDatabaseCode;
		return this;
	}

	/**
	 * Get foodBeverageCompositionDatabaseCode
	 * 
	 * @return foodBeverageCompositionDatabaseCode
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getFoodBeverageCompositionDatabaseCode() {
		return foodBeverageCompositionDatabaseCode;
	}

	public void setFoodBeverageCompositionDatabaseCode(CodifiedValue foodBeverageCompositionDatabaseCode) {
		this.foodBeverageCompositionDatabaseCode = foodBeverageCompositionDatabaseCode;
	}

	public FoodBeverageComposition foodBeverageCompositionDescription(String foodBeverageCompositionDescription) {
		this.foodBeverageCompositionDescription = foodBeverageCompositionDescription;
		return this;
	}

	/**
	 * Get foodBeverageCompositionDescription
	 * 
	...
	public void setFoodBeverageCompositionDescription(String foodBeverageCompositionDescription) {
		this.foodBeverageCompositionDescription = foodBeverageCompositionDescription;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		FoodBeverageComposition foodBeverageComposition = (FoodBeverageComposition) o;
		return Objects.equals(this.foodBeverageCompositionCode, foodBeverageComposition.foodBeverageCompositionCode)
				&& Objects.equals(this.foodBeverageCompositionDatabaseCode,
						foodBeverageComposition.foodBeverageCompositionDatabaseCode)
				&& Objects.equals(this.foodBeverageCompositionDescription,
						foodBeverageComposition.foodBeverageCompositionDescription);
	}

	@Override
	public int hashCode() {
		return Objects.hash(foodBeverageCompositionCode, foodBeverageCompositionDatabaseCode,
	...
	public String toString() {
		...
		sb.append("class FoodBeverageComposition {\n");

		sb.append("    foodBeverageCompositionCode: ").append(toIndentedString(foodBeverageCompositionCode))
				.append("\n");
		sb.append("    foodBeverageCompositionDatabaseCode: ")
				.append(toIndentedString(foodBeverageCompositionDatabaseCode)).append("\n");
		sb.append("    foodBeverageCompositionDescription: ")
				.append(toIndentedString(foodBeverageCompositionDescription)).append("\n");
		sb.append("}");
		return sb.toString();
	}
