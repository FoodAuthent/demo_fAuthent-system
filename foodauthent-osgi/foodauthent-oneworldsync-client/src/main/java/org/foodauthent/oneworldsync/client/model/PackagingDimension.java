...
public class PackagingDimension {
	@JsonProperty("packagingDepth")
	private QualifiedValue packagingDepth = null;

	@JsonProperty("packagingHeight")
	private QualifiedValue packagingHeight = null;

	@JsonProperty("packagingWidth")
	private QualifiedValue packagingWidth = null;

	public PackagingDimension packagingDepth(QualifiedValue packagingDepth) {
	...
	public QualifiedValue getPackagingDepth() {
		return packagingDepth;
	}

	public void setPackagingDepth(QualifiedValue packagingDepth) {
		this.packagingDepth = packagingDepth;
	}

	public PackagingDimension packagingHeight(QualifiedValue packagingHeight) {
	 ...
	 **/
	@ApiModelProperty(value = "")
	public QualifiedValue getPackagingHeight() {
		return packagingHeight;
	}

	public void setPackagingHeight(QualifiedValue packagingHeight) {
		this.packagingHeight = packagingHeight;
	}

	public PackagingDimension packagingWidth(QualifiedValue packagingWidth) {
	 ...
	 **/
	@ApiModelProperty(value = "")
	public QualifiedValue getPackagingWidth() {
		return packagingWidth;
	}

	public void setPackagingWidth(QualifiedValue packagingWidth) {
		this.packagingWidth = packagingWidth;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		PackagingDimension packagingDimension = (PackagingDimension) o;
		return Objects.equals(this.packagingDepth, packagingDimension.packagingDepth)
				&& Objects.equals(this.packagingHeight, packagingDimension.packagingHeight)
				&& Objects.equals(this.packagingWidth, packagingDimension.packagingWidth);
	}

	@Override
	public int hashCode() {
		return Objects.hash(packagingDepth, packagingHeight, packagingWidth);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class PackagingDimension {\n");

		sb.append("    packagingDepth: ").append(toIndentedString(packagingDepth)).append("\n");
		sb.append("    packagingHeight: ").append(toIndentedString(packagingHeight)).append("\n");
		sb.append("    packagingWidth: ").append(toIndentedString(packagingWidth)).append("\n");
		sb.append("}");
		return sb.toString();
	}
