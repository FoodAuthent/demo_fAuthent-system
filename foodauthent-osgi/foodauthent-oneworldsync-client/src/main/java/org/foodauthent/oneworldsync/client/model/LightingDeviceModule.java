...
import org.foodauthent.oneworldsync.client.model.LightBulbInformation;
...
public class LightingDeviceModule {
	@JsonProperty("lightBulbInformation")
	private List<LightBulbInformation> lightBulbInformation = null;

	public LightingDeviceModule lightBulbInformation(List<LightBulbInformation> lightBulbInformation) {
		this.lightBulbInformation = lightBulbInformation;
		return this;
	}

	public LightingDeviceModule addLightBulbInformationItem(LightBulbInformation lightBulbInformationItem) {
		if (this.lightBulbInformation == null) {
			this.lightBulbInformation = new ArrayList<LightBulbInformation>();
		}
		this.lightBulbInformation.add(lightBulbInformationItem);
		return this;
	}

	/**
	 * Get lightBulbInformation
	 * 
	 * @return lightBulbInformation
	 **/
	@ApiModelProperty(value = "")
	public List<LightBulbInformation> getLightBulbInformation() {
		return lightBulbInformation;
	}

	public void setLightBulbInformation(List<LightBulbInformation> lightBulbInformation) {
		this.lightBulbInformation = lightBulbInformation;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		LightingDeviceModule lightingDeviceModule = (LightingDeviceModule) o;
		return Objects.equals(this.lightBulbInformation, lightingDeviceModule.lightBulbInformation);
	}

	@Override
	public int hashCode() {
		return Objects.hash(lightBulbInformation);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class LightingDeviceModule {\n");

		sb.append("    lightBulbInformation: ").append(toIndentedString(lightBulbInformation)).append("\n");
		sb.append("}");
		return sb.toString();
	}
