...
public class ShapeGroup {
	...
	public ShapeGroup recipient(Recipient recipient) {
	...
	public ShapeGroup shape(String shape) {
		this.shape = shape;
		return this;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		ShapeGroup shapeGroup = (ShapeGroup) o;
		return Objects.equals(this.recipient, shapeGroup.recipient) && Objects.equals(this.shape, shapeGroup.shape);
	}

	@Override
	public int hashCode() {
		return Objects.hash(recipient, shape);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class ShapeGroup {\n");
