...
import org.foodauthent.oneworldsync.client.model.TradeItemDescriptionInformation;
...
public class TradeItemDescriptionModule {
	...
	private List<TradeItemDescriptionInformation> tradeItemDescriptionInformation = null;

	public TradeItemDescriptionModule tradeItemDescriptionInformation(
			List<TradeItemDescriptionInformation> tradeItemDescriptionInformation) {
		this.tradeItemDescriptionInformation = tradeItemDescriptionInformation;
		return this;
	}

	public TradeItemDescriptionModule addTradeItemDescriptionInformationItem(
			TradeItemDescriptionInformation tradeItemDescriptionInformationItem) {
		if (this.tradeItemDescriptionInformation == null) {
			this.tradeItemDescriptionInformation = new ArrayList<TradeItemDescriptionInformation>();
		}
		this.tradeItemDescriptionInformation.add(tradeItemDescriptionInformationItem);
		return this;
	}

	/**
	 * Get tradeItemDescriptionInformation
	 * 
	 * @return tradeItemDescriptionInformation
	 **/
	@ApiModelProperty(value = "")
	public List<TradeItemDescriptionInformation> getTradeItemDescriptionInformation() {
		return tradeItemDescriptionInformation;
	}

	public void setTradeItemDescriptionInformation(
			List<TradeItemDescriptionInformation> tradeItemDescriptionInformation) {
		this.tradeItemDescriptionInformation = tradeItemDescriptionInformation;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		TradeItemDescriptionModule tradeItemDescriptionModule = (TradeItemDescriptionModule) o;
		return Objects.equals(this.tradeItemDescriptionInformation,
				tradeItemDescriptionModule.tradeItemDescriptionInformation);
	}

	@Override
	public int hashCode() {
		return Objects.hash(tradeItemDescriptionInformation);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class TradeItemDescriptionModule {\n");

		sb.append("    tradeItemDescriptionInformation: ").append(toIndentedString(tradeItemDescriptionInformation))
				.append("\n");
		sb.append("}");
		return sb.toString();
	}
