...
import org.foodauthent.oneworldsync.client.model.PharmaceuticalItemInformation;

/**
 * PharmaceuticalItemInformationModule
 */
...
public class PharmaceuticalItemInformationModule {
	@JsonProperty("pharmaceuticalItemInformation")
	private PharmaceuticalItemInformation pharmaceuticalItemInformation = null;

	public PharmaceuticalItemInformationModule pharmaceuticalItemInformation(
			PharmaceuticalItemInformation pharmaceuticalItemInformation) {
		this.pharmaceuticalItemInformation = pharmaceuticalItemInformation;
		return this;
	}

	/**
	 * Get pharmaceuticalItemInformation
	 * 
	 * @return pharmaceuticalItemInformation
	 **/
	@ApiModelProperty(value = "")
	public PharmaceuticalItemInformation getPharmaceuticalItemInformation() {
		return pharmaceuticalItemInformation;
	}

	public void setPharmaceuticalItemInformation(PharmaceuticalItemInformation pharmaceuticalItemInformation) {
		this.pharmaceuticalItemInformation = pharmaceuticalItemInformation;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		PharmaceuticalItemInformationModule pharmaceuticalItemInformationModule = (PharmaceuticalItemInformationModule) o;
		return Objects.equals(this.pharmaceuticalItemInformation,
				pharmaceuticalItemInformationModule.pharmaceuticalItemInformation);
	}

	@Override
	public int hashCode() {
		return Objects.hash(pharmaceuticalItemInformation);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class PharmaceuticalItemInformationModule {\n");

		sb.append("    pharmaceuticalItemInformation: ").append(toIndentedString(pharmaceuticalItemInformation))
				.append("\n");
		sb.append("}");
		return sb.toString();
	}
