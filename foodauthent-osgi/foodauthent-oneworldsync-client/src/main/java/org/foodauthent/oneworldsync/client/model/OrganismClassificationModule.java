...
import org.foodauthent.oneworldsync.client.model.OrganismClassification;

/**
 * OrganismClassificationModule
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-07-25T20:10:55.785Z")
public class OrganismClassificationModule {
	@JsonProperty("organismClassification")
	private List<OrganismClassification> organismClassification = null;

	public OrganismClassificationModule organismClassification(List<OrganismClassification> organismClassification) {
		this.organismClassification = organismClassification;
		return this;
	}

	public OrganismClassificationModule addOrganismClassificationItem(
			OrganismClassification organismClassificationItem) {
		if (this.organismClassification == null) {
			this.organismClassification = new ArrayList<OrganismClassification>();
		}
		this.organismClassification.add(organismClassificationItem);
		return this;
	}

	/**
	 * Get organismClassification
	 * 
	 * @return organismClassification
	 **/
	@ApiModelProperty(value = "")
	public List<OrganismClassification> getOrganismClassification() {
		return organismClassification;
	}

	public void setOrganismClassification(List<OrganismClassification> organismClassification) {
		this.organismClassification = organismClassification;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		OrganismClassificationModule organismClassificationModule = (OrganismClassificationModule) o;
		return Objects.equals(this.organismClassification, organismClassificationModule.organismClassification);
	}

	@Override
	public int hashCode() {
		return Objects.hash(organismClassification);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class OrganismClassificationModule {\n");

		sb.append("    organismClassification: ").append(toIndentedString(organismClassification)).append("\n");
		sb.append("}");
		return sb.toString();
	}
