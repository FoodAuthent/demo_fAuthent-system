...
public class TradeItemLicenseEffectiveDateInformation {
	@JsonProperty("tradeItemLicenseEndDateTime")
	private String tradeItemLicenseEndDateTime = null;

	@JsonProperty("tradeItemLicenseStartDateTime")
	private String tradeItemLicenseStartDateTime = null;

	public TradeItemLicenseEffectiveDateInformation tradeItemLicenseEndDateTime(String tradeItemLicenseEndDateTime) {
		this.tradeItemLicenseEndDateTime = tradeItemLicenseEndDateTime;
		return this;
	}

	/**
	 * Get tradeItemLicenseEndDateTime
	 * 
	 * @return tradeItemLicenseEndDateTime
	 **/
	@ApiModelProperty(value = "")
	public String getTradeItemLicenseEndDateTime() {
		return tradeItemLicenseEndDateTime;
	}

	public void setTradeItemLicenseEndDateTime(String tradeItemLicenseEndDateTime) {
		this.tradeItemLicenseEndDateTime = tradeItemLicenseEndDateTime;
	}

	public TradeItemLicenseEffectiveDateInformation tradeItemLicenseStartDateTime(
			String tradeItemLicenseStartDateTime) {
		this.tradeItemLicenseStartDateTime = tradeItemLicenseStartDateTime;
		return this;
	}

	/**
	 * Get tradeItemLicenseStartDateTime
	 * 
	 * @return tradeItemLicenseStartDateTime
	 **/
	@ApiModelProperty(value = "")
	public String getTradeItemLicenseStartDateTime() {
		return tradeItemLicenseStartDateTime;
	}

	public void setTradeItemLicenseStartDateTime(String tradeItemLicenseStartDateTime) {
		this.tradeItemLicenseStartDateTime = tradeItemLicenseStartDateTime;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		TradeItemLicenseEffectiveDateInformation tradeItemLicenseEffectiveDateInformation = (TradeItemLicenseEffectiveDateInformation) o;
		return Objects.equals(this.tradeItemLicenseEndDateTime,
				tradeItemLicenseEffectiveDateInformation.tradeItemLicenseEndDateTime)
				&& Objects.equals(this.tradeItemLicenseStartDateTime,
						tradeItemLicenseEffectiveDateInformation.tradeItemLicenseStartDateTime);
	}

	@Override
	public int hashCode() {
		return Objects.hash(tradeItemLicenseEndDateTime, tradeItemLicenseStartDateTime);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class TradeItemLicenseEffectiveDateInformation {\n");

		sb.append("    tradeItemLicenseEndDateTime: ").append(toIndentedString(tradeItemLicenseEndDateTime))
				.append("\n");
		sb.append("    tradeItemLicenseStartDateTime: ").append(toIndentedString(tradeItemLicenseStartDateTime))
				.append("\n");
		sb.append("}");
		return sb.toString();
	}
