...
import org.foodauthent.oneworldsync.client.model.SalesInformationModule;

/**
 * SalesInformationModuleGroup
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-07-25T20:10:55.785Z")
public class SalesInformationModuleGroup {
	@JsonProperty("recipient")
	private Recipient recipient = null;

	@JsonProperty("salesInformationModule")
	private List<SalesInformationModule> salesInformationModule = null;

	public SalesInformationModuleGroup recipient(Recipient recipient) {
	...
	public SalesInformationModuleGroup salesInformationModule(List<SalesInformationModule> salesInformationModule) {
		this.salesInformationModule = salesInformationModule;
		return this;
	}

	public SalesInformationModuleGroup addSalesInformationModuleItem(
			SalesInformationModule salesInformationModuleItem) {
		if (this.salesInformationModule == null) {
			this.salesInformationModule = new ArrayList<SalesInformationModule>();
		}
		this.salesInformationModule.add(salesInformationModuleItem);
		return this;
	}

	/**
	 * Get salesInformationModule
	 * 
	 * @return salesInformationModule
	 **/
	@ApiModelProperty(value = "")
	public List<SalesInformationModule> getSalesInformationModule() {
		return salesInformationModule;
	}

	public void setSalesInformationModule(List<SalesInformationModule> salesInformationModule) {
		this.salesInformationModule = salesInformationModule;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		SalesInformationModuleGroup salesInformationModuleGroup = (SalesInformationModuleGroup) o;
		return Objects.equals(this.recipient, salesInformationModuleGroup.recipient)
				&& Objects.equals(this.salesInformationModule, salesInformationModuleGroup.salesInformationModule);
	}

	@Override
	public int hashCode() {
		return Objects.hash(recipient, salesInformationModule);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class SalesInformationModuleGroup {\n");

		sb.append("    recipient: ").append(toIndentedString(recipient)).append("\n");
		sb.append("    salesInformationModule: ").append(toIndentedString(salesInformationModule)).append("\n");
		sb.append("}");
		return sb.toString();
	}
