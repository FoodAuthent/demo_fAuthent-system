...
public class ProductYieldInformation {
	...
	private QualifiedValue productYield = null;

	@JsonProperty("productYieldTypeCode")
	private CodifiedValue productYieldTypeCode = null;

	@JsonProperty("productYieldVariationPercentage")
	private String productYieldVariationPercentage = null;

	public ProductYieldInformation productYield(QualifiedValue productYield) {
	...
	public QualifiedValue getProductYield() {
		return productYield;
	}

	public void setProductYield(QualifiedValue productYield) {
		this.productYield = productYield;
	}

	public ProductYieldInformation productYieldTypeCode(CodifiedValue productYieldTypeCode) {
		this.productYieldTypeCode = productYieldTypeCode;
		return this;
	}

	/**
	 * Get productYieldTypeCode
	 * 
	 * @return productYieldTypeCode
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getProductYieldTypeCode() {
		return productYieldTypeCode;
	}

	public void setProductYieldTypeCode(CodifiedValue productYieldTypeCode) {
		this.productYieldTypeCode = productYieldTypeCode;
	}

	public ProductYieldInformation productYieldVariationPercentage(String productYieldVariationPercentage) {
		this.productYieldVariationPercentage = productYieldVariationPercentage;
		return this;
	}

	/**
	 * Get productYieldVariationPercentage
	 * 
	...
	public void setProductYieldVariationPercentage(String productYieldVariationPercentage) {
		this.productYieldVariationPercentage = productYieldVariationPercentage;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		ProductYieldInformation productYieldInformation = (ProductYieldInformation) o;
		return Objects.equals(this.productYield, productYieldInformation.productYield)
				&& Objects.equals(this.productYieldTypeCode, productYieldInformation.productYieldTypeCode)
				&& Objects.equals(this.productYieldVariationPercentage,
						productYieldInformation.productYieldVariationPercentage);
	}

	@Override
	public int hashCode() {
		return Objects.hash(productYield, productYieldTypeCode, productYieldVariationPercentage);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class ProductYieldInformation {\n");

		sb.append("    productYield: ").append(toIndentedString(productYield)).append("\n");
		sb.append("    productYieldTypeCode: ").append(toIndentedString(productYieldTypeCode)).append("\n");
		sb.append("    productYieldVariationPercentage: ").append(toIndentedString(productYieldVariationPercentage))
				.append("\n");
		sb.append("}");
		return sb.toString();
	}
