...
public class TargetConsumer {
	...
	private LanguageLabels targetConsumerAge = null;

	@JsonProperty("targetConsumerAgeGroup")
	private LanguageLabels targetConsumerAgeGroup = null;

	@JsonProperty("targetConsumerGender")
	private CodifiedValue targetConsumerGender = null;

	public TargetConsumer targetConsumerAge(LanguageLabels targetConsumerAge) {
		this.targetConsumerAge = targetConsumerAge;
		return this;
	}

	/**
	 * Get targetConsumerAge
	 * 
	 * @return targetConsumerAge
	 **/
	@ApiModelProperty(value = "")
	public LanguageLabels getTargetConsumerAge() {
		return targetConsumerAge;
	}

	public void setTargetConsumerAge(LanguageLabels targetConsumerAge) {
		this.targetConsumerAge = targetConsumerAge;
	}

	public TargetConsumer targetConsumerAgeGroup(LanguageLabels targetConsumerAgeGroup) {
		this.targetConsumerAgeGroup = targetConsumerAgeGroup;
		return this;
	}

	/**
	 * Get targetConsumerAgeGroup
	 * 
	 * @return targetConsumerAgeGroup
	 **/
	@ApiModelProperty(value = "")
	public LanguageLabels getTargetConsumerAgeGroup() {
		return targetConsumerAgeGroup;
	}

	public void setTargetConsumerAgeGroup(LanguageLabels targetConsumerAgeGroup) {
		this.targetConsumerAgeGroup = targetConsumerAgeGroup;
	}

	public TargetConsumer targetConsumerGender(CodifiedValue targetConsumerGender) {
		this.targetConsumerGender = targetConsumerGender;
		return this;
	}

	/**
	 * Get targetConsumerGender
	 * 
	 * @return targetConsumerGender
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getTargetConsumerGender() {
		return targetConsumerGender;
	}

	public void setTargetConsumerGender(CodifiedValue targetConsumerGender) {
		this.targetConsumerGender = targetConsumerGender;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		TargetConsumer targetConsumer = (TargetConsumer) o;
		return Objects.equals(this.targetConsumerAge, targetConsumer.targetConsumerAge)
				&& Objects.equals(this.targetConsumerAgeGroup, targetConsumer.targetConsumerAgeGroup)
				&& Objects.equals(this.targetConsumerGender, targetConsumer.targetConsumerGender);
	}

	@Override
	public int hashCode() {
		return Objects.hash(targetConsumerAge, targetConsumerAgeGroup, targetConsumerGender);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class TargetConsumer {\n");

		sb.append("    targetConsumerAge: ").append(toIndentedString(targetConsumerAge)).append("\n");
		sb.append("    targetConsumerAgeGroup: ").append(toIndentedString(targetConsumerAgeGroup)).append("\n");
		sb.append("    targetConsumerGender: ").append(toIndentedString(targetConsumerGender)).append("\n");
		sb.append("}");
		return sb.toString();
	}
