...
import org.foodauthent.oneworldsync.client.model.ProductFormulationStatement;

/**
 * ProductFormulationStatementModule
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-07-25T20:10:55.785Z")
public class ProductFormulationStatementModule {
	@JsonProperty("productFormulationStatement")
	private List<ProductFormulationStatement> productFormulationStatement = null;

	public ProductFormulationStatementModule productFormulationStatement(
			List<ProductFormulationStatement> productFormulationStatement) {
		this.productFormulationStatement = productFormulationStatement;
		return this;
	}

	public ProductFormulationStatementModule addProductFormulationStatementItem(
			ProductFormulationStatement productFormulationStatementItem) {
		if (this.productFormulationStatement == null) {
			this.productFormulationStatement = new ArrayList<ProductFormulationStatement>();
		}
		this.productFormulationStatement.add(productFormulationStatementItem);
		return this;
	}

	/**
	 * Get productFormulationStatement
	 * 
	 * @return productFormulationStatement
	 **/
	@ApiModelProperty(value = "")
	public List<ProductFormulationStatement> getProductFormulationStatement() {
		return productFormulationStatement;
	}

	public void setProductFormulationStatement(List<ProductFormulationStatement> productFormulationStatement) {
		this.productFormulationStatement = productFormulationStatement;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		ProductFormulationStatementModule productFormulationStatementModule = (ProductFormulationStatementModule) o;
		return Objects.equals(this.productFormulationStatement,
				productFormulationStatementModule.productFormulationStatement);
	}

	@Override
	public int hashCode() {
		return Objects.hash(productFormulationStatement);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class ProductFormulationStatementModule {\n");

		sb.append("    productFormulationStatement: ").append(toIndentedString(productFormulationStatement))
				.append("\n");
		sb.append("}");
		return sb.toString();
	}
