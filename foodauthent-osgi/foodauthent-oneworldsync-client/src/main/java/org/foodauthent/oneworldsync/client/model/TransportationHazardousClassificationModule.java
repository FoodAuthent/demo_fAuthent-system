...
import org.foodauthent.oneworldsync.client.model.TransportationClassification;

/**
 * TransportationHazardousClassificationModule
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-07-25T20:10:55.785Z")
public class TransportationHazardousClassificationModule {
	@JsonProperty("transportationClassification")
	private List<TransportationClassification> transportationClassification = null;

	public TransportationHazardousClassificationModule transportationClassification(
			List<TransportationClassification> transportationClassification) {
		this.transportationClassification = transportationClassification;
		return this;
	}

	public TransportationHazardousClassificationModule addTransportationClassificationItem(
			TransportationClassification transportationClassificationItem) {
		if (this.transportationClassification == null) {
			this.transportationClassification = new ArrayList<TransportationClassification>();
		}
		this.transportationClassification.add(transportationClassificationItem);
		return this;
	}

	/**
	 * Get transportationClassification
	 * 
	 * @return transportationClassification
	 **/
	@ApiModelProperty(value = "")
	public List<TransportationClassification> getTransportationClassification() {
		return transportationClassification;
	}

	public void setTransportationClassification(List<TransportationClassification> transportationClassification) {
		this.transportationClassification = transportationClassification;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		TransportationHazardousClassificationModule transportationHazardousClassificationModule = (TransportationHazardousClassificationModule) o;
		return Objects.equals(this.transportationClassification,
				transportationHazardousClassificationModule.transportationClassification);
	}

	@Override
	public int hashCode() {
		return Objects.hash(transportationClassification);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class TransportationHazardousClassificationModule {\n");

		sb.append("    transportationClassification: ").append(toIndentedString(transportationClassification))
				.append("\n");
		sb.append("}");
		return sb.toString();
	}
