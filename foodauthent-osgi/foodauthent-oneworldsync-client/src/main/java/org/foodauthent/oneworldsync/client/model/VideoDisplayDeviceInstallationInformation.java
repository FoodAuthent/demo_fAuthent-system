...
public class VideoDisplayDeviceInstallationInformation {
	@JsonProperty("audioVisualItemInstallationOptionTypeCode")
	private CodifiedValue audioVisualItemInstallationOptionTypeCode = null;

	@JsonProperty("vESAWallMountTypeCode")
	private String vESAWallMountTypeCode = null;

	public VideoDisplayDeviceInstallationInformation audioVisualItemInstallationOptionTypeCode(
			CodifiedValue audioVisualItemInstallationOptionTypeCode) {
		this.audioVisualItemInstallationOptionTypeCode = audioVisualItemInstallationOptionTypeCode;
		return this;
	}

	/**
	 * Get audioVisualItemInstallationOptionTypeCode
	 * 
	 * @return audioVisualItemInstallationOptionTypeCode
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getAudioVisualItemInstallationOptionTypeCode() {
		return audioVisualItemInstallationOptionTypeCode;
	}

	public void setAudioVisualItemInstallationOptionTypeCode(CodifiedValue audioVisualItemInstallationOptionTypeCode) {
		this.audioVisualItemInstallationOptionTypeCode = audioVisualItemInstallationOptionTypeCode;
	}

	public VideoDisplayDeviceInstallationInformation vESAWallMountTypeCode(String vESAWallMountTypeCode) {
		this.vESAWallMountTypeCode = vESAWallMountTypeCode;
		return this;
	}

	/**
	 * Get vESAWallMountTypeCode
	 * 
	...
	public void setVESAWallMountTypeCode(String vESAWallMountTypeCode) {
		this.vESAWallMountTypeCode = vESAWallMountTypeCode;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		VideoDisplayDeviceInstallationInformation videoDisplayDeviceInstallationInformation = (VideoDisplayDeviceInstallationInformation) o;
		return Objects.equals(this.audioVisualItemInstallationOptionTypeCode,
				videoDisplayDeviceInstallationInformation.audioVisualItemInstallationOptionTypeCode)
				&& Objects.equals(this.vESAWallMountTypeCode,
						videoDisplayDeviceInstallationInformation.vESAWallMountTypeCode);
	}

	@Override
	public int hashCode() {
		return Objects.hash(audioVisualItemInstallationOptionTypeCode, vESAWallMountTypeCode);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class VideoDisplayDeviceInstallationInformation {\n");

		sb.append("    audioVisualItemInstallationOptionTypeCode: ")
				.append(toIndentedString(audioVisualItemInstallationOptionTypeCode)).append("\n");
		sb.append("    vESAWallMountTypeCode: ").append(toIndentedString(vESAWallMountTypeCode)).append("\n");
		sb.append("}");
		return sb.toString();
	}
