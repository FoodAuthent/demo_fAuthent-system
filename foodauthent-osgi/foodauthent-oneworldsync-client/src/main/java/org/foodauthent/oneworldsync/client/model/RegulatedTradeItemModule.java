...
import org.foodauthent.oneworldsync.client.model.RegulatoryInformation;
...
public class RegulatedTradeItemModule {
	@JsonProperty("regulatoryInformation")
	private List<RegulatoryInformation> regulatoryInformation = null;

	public RegulatedTradeItemModule regulatoryInformation(List<RegulatoryInformation> regulatoryInformation) {
		this.regulatoryInformation = regulatoryInformation;
		return this;
	}

	public RegulatedTradeItemModule addRegulatoryInformationItem(RegulatoryInformation regulatoryInformationItem) {
		if (this.regulatoryInformation == null) {
			this.regulatoryInformation = new ArrayList<RegulatoryInformation>();
		}
	...
	public void setRegulatoryInformation(List<RegulatoryInformation> regulatoryInformation) {
		this.regulatoryInformation = regulatoryInformation;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		RegulatedTradeItemModule regulatedTradeItemModule = (RegulatedTradeItemModule) o;
		return Objects.equals(this.regulatoryInformation, regulatedTradeItemModule.regulatoryInformation);
	}

	@Override
	public int hashCode() {
		return Objects.hash(regulatoryInformation);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class RegulatedTradeItemModule {\n");
