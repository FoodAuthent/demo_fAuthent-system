...
public class HandlingInstructionsCodeReference {
	...
	@JsonProperty("handlingInstructionsCodeReferenceValue")
	private String handlingInstructionsCodeReferenceValue = null;

	public HandlingInstructionsCodeReference codeDescription(String codeDescription) {
	...
	public HandlingInstructionsCodeReference codeListAgencyCode(String codeListAgencyCode) {
	...
	public HandlingInstructionsCodeReference codeListAgencyCodeListVersion(String codeListAgencyCodeListVersion) {
	...
	public HandlingInstructionsCodeReference codeListAgencyName(String codeListAgencyName) {
	...
	public HandlingInstructionsCodeReference codeListName(String codeListName) {
	...
	public HandlingInstructionsCodeReference codeListURI(String codeListURI) {
	...
	public HandlingInstructionsCodeReference codeListVersion(String codeListVersion) {
	...
	public HandlingInstructionsCodeReference handlingInstructionsCodeReferenceValue(
			String handlingInstructionsCodeReferenceValue) {
		this.handlingInstructionsCodeReferenceValue = handlingInstructionsCodeReferenceValue;
		return this;
	}

	/**
	 * Get handlingInstructionsCodeReferenceValue
	 * 
	 * @return handlingInstructionsCodeReferenceValue
	 **/
	@ApiModelProperty(value = "")
	public String getHandlingInstructionsCodeReferenceValue() {
		return handlingInstructionsCodeReferenceValue;
	}

	public void setHandlingInstructionsCodeReferenceValue(String handlingInstructionsCodeReferenceValue) {
		this.handlingInstructionsCodeReferenceValue = handlingInstructionsCodeReferenceValue;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		HandlingInstructionsCodeReference handlingInstructionsCodeReference = (HandlingInstructionsCodeReference) o;
		return Objects.equals(this.codeDescription, handlingInstructionsCodeReference.codeDescription)
				&& Objects.equals(this.codeListAgencyCode, handlingInstructionsCodeReference.codeListAgencyCode)
				&& Objects.equals(this.codeListAgencyCodeListVersion,
						handlingInstructionsCodeReference.codeListAgencyCodeListVersion)
				&& Objects.equals(this.codeListAgencyName, handlingInstructionsCodeReference.codeListAgencyName)
				&& Objects.equals(this.codeListName, handlingInstructionsCodeReference.codeListName)
				&& Objects.equals(this.codeListURI, handlingInstructionsCodeReference.codeListURI)
				&& Objects.equals(this.codeListVersion, handlingInstructionsCodeReference.codeListVersion)
				&& Objects.equals(this.handlingInstructionsCodeReferenceValue,
						handlingInstructionsCodeReference.handlingInstructionsCodeReferenceValue);
	}

	@Override
	public int hashCode() {
		return Objects.hash(codeDescription, codeListAgencyCode, codeListAgencyCodeListVersion, codeListAgencyName,
				codeListName, codeListURI, codeListVersion, handlingInstructionsCodeReferenceValue);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class HandlingInstructionsCodeReference {\n");
		...
		sb.append("    handlingInstructionsCodeReferenceValue: ")
				.append(toIndentedString(handlingInstructionsCodeReferenceValue)).append("\n");
		sb.append("}");
		return sb.toString();
	}
