...
import org.foodauthent.oneworldsync.client.model.ItemIdentification;
...
public class NonPromotionalTradeItem {
	@JsonProperty("ItemIdentification")
	private List<ItemIdentification> itemIdentification = null;
	...
	public NonPromotionalTradeItem itemIdentification(List<ItemIdentification> itemIdentification) {
		this.itemIdentification = itemIdentification;
		return this;
	}

	public NonPromotionalTradeItem addItemIdentificationItem(ItemIdentification itemIdentificationItem) {
		if (this.itemIdentification == null) {
			this.itemIdentification = new ArrayList<ItemIdentification>();
		}
		this.itemIdentification.add(itemIdentificationItem);
		return this;
	}
	...
	public NonPromotionalTradeItem additionalTradeItemIdentification(
	...
	public NonPromotionalTradeItem addAdditionalTradeItemIdentificationItem(
	...
	public boolean equals(java.lang.Object o) {
		...
		NonPromotionalTradeItem nonPromotionalTradeItem = (NonPromotionalTradeItem) o;
		return Objects.equals(this.itemIdentification, nonPromotionalTradeItem.itemIdentification) && Objects.equals(
				this.additionalTradeItemIdentification, nonPromotionalTradeItem.additionalTradeItemIdentification);
	}

	@Override
	public int hashCode() {
		return Objects.hash(itemIdentification, additionalTradeItemIdentification);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class NonPromotionalTradeItem {\n");
