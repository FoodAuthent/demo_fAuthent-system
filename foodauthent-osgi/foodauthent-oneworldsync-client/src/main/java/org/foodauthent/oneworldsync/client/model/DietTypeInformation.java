...
import org.foodauthent.oneworldsync.client.model.DietCertification;

/**
 * DietTypeInformation
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-07-25T20:10:55.785Z")
public class DietTypeInformation {
	@JsonProperty("dietCertification")
	private List<DietCertification> dietCertification = null;

	@JsonProperty("dietTypeCode")
	private CodifiedValue dietTypeCode = null;

	@JsonProperty("dietTypeSubcode")
	private String dietTypeSubcode = null;

	public DietTypeInformation dietCertification(List<DietCertification> dietCertification) {
		this.dietCertification = dietCertification;
		return this;
	}

	public DietTypeInformation addDietCertificationItem(DietCertification dietCertificationItem) {
		if (this.dietCertification == null) {
			this.dietCertification = new ArrayList<DietCertification>();
		}
		this.dietCertification.add(dietCertificationItem);
		return this;
	}

	/**
	 * Get dietCertification
	 * 
	 * @return dietCertification
	 **/
	@ApiModelProperty(value = "")
	public List<DietCertification> getDietCertification() {
		return dietCertification;
	}

	public void setDietCertification(List<DietCertification> dietCertification) {
		this.dietCertification = dietCertification;
	}

	public DietTypeInformation dietTypeCode(CodifiedValue dietTypeCode) {
	 ...
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getDietTypeCode() {
		return dietTypeCode;
	}

	public void setDietTypeCode(CodifiedValue dietTypeCode) {
		this.dietTypeCode = dietTypeCode;
	}

	public DietTypeInformation dietTypeSubcode(String dietTypeSubcode) {
	...
	public void setDietTypeSubcode(String dietTypeSubcode) {
		this.dietTypeSubcode = dietTypeSubcode;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		DietTypeInformation dietTypeInformation = (DietTypeInformation) o;
		return Objects.equals(this.dietCertification, dietTypeInformation.dietCertification)
				&& Objects.equals(this.dietTypeCode, dietTypeInformation.dietTypeCode)
				&& Objects.equals(this.dietTypeSubcode, dietTypeInformation.dietTypeSubcode);
	}

	@Override
	public int hashCode() {
		return Objects.hash(dietCertification, dietTypeCode, dietTypeSubcode);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class DietTypeInformation {\n");

		sb.append("    dietCertification: ").append(toIndentedString(dietCertification)).append("\n");
		sb.append("    dietTypeCode: ").append(toIndentedString(dietTypeCode)).append("\n");
		sb.append("    dietTypeSubcode: ").append(toIndentedString(dietTypeSubcode)).append("\n");
		sb.append("}");
		return sb.toString();
	}
