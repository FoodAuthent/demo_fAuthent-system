...
import org.foodauthent.oneworldsync.client.auth.Authentication;
...
public class ApiClient {
	...
	protected String basePath = "https://marketplace.api.1worldsync.com/V2";
	...
	public <T> ApiResponse<T> invokeAPI(String path, String method, List<Pair> queryParams, Object body,
		...
		try {
			...
			try {
				...
				// it's not critical, since the response object is local in method invokeAPI;
