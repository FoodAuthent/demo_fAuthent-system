...
public class ControlledSubstanceScheduleCodeReference {
	...
	@JsonProperty("controlledSubstanceScheduleCodeReferenceValue")
	private String controlledSubstanceScheduleCodeReferenceValue = null;

	public ControlledSubstanceScheduleCodeReference codeDescription(String codeDescription) {
	...
	public ControlledSubstanceScheduleCodeReference codeListAgencyCode(String codeListAgencyCode) {
	...
	public ControlledSubstanceScheduleCodeReference codeListAgencyCodeListVersion(
	...
	public ControlledSubstanceScheduleCodeReference codeListAgencyName(String codeListAgencyName) {
	...
	public ControlledSubstanceScheduleCodeReference codeListName(String codeListName) {
	...
	public ControlledSubstanceScheduleCodeReference codeListURI(String codeListURI) {
	...
	public ControlledSubstanceScheduleCodeReference codeListVersion(String codeListVersion) {
	...
	public ControlledSubstanceScheduleCodeReference controlledSubstanceScheduleCodeReferenceValue(
			String controlledSubstanceScheduleCodeReferenceValue) {
		this.controlledSubstanceScheduleCodeReferenceValue = controlledSubstanceScheduleCodeReferenceValue;
		return this;
	}

	/**
	 * Get controlledSubstanceScheduleCodeReferenceValue
	 * 
	 * @return controlledSubstanceScheduleCodeReferenceValue
	 **/
	@ApiModelProperty(value = "")
	public String getControlledSubstanceScheduleCodeReferenceValue() {
		return controlledSubstanceScheduleCodeReferenceValue;
	}

	public void setControlledSubstanceScheduleCodeReferenceValue(String controlledSubstanceScheduleCodeReferenceValue) {
		this.controlledSubstanceScheduleCodeReferenceValue = controlledSubstanceScheduleCodeReferenceValue;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		ControlledSubstanceScheduleCodeReference controlledSubstanceScheduleCodeReference = (ControlledSubstanceScheduleCodeReference) o;
		return Objects.equals(this.codeDescription, controlledSubstanceScheduleCodeReference.codeDescription)
				&& Objects.equals(this.codeListAgencyCode, controlledSubstanceScheduleCodeReference.codeListAgencyCode)
				&& Objects.equals(this.codeListAgencyCodeListVersion,
						controlledSubstanceScheduleCodeReference.codeListAgencyCodeListVersion)
				&& Objects.equals(this.codeListAgencyName, controlledSubstanceScheduleCodeReference.codeListAgencyName)
				&& Objects.equals(this.codeListName, controlledSubstanceScheduleCodeReference.codeListName)
				&& Objects.equals(this.codeListURI, controlledSubstanceScheduleCodeReference.codeListURI)
				&& Objects.equals(this.codeListVersion, controlledSubstanceScheduleCodeReference.codeListVersion)
				&& Objects.equals(this.controlledSubstanceScheduleCodeReferenceValue,
						controlledSubstanceScheduleCodeReference.controlledSubstanceScheduleCodeReferenceValue);
	}

	@Override
	public int hashCode() {
		return Objects.hash(codeDescription, codeListAgencyCode, codeListAgencyCodeListVersion, codeListAgencyName,
				codeListName, codeListURI, codeListVersion, controlledSubstanceScheduleCodeReferenceValue);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class ControlledSubstanceScheduleCodeReference {\n");
		...
		sb.append("    controlledSubstanceScheduleCodeReferenceValue: ")
				.append(toIndentedString(controlledSubstanceScheduleCodeReferenceValue)).append("\n");
		sb.append("}");
		return sb.toString();
	}
