...
public class CreditableAlternativeProtein {
	@JsonProperty("containedAlternativeProteinPercent")
	private String containedAlternativeProteinPercent = null;

	@JsonProperty("creditableAlternativeProteinPerPortion")
	private QualifiedValues creditableAlternativeProteinPerPortion = null;

	public CreditableAlternativeProtein containedAlternativeProteinPercent(String containedAlternativeProteinPercent) {
		this.containedAlternativeProteinPercent = containedAlternativeProteinPercent;
		return this;
	}

	/**
	 * Get containedAlternativeProteinPercent
	 * 
	 * @return containedAlternativeProteinPercent
	 **/
	@ApiModelProperty(value = "")
	public String getContainedAlternativeProteinPercent() {
		return containedAlternativeProteinPercent;
	}

	public void setContainedAlternativeProteinPercent(String containedAlternativeProteinPercent) {
		this.containedAlternativeProteinPercent = containedAlternativeProteinPercent;
	}

	public CreditableAlternativeProtein creditableAlternativeProteinPerPortion(
			QualifiedValues creditableAlternativeProteinPerPortion) {
		this.creditableAlternativeProteinPerPortion = creditableAlternativeProteinPerPortion;
		return this;
	}

	/**
	 * Get creditableAlternativeProteinPerPortion
	 * 
	 * @return creditableAlternativeProteinPerPortion
	 **/
	@ApiModelProperty(value = "")
	public QualifiedValues getCreditableAlternativeProteinPerPortion() {
		return creditableAlternativeProteinPerPortion;
	}

	public void setCreditableAlternativeProteinPerPortion(QualifiedValues creditableAlternativeProteinPerPortion) {
		this.creditableAlternativeProteinPerPortion = creditableAlternativeProteinPerPortion;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		CreditableAlternativeProtein creditableAlternativeProtein = (CreditableAlternativeProtein) o;
		return Objects.equals(this.containedAlternativeProteinPercent,
				creditableAlternativeProtein.containedAlternativeProteinPercent)
				&& Objects.equals(this.creditableAlternativeProteinPerPortion,
						creditableAlternativeProtein.creditableAlternativeProteinPerPortion);
	}

	@Override
	public int hashCode() {
		return Objects.hash(containedAlternativeProteinPercent, creditableAlternativeProteinPerPortion);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class CreditableAlternativeProtein {\n");

		sb.append("    containedAlternativeProteinPercent: ")
				.append(toIndentedString(containedAlternativeProteinPercent)).append("\n");
		sb.append("    creditableAlternativeProteinPerPortion: ")
				.append(toIndentedString(creditableAlternativeProteinPerPortion)).append("\n");
		sb.append("}");
		return sb.toString();
	}
