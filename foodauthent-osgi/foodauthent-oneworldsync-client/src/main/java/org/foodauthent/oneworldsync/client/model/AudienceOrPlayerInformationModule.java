...
import org.foodauthent.oneworldsync.client.model.AudienceOrPlayerInformation;

/**
 * AudienceOrPlayerInformationModule
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-07-25T20:10:55.785Z")
public class AudienceOrPlayerInformationModule {
	@JsonProperty("audienceOrPlayerInformation")
	private AudienceOrPlayerInformation audienceOrPlayerInformation = null;

	public AudienceOrPlayerInformationModule audienceOrPlayerInformation(
			AudienceOrPlayerInformation audienceOrPlayerInformation) {
		this.audienceOrPlayerInformation = audienceOrPlayerInformation;
		return this;
	}

	/**
	 * Get audienceOrPlayerInformation
	 * 
	 * @return audienceOrPlayerInformation
	 **/
	@ApiModelProperty(value = "")
	public AudienceOrPlayerInformation getAudienceOrPlayerInformation() {
		return audienceOrPlayerInformation;
	}

	public void setAudienceOrPlayerInformation(AudienceOrPlayerInformation audienceOrPlayerInformation) {
		this.audienceOrPlayerInformation = audienceOrPlayerInformation;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		AudienceOrPlayerInformationModule audienceOrPlayerInformationModule = (AudienceOrPlayerInformationModule) o;
		return Objects.equals(this.audienceOrPlayerInformation,
				audienceOrPlayerInformationModule.audienceOrPlayerInformation);
	}

	@Override
	public int hashCode() {
		return Objects.hash(audienceOrPlayerInformation);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class AudienceOrPlayerInformationModule {\n");

		sb.append("    audienceOrPlayerInformation: ").append(toIndentedString(audienceOrPlayerInformation))
				.append("\n");
		sb.append("}");
		return sb.toString();
	}
