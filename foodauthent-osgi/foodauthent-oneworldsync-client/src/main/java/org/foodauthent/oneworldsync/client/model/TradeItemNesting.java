...
public class TradeItemNesting {
	@JsonProperty("nestingDirectionCode")
	private CodifiedValue nestingDirectionCode = null;

	@JsonProperty("nestingIncrement")
	private QualifiedValues nestingIncrement = null;

	@JsonProperty("nestingTypeCode")
	private CodifiedValue nestingTypeCode = null;

	public TradeItemNesting nestingDirectionCode(CodifiedValue nestingDirectionCode) {
		this.nestingDirectionCode = nestingDirectionCode;
		return this;
	}

	/**
	 * Get nestingDirectionCode
	 * 
	 * @return nestingDirectionCode
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getNestingDirectionCode() {
		return nestingDirectionCode;
	}

	public void setNestingDirectionCode(CodifiedValue nestingDirectionCode) {
		this.nestingDirectionCode = nestingDirectionCode;
	}

	public TradeItemNesting nestingIncrement(QualifiedValues nestingIncrement) {
		this.nestingIncrement = nestingIncrement;
		return this;
	}

	/**
	 * Get nestingIncrement
	 * 
	 * @return nestingIncrement
	 **/
	@ApiModelProperty(value = "")
	public QualifiedValues getNestingIncrement() {
		return nestingIncrement;
	}

	public void setNestingIncrement(QualifiedValues nestingIncrement) {
		this.nestingIncrement = nestingIncrement;
	}

	public TradeItemNesting nestingTypeCode(CodifiedValue nestingTypeCode) {
		this.nestingTypeCode = nestingTypeCode;
		return this;
	}
	 ...
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getNestingTypeCode() {
		return nestingTypeCode;
	}

	public void setNestingTypeCode(CodifiedValue nestingTypeCode) {
		this.nestingTypeCode = nestingTypeCode;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		TradeItemNesting tradeItemNesting = (TradeItemNesting) o;
		return Objects.equals(this.nestingDirectionCode, tradeItemNesting.nestingDirectionCode)
				&& Objects.equals(this.nestingIncrement, tradeItemNesting.nestingIncrement)
				&& Objects.equals(this.nestingTypeCode, tradeItemNesting.nestingTypeCode);
	}

	@Override
	public int hashCode() {
		return Objects.hash(nestingDirectionCode, nestingIncrement, nestingTypeCode);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class TradeItemNesting {\n");

		sb.append("    nestingDirectionCode: ").append(toIndentedString(nestingDirectionCode)).append("\n");
		sb.append("    nestingIncrement: ").append(toIndentedString(nestingIncrement)).append("\n");
		sb.append("    nestingTypeCode: ").append(toIndentedString(nestingTypeCode)).append("\n");
		sb.append("}");
		return sb.toString();
	}
