...
public class ChemicalProperty {
	@JsonProperty("chemicalPropertyAdditionalDescription")
	private LanguageLabels chemicalPropertyAdditionalDescription = null;

	@JsonProperty("chemicalPropertyCode")
	private String chemicalPropertyCode = null;

	@JsonProperty("chemicalPropertyName")
	private String chemicalPropertyName = null;

	public ChemicalProperty chemicalPropertyAdditionalDescription(
			LanguageLabels chemicalPropertyAdditionalDescription) {
		this.chemicalPropertyAdditionalDescription = chemicalPropertyAdditionalDescription;
		return this;
	}

	/**
	 * Get chemicalPropertyAdditionalDescription
	 * 
	 * @return chemicalPropertyAdditionalDescription
	 **/
	@ApiModelProperty(value = "")
	public LanguageLabels getChemicalPropertyAdditionalDescription() {
		return chemicalPropertyAdditionalDescription;
	}

	public void setChemicalPropertyAdditionalDescription(LanguageLabels chemicalPropertyAdditionalDescription) {
		this.chemicalPropertyAdditionalDescription = chemicalPropertyAdditionalDescription;
	}

	public ChemicalProperty chemicalPropertyCode(String chemicalPropertyCode) {
		this.chemicalPropertyCode = chemicalPropertyCode;
		return this;
	}

	/**
	 * Get chemicalPropertyCode
	 * 
	...
	public void setChemicalPropertyCode(String chemicalPropertyCode) {
		this.chemicalPropertyCode = chemicalPropertyCode;
	}

	public ChemicalProperty chemicalPropertyName(String chemicalPropertyName) {
		this.chemicalPropertyName = chemicalPropertyName;
		return this;
	}

	/**
	 * Get chemicalPropertyName
	 * 
	...
	public void setChemicalPropertyName(String chemicalPropertyName) {
		this.chemicalPropertyName = chemicalPropertyName;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		ChemicalProperty chemicalProperty = (ChemicalProperty) o;
		return Objects.equals(this.chemicalPropertyAdditionalDescription,
				chemicalProperty.chemicalPropertyAdditionalDescription)
				&& Objects.equals(this.chemicalPropertyCode, chemicalProperty.chemicalPropertyCode)
				&& Objects.equals(this.chemicalPropertyName, chemicalProperty.chemicalPropertyName);
	}

	@Override
	public int hashCode() {
		return Objects.hash(chemicalPropertyAdditionalDescription, chemicalPropertyCode, chemicalPropertyName);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class ChemicalProperty {\n");

		sb.append("    chemicalPropertyAdditionalDescription: ")
				.append(toIndentedString(chemicalPropertyAdditionalDescription)).append("\n");
		sb.append("    chemicalPropertyCode: ").append(toIndentedString(chemicalPropertyCode)).append("\n");
		sb.append("    chemicalPropertyName: ").append(toIndentedString(chemicalPropertyName)).append("\n");
		sb.append("}");
		return sb.toString();
	}
