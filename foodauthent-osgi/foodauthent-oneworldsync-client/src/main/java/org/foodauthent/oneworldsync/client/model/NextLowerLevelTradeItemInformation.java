...
import org.foodauthent.oneworldsync.client.model.ChildTradeItem;
...
public class NextLowerLevelTradeItemInformation {
	@JsonProperty("childTradeItem")
	private List<ChildTradeItem> childTradeItem = null;

	@JsonProperty("quantityOfChildren")
	private String quantityOfChildren = null;

	@JsonProperty("totalQuantityOfNextLowerLevelTradeItem")
	private String totalQuantityOfNextLowerLevelTradeItem = null;

	public NextLowerLevelTradeItemInformation childTradeItem(List<ChildTradeItem> childTradeItem) {
		this.childTradeItem = childTradeItem;
		return this;
	}

	public NextLowerLevelTradeItemInformation addChildTradeItemItem(ChildTradeItem childTradeItemItem) {
		if (this.childTradeItem == null) {
			this.childTradeItem = new ArrayList<ChildTradeItem>();
		}
		this.childTradeItem.add(childTradeItemItem);
		return this;
	}
	...
	public List<ChildTradeItem> getChildTradeItem() {
		return childTradeItem;
	}

	public void setChildTradeItem(List<ChildTradeItem> childTradeItem) {
		this.childTradeItem = childTradeItem;
	}

	public NextLowerLevelTradeItemInformation quantityOfChildren(String quantityOfChildren) {
		this.quantityOfChildren = quantityOfChildren;
		return this;
	}

	/**
	 * Get quantityOfChildren
	 * 
	...
	public NextLowerLevelTradeItemInformation totalQuantityOfNextLowerLevelTradeItem(
			String totalQuantityOfNextLowerLevelTradeItem) {
		this.totalQuantityOfNextLowerLevelTradeItem = totalQuantityOfNextLowerLevelTradeItem;
		return this;
	}

	/**
	 * Get totalQuantityOfNextLowerLevelTradeItem
	 * 
	 * @return totalQuantityOfNextLowerLevelTradeItem
	 **/
	@ApiModelProperty(value = "")
	public String getTotalQuantityOfNextLowerLevelTradeItem() {
		return totalQuantityOfNextLowerLevelTradeItem;
	}

	public void setTotalQuantityOfNextLowerLevelTradeItem(String totalQuantityOfNextLowerLevelTradeItem) {
		this.totalQuantityOfNextLowerLevelTradeItem = totalQuantityOfNextLowerLevelTradeItem;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		NextLowerLevelTradeItemInformation nextLowerLevelTradeItemInformation = (NextLowerLevelTradeItemInformation) o;
		return Objects.equals(this.childTradeItem, nextLowerLevelTradeItemInformation.childTradeItem)
				&& Objects.equals(this.quantityOfChildren, nextLowerLevelTradeItemInformation.quantityOfChildren)
				&& Objects.equals(this.totalQuantityOfNextLowerLevelTradeItem,
						nextLowerLevelTradeItemInformation.totalQuantityOfNextLowerLevelTradeItem);
	}

	@Override
	public int hashCode() {
		return Objects.hash(childTradeItem, quantityOfChildren, totalQuantityOfNextLowerLevelTradeItem);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class NextLowerLevelTradeItemInformation {\n");

		sb.append("    childTradeItem: ").append(toIndentedString(childTradeItem)).append("\n");
		sb.append("    quantityOfChildren: ").append(toIndentedString(quantityOfChildren)).append("\n");
		sb.append("    totalQuantityOfNextLowerLevelTradeItem: ")
				.append(toIndentedString(totalQuantityOfNextLowerLevelTradeItem)).append("\n");
		sb.append("}");
		return sb.toString();
	}
