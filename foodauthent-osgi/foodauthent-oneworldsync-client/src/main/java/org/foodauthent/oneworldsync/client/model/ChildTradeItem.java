...
public class ChildTradeItem {
	...
	@JsonProperty("quantityOfNextLowerLevelTradeItem")
	private String quantityOfNextLowerLevelTradeItem = null;

	public ChildTradeItem itemIdentificationInformation(ItemIdentificationInformation itemIdentificationInformation) {
	...
	public ChildTradeItem quantityOfNextLowerLevelTradeItem(String quantityOfNextLowerLevelTradeItem) {
		this.quantityOfNextLowerLevelTradeItem = quantityOfNextLowerLevelTradeItem;
		return this;
	}

	/**
	 * Get quantityOfNextLowerLevelTradeItem
	 * 
	 * @return quantityOfNextLowerLevelTradeItem
	 **/
	@ApiModelProperty(value = "")
	public String getQuantityOfNextLowerLevelTradeItem() {
		return quantityOfNextLowerLevelTradeItem;
	}

	public void setQuantityOfNextLowerLevelTradeItem(String quantityOfNextLowerLevelTradeItem) {
		this.quantityOfNextLowerLevelTradeItem = quantityOfNextLowerLevelTradeItem;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		ChildTradeItem childTradeItem = (ChildTradeItem) o;
		return Objects.equals(this.itemIdentificationInformation, childTradeItem.itemIdentificationInformation)
				&& Objects.equals(this.quantityOfNextLowerLevelTradeItem,
						childTradeItem.quantityOfNextLowerLevelTradeItem);
	}

	@Override
	public int hashCode() {
		return Objects.hash(itemIdentificationInformation, quantityOfNextLowerLevelTradeItem);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class ChildTradeItem {\n");

		sb.append("    itemIdentificationInformation: ").append(toIndentedString(itemIdentificationInformation))
				.append("\n");
		sb.append("    quantityOfNextLowerLevelTradeItem: ").append(toIndentedString(quantityOfNextLowerLevelTradeItem))
				.append("\n");
		sb.append("}");
		return sb.toString();
	}
