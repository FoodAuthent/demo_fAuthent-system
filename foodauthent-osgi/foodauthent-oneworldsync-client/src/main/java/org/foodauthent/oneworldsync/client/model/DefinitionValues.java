...
import org.foodauthent.oneworldsync.client.model.DefinitionLanguageValue;
...
public class DefinitionValues {
	...
	private List<DefinitionLanguageValue> languageValues = null;

	@JsonProperty("code")
	private String code = null;

	public DefinitionValues languageValues(List<DefinitionLanguageValue> languageValues) {
		this.languageValues = languageValues;
		return this;
	}

	public DefinitionValues addLanguageValuesItem(DefinitionLanguageValue languageValuesItem) {
		if (this.languageValues == null) {
			this.languageValues = new ArrayList<DefinitionLanguageValue>();
		}
		this.languageValues.add(languageValuesItem);
		return this;
	}
	...
	public List<DefinitionLanguageValue> getLanguageValues() {
		return languageValues;
	}

	public void setLanguageValues(List<DefinitionLanguageValue> languageValues) {
		this.languageValues = languageValues;
	}

	public DefinitionValues code(String code) {
		this.code = code;
		return this;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		DefinitionValues definitionValues = (DefinitionValues) o;
		return Objects.equals(this.languageValues, definitionValues.languageValues)
				&& Objects.equals(this.code, definitionValues.code);
	}

	@Override
	public int hashCode() {
		return Objects.hash(languageValues, code);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class DefinitionValues {\n");
