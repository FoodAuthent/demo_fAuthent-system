...
import org.foodauthent.oneworldsync.client.model.PublicationTitleRating;

/**
 * PublicationTitleRatingModule
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-07-25T20:10:55.785Z")
public class PublicationTitleRatingModule {
	@JsonProperty("publicationTitleRating")
	private List<PublicationTitleRating> publicationTitleRating = null;

	public PublicationTitleRatingModule publicationTitleRating(List<PublicationTitleRating> publicationTitleRating) {
		this.publicationTitleRating = publicationTitleRating;
		return this;
	}

	public PublicationTitleRatingModule addPublicationTitleRatingItem(
			PublicationTitleRating publicationTitleRatingItem) {
		if (this.publicationTitleRating == null) {
			this.publicationTitleRating = new ArrayList<PublicationTitleRating>();
		}
		this.publicationTitleRating.add(publicationTitleRatingItem);
		return this;
	}

	/**
	 * Get publicationTitleRating
	 * 
	 * @return publicationTitleRating
	 **/
	@ApiModelProperty(value = "")
	public List<PublicationTitleRating> getPublicationTitleRating() {
		return publicationTitleRating;
	}

	public void setPublicationTitleRating(List<PublicationTitleRating> publicationTitleRating) {
		this.publicationTitleRating = publicationTitleRating;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		PublicationTitleRatingModule publicationTitleRatingModule = (PublicationTitleRatingModule) o;
		return Objects.equals(this.publicationTitleRating, publicationTitleRatingModule.publicationTitleRating);
	}

	@Override
	public int hashCode() {
		return Objects.hash(publicationTitleRating);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class PublicationTitleRatingModule {\n");

		sb.append("    publicationTitleRating: ").append(toIndentedString(publicationTitleRating)).append("\n");
		sb.append("}");
		return sb.toString();
	}
