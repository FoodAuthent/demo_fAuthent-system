...
public class CreditableVegetable {
	@JsonProperty("totalVegetableSubgroupAmount")
	private QualifiedValues totalVegetableSubgroupAmount = null;

	@JsonProperty("vegetableSubgroupCode")
	private CodifiedValue vegetableSubgroupCode = null;

	public CreditableVegetable totalVegetableSubgroupAmount(QualifiedValues totalVegetableSubgroupAmount) {
		this.totalVegetableSubgroupAmount = totalVegetableSubgroupAmount;
		return this;
	}

	/**
	 * Get totalVegetableSubgroupAmount
	 * 
	 * @return totalVegetableSubgroupAmount
	 **/
	@ApiModelProperty(value = "")
	public QualifiedValues getTotalVegetableSubgroupAmount() {
		return totalVegetableSubgroupAmount;
	}

	public void setTotalVegetableSubgroupAmount(QualifiedValues totalVegetableSubgroupAmount) {
		this.totalVegetableSubgroupAmount = totalVegetableSubgroupAmount;
	}

	public CreditableVegetable vegetableSubgroupCode(CodifiedValue vegetableSubgroupCode) {
		this.vegetableSubgroupCode = vegetableSubgroupCode;
		return this;
	}

	/**
	 * Get vegetableSubgroupCode
	 * 
	 * @return vegetableSubgroupCode
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getVegetableSubgroupCode() {
		return vegetableSubgroupCode;
	}

	public void setVegetableSubgroupCode(CodifiedValue vegetableSubgroupCode) {
		this.vegetableSubgroupCode = vegetableSubgroupCode;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		CreditableVegetable creditableVegetable = (CreditableVegetable) o;
		return Objects.equals(this.totalVegetableSubgroupAmount, creditableVegetable.totalVegetableSubgroupAmount)
				&& Objects.equals(this.vegetableSubgroupCode, creditableVegetable.vegetableSubgroupCode);
	}

	@Override
	public int hashCode() {
		return Objects.hash(totalVegetableSubgroupAmount, vegetableSubgroupCode);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class CreditableVegetable {\n");

		sb.append("    totalVegetableSubgroupAmount: ").append(toIndentedString(totalVegetableSubgroupAmount))
				.append("\n");
		sb.append("    vegetableSubgroupCode: ").append(toIndentedString(vegetableSubgroupCode)).append("\n");
		sb.append("}");
		return sb.toString();
	}
