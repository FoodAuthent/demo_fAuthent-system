...
public class TextileMaterialComposition {
	...
	@JsonProperty("materialThreadCount")
	private LanguageLabels materialThreadCount = null;
	...
	public TextileMaterialComposition materialCode(String materialCode) {
	...
	public TextileMaterialComposition materialContent(LanguageLabels materialContent) {
	...
	public TextileMaterialComposition materialCountryOfOrigin(List<MaterialCountryOfOrigin> materialCountryOfOrigin) {
		this.materialCountryOfOrigin = materialCountryOfOrigin;
		return this;
	}

	public TextileMaterialComposition addMaterialCountryOfOriginItem(
	...
	public TextileMaterialComposition materialPercentage(String materialPercentage) {
	...
	public TextileMaterialComposition materialThreadCount(LanguageLabels materialThreadCount) {
		this.materialThreadCount = materialThreadCount;
		return this;
	}

	/**
	 * Get materialThreadCount
	 * 
	 * @return materialThreadCount
	 **/
	@ApiModelProperty(value = "")
	public LanguageLabels getMaterialThreadCount() {
		return materialThreadCount;
	}

	public void setMaterialThreadCount(LanguageLabels materialThreadCount) {
		this.materialThreadCount = materialThreadCount;
	}

	public TextileMaterialComposition materialTreatment(LanguageLabels materialTreatment) {
	...
	public TextileMaterialComposition materialWeight(QualifiedValue materialWeight) {
	...
	public boolean equals(java.lang.Object o) {
		...
		TextileMaterialComposition textileMaterialComposition = (TextileMaterialComposition) o;
		return Objects.equals(this.materialCode, textileMaterialComposition.materialCode)
				&& Objects.equals(this.materialContent, textileMaterialComposition.materialContent)
				&& Objects.equals(this.materialCountryOfOrigin, textileMaterialComposition.materialCountryOfOrigin)
				&& Objects.equals(this.materialPercentage, textileMaterialComposition.materialPercentage)
				&& Objects.equals(this.materialThreadCount, textileMaterialComposition.materialThreadCount)
				&& Objects.equals(this.materialTreatment, textileMaterialComposition.materialTreatment)
				&& Objects.equals(this.materialWeight, textileMaterialComposition.materialWeight);
	}

	@Override
	public int hashCode() {
		return Objects.hash(materialCode, materialContent, materialCountryOfOrigin, materialPercentage,
				materialThreadCount, materialTreatment, materialWeight);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class TextileMaterialComposition {\n");
		...
		sb.append("    materialThreadCount: ").append(toIndentedString(materialThreadCount)).append("\n");
