...
import org.foodauthent.oneworldsync.client.model.ReferencedTradeItem;

/**
 * ReferencedTradeItemGroup
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-07-25T20:10:55.785Z")
public class ReferencedTradeItemGroup {
	@JsonProperty("recipient")
	private Recipient recipient = null;

	@JsonProperty("referencedTradeItem")
	private List<ReferencedTradeItem> referencedTradeItem = null;

	public ReferencedTradeItemGroup recipient(Recipient recipient) {
	...
	public ReferencedTradeItemGroup referencedTradeItem(List<ReferencedTradeItem> referencedTradeItem) {
		this.referencedTradeItem = referencedTradeItem;
		return this;
	}

	public ReferencedTradeItemGroup addReferencedTradeItemItem(ReferencedTradeItem referencedTradeItemItem) {
		if (this.referencedTradeItem == null) {
			this.referencedTradeItem = new ArrayList<ReferencedTradeItem>();
		}
		this.referencedTradeItem.add(referencedTradeItemItem);
		return this;
	}

	/**
	 * Get referencedTradeItem
	 * 
	 * @return referencedTradeItem
	 **/
	@ApiModelProperty(value = "")
	public List<ReferencedTradeItem> getReferencedTradeItem() {
		return referencedTradeItem;
	}

	public void setReferencedTradeItem(List<ReferencedTradeItem> referencedTradeItem) {
		this.referencedTradeItem = referencedTradeItem;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		ReferencedTradeItemGroup referencedTradeItemGroup = (ReferencedTradeItemGroup) o;
		return Objects.equals(this.recipient, referencedTradeItemGroup.recipient)
				&& Objects.equals(this.referencedTradeItem, referencedTradeItemGroup.referencedTradeItem);
	}

	@Override
	public int hashCode() {
		return Objects.hash(recipient, referencedTradeItem);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class ReferencedTradeItemGroup {\n");

		sb.append("    recipient: ").append(toIndentedString(recipient)).append("\n");
		sb.append("    referencedTradeItem: ").append(toIndentedString(referencedTradeItem)).append("\n");
		sb.append("}");
		return sb.toString();
	}
