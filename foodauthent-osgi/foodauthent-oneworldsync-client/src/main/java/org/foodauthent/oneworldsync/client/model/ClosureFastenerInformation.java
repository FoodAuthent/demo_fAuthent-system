...
public class ClosureFastenerInformation {
	@JsonProperty("closureOrFastenerLocation")
	private LanguageLabels closureOrFastenerLocation = null;

	@JsonProperty("closureOrFastenerTypeCode")
	private CodifiedValue closureOrFastenerTypeCode = null;

	public ClosureFastenerInformation closureOrFastenerLocation(LanguageLabels closureOrFastenerLocation) {
		this.closureOrFastenerLocation = closureOrFastenerLocation;
		return this;
	}

	/**
	 * Get closureOrFastenerLocation
	 * 
	 * @return closureOrFastenerLocation
	 **/
	@ApiModelProperty(value = "")
	public LanguageLabels getClosureOrFastenerLocation() {
		return closureOrFastenerLocation;
	}

	public void setClosureOrFastenerLocation(LanguageLabels closureOrFastenerLocation) {
		this.closureOrFastenerLocation = closureOrFastenerLocation;
	}

	public ClosureFastenerInformation closureOrFastenerTypeCode(CodifiedValue closureOrFastenerTypeCode) {
		this.closureOrFastenerTypeCode = closureOrFastenerTypeCode;
		return this;
	}

	/**
	 * Get closureOrFastenerTypeCode
	 * 
	 * @return closureOrFastenerTypeCode
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getClosureOrFastenerTypeCode() {
		return closureOrFastenerTypeCode;
	}

	public void setClosureOrFastenerTypeCode(CodifiedValue closureOrFastenerTypeCode) {
		this.closureOrFastenerTypeCode = closureOrFastenerTypeCode;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		ClosureFastenerInformation closureFastenerInformation = (ClosureFastenerInformation) o;
		return Objects.equals(this.closureOrFastenerLocation, closureFastenerInformation.closureOrFastenerLocation)
				&& Objects.equals(this.closureOrFastenerTypeCode, closureFastenerInformation.closureOrFastenerTypeCode);
	}

	@Override
	public int hashCode() {
		return Objects.hash(closureOrFastenerLocation, closureOrFastenerTypeCode);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class ClosureFastenerInformation {\n");

		sb.append("    closureOrFastenerLocation: ").append(toIndentedString(closureOrFastenerLocation)).append("\n");
		sb.append("    closureOrFastenerTypeCode: ").append(toIndentedString(closureOrFastenerTypeCode)).append("\n");
		sb.append("}");
		return sb.toString();
	}
