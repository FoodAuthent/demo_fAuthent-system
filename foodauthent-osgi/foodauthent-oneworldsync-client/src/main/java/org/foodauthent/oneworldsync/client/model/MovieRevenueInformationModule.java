...
import org.foodauthent.oneworldsync.client.model.MovieRevenueInformation;

/**
 * MovieRevenueInformationModule
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-07-25T20:10:55.785Z")
public class MovieRevenueInformationModule {
	@JsonProperty("movieRevenueInformation")
	private MovieRevenueInformation movieRevenueInformation = null;

	public MovieRevenueInformationModule movieRevenueInformation(MovieRevenueInformation movieRevenueInformation) {
		this.movieRevenueInformation = movieRevenueInformation;
		return this;
	}

	/**
	 * Get movieRevenueInformation
	 * 
	 * @return movieRevenueInformation
	 **/
	@ApiModelProperty(value = "")
	public MovieRevenueInformation getMovieRevenueInformation() {
		return movieRevenueInformation;
	}

	public void setMovieRevenueInformation(MovieRevenueInformation movieRevenueInformation) {
		this.movieRevenueInformation = movieRevenueInformation;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		MovieRevenueInformationModule movieRevenueInformationModule = (MovieRevenueInformationModule) o;
		return Objects.equals(this.movieRevenueInformation, movieRevenueInformationModule.movieRevenueInformation);
	}

	@Override
	public int hashCode() {
		return Objects.hash(movieRevenueInformation);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class MovieRevenueInformationModule {\n");

		sb.append("    movieRevenueInformation: ").append(toIndentedString(movieRevenueInformation)).append("\n");
		sb.append("}");
		return sb.toString();
	}
