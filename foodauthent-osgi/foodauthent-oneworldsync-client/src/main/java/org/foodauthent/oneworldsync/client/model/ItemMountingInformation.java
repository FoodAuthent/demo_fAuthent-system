...
public class ItemMountingInformation {
	@JsonProperty("mountLocationDescription")
	private LanguageLabels mountLocationDescription = null;

	@JsonProperty("mountTypeDescription")
	private LanguageLabels mountTypeDescription = null;

	public ItemMountingInformation mountLocationDescription(LanguageLabels mountLocationDescription) {
		this.mountLocationDescription = mountLocationDescription;
		return this;
	}

	/**
	 * Get mountLocationDescription
	 * 
	 * @return mountLocationDescription
	 **/
	@ApiModelProperty(value = "")
	public LanguageLabels getMountLocationDescription() {
		return mountLocationDescription;
	}

	public void setMountLocationDescription(LanguageLabels mountLocationDescription) {
		this.mountLocationDescription = mountLocationDescription;
	}

	public ItemMountingInformation mountTypeDescription(LanguageLabels mountTypeDescription) {
		this.mountTypeDescription = mountTypeDescription;
		return this;
	}

	/**
	 * Get mountTypeDescription
	 * 
	 * @return mountTypeDescription
	 **/
	@ApiModelProperty(value = "")
	public LanguageLabels getMountTypeDescription() {
		return mountTypeDescription;
	}

	public void setMountTypeDescription(LanguageLabels mountTypeDescription) {
		this.mountTypeDescription = mountTypeDescription;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		ItemMountingInformation itemMountingInformation = (ItemMountingInformation) o;
		return Objects.equals(this.mountLocationDescription, itemMountingInformation.mountLocationDescription)
				&& Objects.equals(this.mountTypeDescription, itemMountingInformation.mountTypeDescription);
	}

	@Override
	public int hashCode() {
		return Objects.hash(mountLocationDescription, mountTypeDescription);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class ItemMountingInformation {\n");

		sb.append("    mountLocationDescription: ").append(toIndentedString(mountLocationDescription)).append("\n");
		sb.append("    mountTypeDescription: ").append(toIndentedString(mountTypeDescription)).append("\n");
		sb.append("}");
		return sb.toString();
	}
