...
public class TradeItemMarketingMessage {
	...
	private LanguageLabels tradeItemMarketingMessage = null;

	public TradeItemMarketingMessage formattingPattern(String formattingPattern) {
	...
	public TradeItemMarketingMessage sequenceNumber(String sequenceNumber) {
	...
	public TradeItemMarketingMessage tradeItemMarketingMessage(LanguageLabels tradeItemMarketingMessage) {
	 ...
	 **/
	@ApiModelProperty(value = "")
	public LanguageLabels getTradeItemMarketingMessage() {
		return tradeItemMarketingMessage;
	}

	public void setTradeItemMarketingMessage(LanguageLabels tradeItemMarketingMessage) {
		this.tradeItemMarketingMessage = tradeItemMarketingMessage;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		TradeItemMarketingMessage tradeItemMarketingMessage = (TradeItemMarketingMessage) o;
		return Objects.equals(this.formattingPattern, tradeItemMarketingMessage.formattingPattern)
				&& Objects.equals(this.sequenceNumber, tradeItemMarketingMessage.sequenceNumber)
				&& Objects.equals(this.tradeItemMarketingMessage, tradeItemMarketingMessage.tradeItemMarketingMessage);
	}

	@Override
	public int hashCode() {
		return Objects.hash(formattingPattern, sequenceNumber, tradeItemMarketingMessage);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class TradeItemMarketingMessage {\n");
