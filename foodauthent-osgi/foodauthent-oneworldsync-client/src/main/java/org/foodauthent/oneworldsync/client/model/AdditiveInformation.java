...
import org.foodauthent.oneworldsync.client.model.AdditiveTypeCodeReference;
...
public class AdditiveInformation {
	...
	private String additiveName = null;

	@JsonProperty("additiveTypeCodeReference")
	private List<AdditiveTypeCodeReference> additiveTypeCodeReference = null;

	@JsonProperty("levelOfContainmentCode")
	private CodifiedValue levelOfContainmentCode = null;

	public AdditiveInformation additiveName(String additiveName) {
	...
	public AdditiveInformation additiveTypeCodeReference(List<AdditiveTypeCodeReference> additiveTypeCodeReference) {
		this.additiveTypeCodeReference = additiveTypeCodeReference;
		return this;
	}

	public AdditiveInformation addAdditiveTypeCodeReferenceItem(
			AdditiveTypeCodeReference additiveTypeCodeReferenceItem) {
		if (this.additiveTypeCodeReference == null) {
			this.additiveTypeCodeReference = new ArrayList<AdditiveTypeCodeReference>();
		}
		this.additiveTypeCodeReference.add(additiveTypeCodeReferenceItem);
		return this;
	}

	/**
	 * Get additiveTypeCodeReference
	 * 
	 * @return additiveTypeCodeReference
	 **/
	@ApiModelProperty(value = "")
	public List<AdditiveTypeCodeReference> getAdditiveTypeCodeReference() {
		return additiveTypeCodeReference;
	}

	public void setAdditiveTypeCodeReference(List<AdditiveTypeCodeReference> additiveTypeCodeReference) {
		this.additiveTypeCodeReference = additiveTypeCodeReference;
	}

	public AdditiveInformation levelOfContainmentCode(CodifiedValue levelOfContainmentCode) {
		this.levelOfContainmentCode = levelOfContainmentCode;
		return this;
	}

	/**
	 * Get levelOfContainmentCode
	 * 
	 * @return levelOfContainmentCode
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getLevelOfContainmentCode() {
		return levelOfContainmentCode;
	}

	public void setLevelOfContainmentCode(CodifiedValue levelOfContainmentCode) {
		this.levelOfContainmentCode = levelOfContainmentCode;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		AdditiveInformation additiveInformation = (AdditiveInformation) o;
		return Objects.equals(this.additiveName, additiveInformation.additiveName)
				&& Objects.equals(this.additiveTypeCodeReference, additiveInformation.additiveTypeCodeReference)
				&& Objects.equals(this.levelOfContainmentCode, additiveInformation.levelOfContainmentCode);
	}

	@Override
	public int hashCode() {
		return Objects.hash(additiveName, additiveTypeCodeReference, levelOfContainmentCode);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class AdditiveInformation {\n");

		sb.append("    additiveName: ").append(toIndentedString(additiveName)).append("\n");
		sb.append("    additiveTypeCodeReference: ").append(toIndentedString(additiveTypeCodeReference)).append("\n");
		sb.append("    levelOfContainmentCode: ").append(toIndentedString(levelOfContainmentCode)).append("\n");
		sb.append("}");
		return sb.toString();
	}
