...
import org.foodauthent.oneworldsync.client.model.CertificationInformation;
...
public class CertificationInformationModule {
	@JsonProperty("certificationInformation")
	private List<CertificationInformation> certificationInformation = null;

	public CertificationInformationModule certificationInformation(
			List<CertificationInformation> certificationInformation) {
		this.certificationInformation = certificationInformation;
		return this;
	}

	public CertificationInformationModule addCertificationInformationItem(
			CertificationInformation certificationInformationItem) {
		if (this.certificationInformation == null) {
			this.certificationInformation = new ArrayList<CertificationInformation>();
		}
		this.certificationInformation.add(certificationInformationItem);
		return this;
	}

	/**
	 * Get certificationInformation
	 * 
	 * @return certificationInformation
	 **/
	@ApiModelProperty(value = "")
	public List<CertificationInformation> getCertificationInformation() {
		return certificationInformation;
	}

	public void setCertificationInformation(List<CertificationInformation> certificationInformation) {
		this.certificationInformation = certificationInformation;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		CertificationInformationModule certificationInformationModule = (CertificationInformationModule) o;
		return Objects.equals(this.certificationInformation, certificationInformationModule.certificationInformation);
	}

	@Override
	public int hashCode() {
		return Objects.hash(certificationInformation);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class CertificationInformationModule {\n");

		sb.append("    certificationInformation: ").append(toIndentedString(certificationInformation)).append("\n");
		sb.append("}");
		return sb.toString();
	}
