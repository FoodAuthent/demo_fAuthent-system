...
/**
 * IsTradeItemAnInvoiceUnitGroup
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-07-25T20:10:55.785Z")
public class IsTradeItemAnInvoiceUnitGroup {
	@JsonProperty("isTradeItemAnInvoiceUnit")
	private String isTradeItemAnInvoiceUnit = null;

	@JsonProperty("recipient")
	private Recipient recipient = null;

	public IsTradeItemAnInvoiceUnitGroup isTradeItemAnInvoiceUnit(String isTradeItemAnInvoiceUnit) {
		this.isTradeItemAnInvoiceUnit = isTradeItemAnInvoiceUnit;
		return this;
	}

	/**
	 * Get isTradeItemAnInvoiceUnit
	 * 
	 * @return isTradeItemAnInvoiceUnit
	 **/
	@ApiModelProperty(value = "")
	public String getIsTradeItemAnInvoiceUnit() {
		return isTradeItemAnInvoiceUnit;
	}

	public void setIsTradeItemAnInvoiceUnit(String isTradeItemAnInvoiceUnit) {
		this.isTradeItemAnInvoiceUnit = isTradeItemAnInvoiceUnit;
	}

	public IsTradeItemAnInvoiceUnitGroup recipient(Recipient recipient) {
	...
	public boolean equals(java.lang.Object o) {
		...
		IsTradeItemAnInvoiceUnitGroup isTradeItemAnInvoiceUnitGroup = (IsTradeItemAnInvoiceUnitGroup) o;
		return Objects.equals(this.isTradeItemAnInvoiceUnit, isTradeItemAnInvoiceUnitGroup.isTradeItemAnInvoiceUnit)
				&& Objects.equals(this.recipient, isTradeItemAnInvoiceUnitGroup.recipient);
	}

	@Override
	public int hashCode() {
		return Objects.hash(isTradeItemAnInvoiceUnit, recipient);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class IsTradeItemAnInvoiceUnitGroup {\n");

		sb.append("    isTradeItemAnInvoiceUnit: ").append(toIndentedString(isTradeItemAnInvoiceUnit)).append("\n");
