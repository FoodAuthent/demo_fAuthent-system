...
import org.foodauthent.oneworldsync.client.model.AudioVisualMediaContentInformation;
...
public class AudioVisualMediaContentInformationModule {
	@JsonProperty("audioVisualMediaContentInformation")
	private List<AudioVisualMediaContentInformation> audioVisualMediaContentInformation = null;

	public AudioVisualMediaContentInformationModule audioVisualMediaContentInformation(
			List<AudioVisualMediaContentInformation> audioVisualMediaContentInformation) {
		this.audioVisualMediaContentInformation = audioVisualMediaContentInformation;
		return this;
	}

	public AudioVisualMediaContentInformationModule addAudioVisualMediaContentInformationItem(
			AudioVisualMediaContentInformation audioVisualMediaContentInformationItem) {
		if (this.audioVisualMediaContentInformation == null) {
			this.audioVisualMediaContentInformation = new ArrayList<AudioVisualMediaContentInformation>();
		}
		this.audioVisualMediaContentInformation.add(audioVisualMediaContentInformationItem);
		return this;
	}

	/**
	 * Get audioVisualMediaContentInformation
	 * 
	 * @return audioVisualMediaContentInformation
	 **/
	@ApiModelProperty(value = "")
	public List<AudioVisualMediaContentInformation> getAudioVisualMediaContentInformation() {
		return audioVisualMediaContentInformation;
	}

	public void setAudioVisualMediaContentInformation(
			List<AudioVisualMediaContentInformation> audioVisualMediaContentInformation) {
		this.audioVisualMediaContentInformation = audioVisualMediaContentInformation;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		AudioVisualMediaContentInformationModule audioVisualMediaContentInformationModule = (AudioVisualMediaContentInformationModule) o;
		return Objects.equals(this.audioVisualMediaContentInformation,
				audioVisualMediaContentInformationModule.audioVisualMediaContentInformation);
	}

	@Override
	public int hashCode() {
		return Objects.hash(audioVisualMediaContentInformation);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class AudioVisualMediaContentInformationModule {\n");

		sb.append("    audioVisualMediaContentInformation: ")
				.append(toIndentedString(audioVisualMediaContentInformation)).append("\n");
		sb.append("}");
		return sb.toString();
	}
