...
import org.foodauthent.oneworldsync.client.model.ColourCode;
...
public class Colour {
	...
	private List<ColourCode> colourCode = null;

	@JsonProperty("colourDescription")
	private LanguageLabels colourDescription = null;

	public Colour colourCode(List<ColourCode> colourCode) {
		this.colourCode = colourCode;
		return this;
	}

	public Colour addColourCodeItem(ColourCode colourCodeItem) {
		if (this.colourCode == null) {
			this.colourCode = new ArrayList<ColourCode>();
		}
		this.colourCode.add(colourCodeItem);
		return this;
	}
	...
	public List<ColourCode> getColourCode() {
		return colourCode;
	}

	public void setColourCode(List<ColourCode> colourCode) {
		this.colourCode = colourCode;
	}

	public Colour colourDescription(LanguageLabels colourDescription) {
		this.colourDescription = colourDescription;
		return this;
	}

	/**
	 * Get colourDescription
	 * 
	 * @return colourDescription
	 **/
	@ApiModelProperty(value = "")
	public LanguageLabels getColourDescription() {
		return colourDescription;
	}

	public void setColourDescription(LanguageLabels colourDescription) {
		this.colourDescription = colourDescription;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.colourCode, colour.colourCode)
				&& Objects.equals(this.colourDescription, colour.colourDescription);
	}

	@Override
	public int hashCode() {
		return Objects.hash(colourCode, colourDescription);
	}
	...
	public String toString() {
		...
		sb.append("    colourCode: ").append(toIndentedString(colourCode)).append("\n");
		sb.append("    colourDescription: ").append(toIndentedString(colourDescription)).append("\n");
		sb.append("}");
		return sb.toString();
	}
