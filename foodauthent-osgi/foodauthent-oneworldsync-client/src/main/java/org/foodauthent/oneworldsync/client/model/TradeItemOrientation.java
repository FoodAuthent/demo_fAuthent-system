...
public class TradeItemOrientation {
	@JsonProperty("orientationPreferenceSequence")
	private String orientationPreferenceSequence = null;

	@JsonProperty("orientationTypeCode")
	private CodifiedValue orientationTypeCode = null;

	public TradeItemOrientation orientationPreferenceSequence(String orientationPreferenceSequence) {
		this.orientationPreferenceSequence = orientationPreferenceSequence;
		return this;
	}

	/**
	 * Get orientationPreferenceSequence
	 * 
	 * @return orientationPreferenceSequence
	 **/
	@ApiModelProperty(value = "")
	public String getOrientationPreferenceSequence() {
		return orientationPreferenceSequence;
	}

	public void setOrientationPreferenceSequence(String orientationPreferenceSequence) {
		this.orientationPreferenceSequence = orientationPreferenceSequence;
	}

	public TradeItemOrientation orientationTypeCode(CodifiedValue orientationTypeCode) {
		this.orientationTypeCode = orientationTypeCode;
		return this;
	}

	/**
	 * Get orientationTypeCode
	 * 
	 * @return orientationTypeCode
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getOrientationTypeCode() {
		return orientationTypeCode;
	}

	public void setOrientationTypeCode(CodifiedValue orientationTypeCode) {
		this.orientationTypeCode = orientationTypeCode;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		TradeItemOrientation tradeItemOrientation = (TradeItemOrientation) o;
		return Objects.equals(this.orientationPreferenceSequence, tradeItemOrientation.orientationPreferenceSequence)
				&& Objects.equals(this.orientationTypeCode, tradeItemOrientation.orientationTypeCode);
	}

	@Override
	public int hashCode() {
		return Objects.hash(orientationPreferenceSequence, orientationTypeCode);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class TradeItemOrientation {\n");

		sb.append("    orientationPreferenceSequence: ").append(toIndentedString(orientationPreferenceSequence))
				.append("\n");
		sb.append("    orientationTypeCode: ").append(toIndentedString(orientationTypeCode)).append("\n");
		sb.append("}");
		return sb.toString();
	}
