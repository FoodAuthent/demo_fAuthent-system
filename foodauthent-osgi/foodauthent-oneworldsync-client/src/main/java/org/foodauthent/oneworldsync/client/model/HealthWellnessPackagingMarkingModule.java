...
import org.foodauthent.oneworldsync.client.model.HealthWellnessPackagingMarking;

/**
 * HealthWellnessPackagingMarkingModule
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-07-25T20:10:55.785Z")
public class HealthWellnessPackagingMarkingModule {
	@JsonProperty("healthWellnessPackagingMarking")
	private HealthWellnessPackagingMarking healthWellnessPackagingMarking = null;

	public HealthWellnessPackagingMarkingModule healthWellnessPackagingMarking(
			HealthWellnessPackagingMarking healthWellnessPackagingMarking) {
		this.healthWellnessPackagingMarking = healthWellnessPackagingMarking;
		return this;
	}

	/**
	 * Get healthWellnessPackagingMarking
	 * 
	 * @return healthWellnessPackagingMarking
	 **/
	@ApiModelProperty(value = "")
	public HealthWellnessPackagingMarking getHealthWellnessPackagingMarking() {
		return healthWellnessPackagingMarking;
	}

	public void setHealthWellnessPackagingMarking(HealthWellnessPackagingMarking healthWellnessPackagingMarking) {
		this.healthWellnessPackagingMarking = healthWellnessPackagingMarking;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		HealthWellnessPackagingMarkingModule healthWellnessPackagingMarkingModule = (HealthWellnessPackagingMarkingModule) o;
		return Objects.equals(this.healthWellnessPackagingMarking,
				healthWellnessPackagingMarkingModule.healthWellnessPackagingMarking);
	}

	@Override
	public int hashCode() {
		return Objects.hash(healthWellnessPackagingMarking);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class HealthWellnessPackagingMarkingModule {\n");

		sb.append("    healthWellnessPackagingMarking: ").append(toIndentedString(healthWellnessPackagingMarking))
				.append("\n");
		sb.append("}");
		return sb.toString();
	}
