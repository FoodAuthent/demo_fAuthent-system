...
import org.foodauthent.oneworldsync.client.model.WarrantyInformation;

/**
 * WarrantyInformationModule
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-07-25T20:10:55.785Z")
public class WarrantyInformationModule {
	@JsonProperty("warrantyInformation")
	private List<WarrantyInformation> warrantyInformation = null;

	public WarrantyInformationModule warrantyInformation(List<WarrantyInformation> warrantyInformation) {
		this.warrantyInformation = warrantyInformation;
		return this;
	}

	public WarrantyInformationModule addWarrantyInformationItem(WarrantyInformation warrantyInformationItem) {
		if (this.warrantyInformation == null) {
			this.warrantyInformation = new ArrayList<WarrantyInformation>();
		}
	...
	public boolean equals(java.lang.Object o) {
		...
		WarrantyInformationModule warrantyInformationModule = (WarrantyInformationModule) o;
		return Objects.equals(this.warrantyInformation, warrantyInformationModule.warrantyInformation);
	}

	@Override
	public int hashCode() {
		return Objects.hash(warrantyInformation);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class WarrantyInformationModule {\n");
