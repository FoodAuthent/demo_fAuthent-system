...
import org.foodauthent.oneworldsync.client.model.AlcoholInformation;

/**
 * AlcoholInformationModule
 */
...
public class AlcoholInformationModule {
	@JsonProperty("alcoholInformation")
	private AlcoholInformation alcoholInformation = null;

	public AlcoholInformationModule alcoholInformation(AlcoholInformation alcoholInformation) {
		this.alcoholInformation = alcoholInformation;
		return this;
	}

	/**
	 * Get alcoholInformation
	 * 
	 * @return alcoholInformation
	 **/
	@ApiModelProperty(value = "")
	public AlcoholInformation getAlcoholInformation() {
		return alcoholInformation;
	}

	public void setAlcoholInformation(AlcoholInformation alcoholInformation) {
		this.alcoholInformation = alcoholInformation;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		AlcoholInformationModule alcoholInformationModule = (AlcoholInformationModule) o;
		return Objects.equals(this.alcoholInformation, alcoholInformationModule.alcoholInformation);
	}

	@Override
	public int hashCode() {
		return Objects.hash(alcoholInformation);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class AlcoholInformationModule {\n");

		sb.append("    alcoholInformation: ").append(toIndentedString(alcoholInformation)).append("\n");
		sb.append("}");
		return sb.toString();
	}
