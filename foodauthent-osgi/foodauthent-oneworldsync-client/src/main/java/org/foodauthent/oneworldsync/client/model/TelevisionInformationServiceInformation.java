...
public class TelevisionInformationServiceInformation {
	@JsonProperty("televisionInformationServiceTypeCode")
	private CodifiedValues televisionInformationServiceTypeCode = null;

	@JsonProperty("televisionTextMemoryPageQuantity")
	private String televisionTextMemoryPageQuantity = null;

	public TelevisionInformationServiceInformation televisionInformationServiceTypeCode(
			CodifiedValues televisionInformationServiceTypeCode) {
		this.televisionInformationServiceTypeCode = televisionInformationServiceTypeCode;
		return this;
	}

	/**
	 * Get televisionInformationServiceTypeCode
	 * 
	 * @return televisionInformationServiceTypeCode
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValues getTelevisionInformationServiceTypeCode() {
		return televisionInformationServiceTypeCode;
	}

	public void setTelevisionInformationServiceTypeCode(CodifiedValues televisionInformationServiceTypeCode) {
		this.televisionInformationServiceTypeCode = televisionInformationServiceTypeCode;
	}

	public TelevisionInformationServiceInformation televisionTextMemoryPageQuantity(
			String televisionTextMemoryPageQuantity) {
		this.televisionTextMemoryPageQuantity = televisionTextMemoryPageQuantity;
		return this;
	}

	/**
	 * Get televisionTextMemoryPageQuantity
	 * 
	 * @return televisionTextMemoryPageQuantity
	 **/
	@ApiModelProperty(value = "")
	public String getTelevisionTextMemoryPageQuantity() {
		return televisionTextMemoryPageQuantity;
	}

	public void setTelevisionTextMemoryPageQuantity(String televisionTextMemoryPageQuantity) {
		this.televisionTextMemoryPageQuantity = televisionTextMemoryPageQuantity;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		TelevisionInformationServiceInformation televisionInformationServiceInformation = (TelevisionInformationServiceInformation) o;
		return Objects.equals(this.televisionInformationServiceTypeCode,
				televisionInformationServiceInformation.televisionInformationServiceTypeCode)
				&& Objects.equals(this.televisionTextMemoryPageQuantity,
						televisionInformationServiceInformation.televisionTextMemoryPageQuantity);
	}

	@Override
	public int hashCode() {
		return Objects.hash(televisionInformationServiceTypeCode, televisionTextMemoryPageQuantity);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class TelevisionInformationServiceInformation {\n");

		sb.append("    televisionInformationServiceTypeCode: ")
				.append(toIndentedString(televisionInformationServiceTypeCode)).append("\n");
		sb.append("    televisionTextMemoryPageQuantity: ").append(toIndentedString(televisionTextMemoryPageQuantity))
				.append("\n");
		sb.append("}");
		return sb.toString();
	}
