...
public class CodifiedValue {
	...
	public CodifiedValue value(String value) {
		this.value = value;
		return this;
	}
	...
	public CodifiedValue valueDefinition(String valueDefinition) {
	...
	public boolean equals(java.lang.Object o) {
		...
		CodifiedValue codifiedValue = (CodifiedValue) o;
		return Objects.equals(this.value, codifiedValue.value)
				&& Objects.equals(this.valueDefinition, codifiedValue.valueDefinition);
	}

	@Override
	public int hashCode() {
		return Objects.hash(value, valueDefinition);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class CodifiedValue {\n");
