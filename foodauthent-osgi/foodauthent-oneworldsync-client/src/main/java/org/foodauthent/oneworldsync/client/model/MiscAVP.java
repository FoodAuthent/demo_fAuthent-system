...
public class MiscAVP {
	@JsonProperty("miscAVPName")
	private String miscAVPName = null;

	@JsonProperty("miscAVPValue")
	private Values miscAVPValue = null;

	public MiscAVP miscAVPName(String miscAVPName) {
		this.miscAVPName = miscAVPName;
		return this;
	}
	...
	public String getMiscAVPName() {
		return miscAVPName;
	}

	public void setMiscAVPName(String miscAVPName) {
		this.miscAVPName = miscAVPName;
	}

	public MiscAVP miscAVPValue(Values miscAVPValue) {
		this.miscAVPValue = miscAVPValue;
		return this;
	}
	 ...
	 **/
	@ApiModelProperty(value = "")
	public Values getMiscAVPValue() {
		return miscAVPValue;
	}

	public void setMiscAVPValue(Values miscAVPValue) {
		this.miscAVPValue = miscAVPValue;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		MiscAVP miscAVP = (MiscAVP) o;
		return Objects.equals(this.miscAVPName, miscAVP.miscAVPName)
				&& Objects.equals(this.miscAVPValue, miscAVP.miscAVPValue);
	}

	@Override
	public int hashCode() {
		return Objects.hash(miscAVPName, miscAVPValue);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class MiscAVP {\n");

		sb.append("    miscAVPName: ").append(toIndentedString(miscAVPName)).append("\n");
		sb.append("    miscAVPValue: ").append(toIndentedString(miscAVPValue)).append("\n");
		sb.append("}");
		return sb.toString();
	}
