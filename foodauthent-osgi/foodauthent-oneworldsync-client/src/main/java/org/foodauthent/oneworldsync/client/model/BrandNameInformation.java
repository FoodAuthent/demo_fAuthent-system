...
public class BrandNameInformation {
	...
	@JsonProperty("languageSpecificBrandName")
	private LanguageLabels languageSpecificBrandName = null;

	@JsonProperty("languageSpecificSubbrandName")
	private LanguageLabels languageSpecificSubbrandName = null;

	@JsonProperty("subBrand")
	private String subBrand = null;

	public BrandNameInformation brandName(String brandName) {
	...
	public BrandNameInformation languageSpecificBrandName(LanguageLabels languageSpecificBrandName) {
		this.languageSpecificBrandName = languageSpecificBrandName;
		return this;
	}

	/**
	 * Get languageSpecificBrandName
	 * 
	 * @return languageSpecificBrandName
	 **/
	@ApiModelProperty(value = "")
	public LanguageLabels getLanguageSpecificBrandName() {
		return languageSpecificBrandName;
	}

	public void setLanguageSpecificBrandName(LanguageLabels languageSpecificBrandName) {
		this.languageSpecificBrandName = languageSpecificBrandName;
	}

	public BrandNameInformation languageSpecificSubbrandName(LanguageLabels languageSpecificSubbrandName) {
		this.languageSpecificSubbrandName = languageSpecificSubbrandName;
		return this;
	}

	/**
	 * Get languageSpecificSubbrandName
	 * 
	 * @return languageSpecificSubbrandName
	 **/
	@ApiModelProperty(value = "")
	public LanguageLabels getLanguageSpecificSubbrandName() {
		return languageSpecificSubbrandName;
	}

	public void setLanguageSpecificSubbrandName(LanguageLabels languageSpecificSubbrandName) {
		this.languageSpecificSubbrandName = languageSpecificSubbrandName;
	}

	public BrandNameInformation subBrand(String subBrand) {
	...
	public boolean equals(java.lang.Object o) {
		...
		BrandNameInformation brandNameInformation = (BrandNameInformation) o;
		return Objects.equals(this.brandName, brandNameInformation.brandName)
				&& Objects.equals(this.languageSpecificBrandName, brandNameInformation.languageSpecificBrandName)
				&& Objects.equals(this.languageSpecificSubbrandName, brandNameInformation.languageSpecificSubbrandName)
				&& Objects.equals(this.subBrand, brandNameInformation.subBrand);
	}

	@Override
	public int hashCode() {
		return Objects.hash(brandName, languageSpecificBrandName, languageSpecificSubbrandName, subBrand);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class BrandNameInformation {\n");

		sb.append("    brandName: ").append(toIndentedString(brandName)).append("\n");
		sb.append("    languageSpecificBrandName: ").append(toIndentedString(languageSpecificBrandName)).append("\n");
		sb.append("    languageSpecificSubbrandName: ").append(toIndentedString(languageSpecificSubbrandName))
				.append("\n");
