...
public class TradeItemLicenseDetail {
	@JsonProperty("tradeItemLicenseCharacter")
	private LanguageLabels tradeItemLicenseCharacter = null;

	@JsonProperty("tradeItemLicenseTitle")
	private LanguageLabels tradeItemLicenseTitle = null;

	public TradeItemLicenseDetail tradeItemLicenseCharacter(LanguageLabels tradeItemLicenseCharacter) {
		this.tradeItemLicenseCharacter = tradeItemLicenseCharacter;
		return this;
	}

	/**
	 * Get tradeItemLicenseCharacter
	 * 
	 * @return tradeItemLicenseCharacter
	 **/
	@ApiModelProperty(value = "")
	public LanguageLabels getTradeItemLicenseCharacter() {
		return tradeItemLicenseCharacter;
	}

	public void setTradeItemLicenseCharacter(LanguageLabels tradeItemLicenseCharacter) {
		this.tradeItemLicenseCharacter = tradeItemLicenseCharacter;
	}

	public TradeItemLicenseDetail tradeItemLicenseTitle(LanguageLabels tradeItemLicenseTitle) {
		this.tradeItemLicenseTitle = tradeItemLicenseTitle;
		return this;
	}

	/**
	 * Get tradeItemLicenseTitle
	 * 
	 * @return tradeItemLicenseTitle
	 **/
	@ApiModelProperty(value = "")
	public LanguageLabels getTradeItemLicenseTitle() {
		return tradeItemLicenseTitle;
	}

	public void setTradeItemLicenseTitle(LanguageLabels tradeItemLicenseTitle) {
		this.tradeItemLicenseTitle = tradeItemLicenseTitle;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		TradeItemLicenseDetail tradeItemLicenseDetail = (TradeItemLicenseDetail) o;
		return Objects.equals(this.tradeItemLicenseCharacter, tradeItemLicenseDetail.tradeItemLicenseCharacter)
				&& Objects.equals(this.tradeItemLicenseTitle, tradeItemLicenseDetail.tradeItemLicenseTitle);
	}

	@Override
	public int hashCode() {
		return Objects.hash(tradeItemLicenseCharacter, tradeItemLicenseTitle);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class TradeItemLicenseDetail {\n");

		sb.append("    tradeItemLicenseCharacter: ").append(toIndentedString(tradeItemLicenseCharacter)).append("\n");
		sb.append("    tradeItemLicenseTitle: ").append(toIndentedString(tradeItemLicenseTitle)).append("\n");
		sb.append("}");
		return sb.toString();
	}
