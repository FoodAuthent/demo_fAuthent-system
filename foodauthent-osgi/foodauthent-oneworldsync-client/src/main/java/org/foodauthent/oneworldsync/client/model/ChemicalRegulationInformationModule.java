...
import org.foodauthent.oneworldsync.client.model.ChemicalRegulationInformation;
import org.foodauthent.oneworldsync.client.model.RegistrationInformation;
...
public class ChemicalRegulationInformationModule {
	@JsonProperty("chemicalRegulationInformation")
	private List<ChemicalRegulationInformation> chemicalRegulationInformation = null;

	@JsonProperty("registrationInformation")
	private List<RegistrationInformation> registrationInformation = null;

	public ChemicalRegulationInformationModule chemicalRegulationInformation(
			List<ChemicalRegulationInformation> chemicalRegulationInformation) {
		this.chemicalRegulationInformation = chemicalRegulationInformation;
		return this;
	}

	public ChemicalRegulationInformationModule addChemicalRegulationInformationItem(
			ChemicalRegulationInformation chemicalRegulationInformationItem) {
		if (this.chemicalRegulationInformation == null) {
			this.chemicalRegulationInformation = new ArrayList<ChemicalRegulationInformation>();
		}
		this.chemicalRegulationInformation.add(chemicalRegulationInformationItem);
		return this;
	}

	/**
	 * Get chemicalRegulationInformation
	 * 
	 * @return chemicalRegulationInformation
	 **/
	@ApiModelProperty(value = "")
	public List<ChemicalRegulationInformation> getChemicalRegulationInformation() {
		return chemicalRegulationInformation;
	}

	public void setChemicalRegulationInformation(List<ChemicalRegulationInformation> chemicalRegulationInformation) {
		this.chemicalRegulationInformation = chemicalRegulationInformation;
	}

	public ChemicalRegulationInformationModule registrationInformation(
			List<RegistrationInformation> registrationInformation) {
		this.registrationInformation = registrationInformation;
		return this;
	}

	public ChemicalRegulationInformationModule addRegistrationInformationItem(
			RegistrationInformation registrationInformationItem) {
		if (this.registrationInformation == null) {
			this.registrationInformation = new ArrayList<RegistrationInformation>();
		}
		this.registrationInformation.add(registrationInformationItem);
		return this;
	}
	 ...
	 **/
	@ApiModelProperty(value = "")
	public List<RegistrationInformation> getRegistrationInformation() {
		return registrationInformation;
	}

	public void setRegistrationInformation(List<RegistrationInformation> registrationInformation) {
		this.registrationInformation = registrationInformation;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		ChemicalRegulationInformationModule chemicalRegulationInformationModule = (ChemicalRegulationInformationModule) o;
		return Objects.equals(this.chemicalRegulationInformation,
				chemicalRegulationInformationModule.chemicalRegulationInformation)
				&& Objects.equals(this.registrationInformation,
						chemicalRegulationInformationModule.registrationInformation);
	}

	@Override
	public int hashCode() {
		return Objects.hash(chemicalRegulationInformation, registrationInformation);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class ChemicalRegulationInformationModule {\n");

		sb.append("    chemicalRegulationInformation: ").append(toIndentedString(chemicalRegulationInformation))
				.append("\n");
