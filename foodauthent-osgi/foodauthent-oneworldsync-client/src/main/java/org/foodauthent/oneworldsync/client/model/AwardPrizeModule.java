...
import org.foodauthent.oneworldsync.client.model.AwardPrize;

/**
 * AwardPrizeModule
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-07-25T20:10:55.785Z")
public class AwardPrizeModule {
	@JsonProperty("awardPrize")
	private List<AwardPrize> awardPrize = null;

	public AwardPrizeModule awardPrize(List<AwardPrize> awardPrize) {
		this.awardPrize = awardPrize;
		return this;
	}

	public AwardPrizeModule addAwardPrizeItem(AwardPrize awardPrizeItem) {
		if (this.awardPrize == null) {
			this.awardPrize = new ArrayList<AwardPrize>();
		}
		this.awardPrize.add(awardPrizeItem);
		return this;
	}
	...
	public List<AwardPrize> getAwardPrize() {
		return awardPrize;
	}

	public void setAwardPrize(List<AwardPrize> awardPrize) {
		this.awardPrize = awardPrize;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		AwardPrizeModule awardPrizeModule = (AwardPrizeModule) o;
		return Objects.equals(this.awardPrize, awardPrizeModule.awardPrize);
	}

	@Override
	public int hashCode() {
		return Objects.hash(awardPrize);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class AwardPrizeModule {\n");

		sb.append("    awardPrize: ").append(toIndentedString(awardPrize)).append("\n");
		sb.append("}");
		return sb.toString();
	}
