...
public class DubbedSubtitledInformation {
	@JsonProperty("dubbedLanguageCode")
	private Values dubbedLanguageCode = null;

	@JsonProperty("dubbedSubtitledCode")
	private CodifiedValue dubbedSubtitledCode = null;

	@JsonProperty("subtitledLanguageCode")
	private Values subtitledLanguageCode = null;

	public DubbedSubtitledInformation dubbedLanguageCode(Values dubbedLanguageCode) {
		this.dubbedLanguageCode = dubbedLanguageCode;
		return this;
	}

	/**
	 * Get dubbedLanguageCode
	 * 
	 * @return dubbedLanguageCode
	 **/
	@ApiModelProperty(value = "")
	public Values getDubbedLanguageCode() {
		return dubbedLanguageCode;
	}

	public void setDubbedLanguageCode(Values dubbedLanguageCode) {
		this.dubbedLanguageCode = dubbedLanguageCode;
	}

	public DubbedSubtitledInformation dubbedSubtitledCode(CodifiedValue dubbedSubtitledCode) {
		this.dubbedSubtitledCode = dubbedSubtitledCode;
		return this;
	}

	/**
	 * Get dubbedSubtitledCode
	 * 
	 * @return dubbedSubtitledCode
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getDubbedSubtitledCode() {
		return dubbedSubtitledCode;
	}

	public void setDubbedSubtitledCode(CodifiedValue dubbedSubtitledCode) {
		this.dubbedSubtitledCode = dubbedSubtitledCode;
	}

	public DubbedSubtitledInformation subtitledLanguageCode(Values subtitledLanguageCode) {
		this.subtitledLanguageCode = subtitledLanguageCode;
		return this;
	}

	/**
	 * Get subtitledLanguageCode
	 * 
	 * @return subtitledLanguageCode
	 **/
	@ApiModelProperty(value = "")
	public Values getSubtitledLanguageCode() {
		return subtitledLanguageCode;
	}

	public void setSubtitledLanguageCode(Values subtitledLanguageCode) {
		this.subtitledLanguageCode = subtitledLanguageCode;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		DubbedSubtitledInformation dubbedSubtitledInformation = (DubbedSubtitledInformation) o;
		return Objects.equals(this.dubbedLanguageCode, dubbedSubtitledInformation.dubbedLanguageCode)
				&& Objects.equals(this.dubbedSubtitledCode, dubbedSubtitledInformation.dubbedSubtitledCode)
				&& Objects.equals(this.subtitledLanguageCode, dubbedSubtitledInformation.subtitledLanguageCode);
	}

	@Override
	public int hashCode() {
		return Objects.hash(dubbedLanguageCode, dubbedSubtitledCode, subtitledLanguageCode);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class DubbedSubtitledInformation {\n");

		sb.append("    dubbedLanguageCode: ").append(toIndentedString(dubbedLanguageCode)).append("\n");
		sb.append("    dubbedSubtitledCode: ").append(toIndentedString(dubbedSubtitledCode)).append("\n");
		sb.append("    subtitledLanguageCode: ").append(toIndentedString(subtitledLanguageCode)).append("\n");
		sb.append("}");
		return sb.toString();
	}
