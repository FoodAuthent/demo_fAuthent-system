...
public class EnumerationValueInformation {
	@JsonProperty("enumerationValue")
	private String enumerationValue = null;

	@JsonProperty("enumerationValueDefinition")
	private String enumerationValueDefinition = null;

	@JsonProperty("enumerationValueDescription")
	private LanguageLabels enumerationValueDescription = null;

	public EnumerationValueInformation enumerationValue(String enumerationValue) {
	...
	public EnumerationValueInformation enumerationValueDefinition(String enumerationValueDefinition) {
		this.enumerationValueDefinition = enumerationValueDefinition;
		return this;
	}

	/**
	 * Get enumerationValueDefinition
	 * 
	 * @return enumerationValueDefinition
	 **/
	@ApiModelProperty(value = "")
	public String getEnumerationValueDefinition() {
		return enumerationValueDefinition;
	}

	public void setEnumerationValueDefinition(String enumerationValueDefinition) {
		this.enumerationValueDefinition = enumerationValueDefinition;
	}

	public EnumerationValueInformation enumerationValueDescription(LanguageLabels enumerationValueDescription) {
		this.enumerationValueDescription = enumerationValueDescription;
		return this;
	}

	/**
	 * Get enumerationValueDescription
	 * 
	 * @return enumerationValueDescription
	 **/
	@ApiModelProperty(value = "")
	public LanguageLabels getEnumerationValueDescription() {
		return enumerationValueDescription;
	}

	public void setEnumerationValueDescription(LanguageLabels enumerationValueDescription) {
		this.enumerationValueDescription = enumerationValueDescription;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		EnumerationValueInformation enumerationValueInformation = (EnumerationValueInformation) o;
		return Objects.equals(this.enumerationValue, enumerationValueInformation.enumerationValue)
				&& Objects.equals(this.enumerationValueDefinition,
						enumerationValueInformation.enumerationValueDefinition)
				&& Objects.equals(this.enumerationValueDescription,
						enumerationValueInformation.enumerationValueDescription);
	}

	@Override
	public int hashCode() {
		return Objects.hash(enumerationValue, enumerationValueDefinition, enumerationValueDescription);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class EnumerationValueInformation {\n");

		sb.append("    enumerationValue: ").append(toIndentedString(enumerationValue)).append("\n");
		sb.append("    enumerationValueDefinition: ").append(toIndentedString(enumerationValueDefinition)).append("\n");
		sb.append("    enumerationValueDescription: ").append(toIndentedString(enumerationValueDescription))
				.append("\n");
		sb.append("}");
		return sb.toString();
	}
