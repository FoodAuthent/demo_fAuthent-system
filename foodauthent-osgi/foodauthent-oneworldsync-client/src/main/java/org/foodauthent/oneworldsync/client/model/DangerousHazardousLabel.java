...
public class DangerousHazardousLabel {
	@JsonProperty("dangerousHazardousLabelNumber")
	private String dangerousHazardousLabelNumber = null;

	@JsonProperty("dangerousHazardousLabelSequenceNumber")
	private String dangerousHazardousLabelSequenceNumber = null;

	public DangerousHazardousLabel dangerousHazardousLabelNumber(String dangerousHazardousLabelNumber) {
		this.dangerousHazardousLabelNumber = dangerousHazardousLabelNumber;
		return this;
	}

	/**
	 * Get dangerousHazardousLabelNumber
	 * 
	...
	public void setDangerousHazardousLabelNumber(String dangerousHazardousLabelNumber) {
		this.dangerousHazardousLabelNumber = dangerousHazardousLabelNumber;
	}

	public DangerousHazardousLabel dangerousHazardousLabelSequenceNumber(String dangerousHazardousLabelSequenceNumber) {
		this.dangerousHazardousLabelSequenceNumber = dangerousHazardousLabelSequenceNumber;
		return this;
	}

	/**
	 * Get dangerousHazardousLabelSequenceNumber
	 * 
	 * @return dangerousHazardousLabelSequenceNumber
	 **/
	@ApiModelProperty(value = "")
	public String getDangerousHazardousLabelSequenceNumber() {
		return dangerousHazardousLabelSequenceNumber;
	}

	public void setDangerousHazardousLabelSequenceNumber(String dangerousHazardousLabelSequenceNumber) {
		this.dangerousHazardousLabelSequenceNumber = dangerousHazardousLabelSequenceNumber;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		DangerousHazardousLabel dangerousHazardousLabel = (DangerousHazardousLabel) o;
		return Objects.equals(this.dangerousHazardousLabelNumber, dangerousHazardousLabel.dangerousHazardousLabelNumber)
				&& Objects.equals(this.dangerousHazardousLabelSequenceNumber,
						dangerousHazardousLabel.dangerousHazardousLabelSequenceNumber);
	}

	@Override
	public int hashCode() {
		return Objects.hash(dangerousHazardousLabelNumber, dangerousHazardousLabelSequenceNumber);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class DangerousHazardousLabel {\n");

		sb.append("    dangerousHazardousLabelNumber: ").append(toIndentedString(dangerousHazardousLabelNumber))
				.append("\n");
		sb.append("    dangerousHazardousLabelSequenceNumber: ")
				.append(toIndentedString(dangerousHazardousLabelSequenceNumber)).append("\n");
		sb.append("}");
		return sb.toString();
	}
