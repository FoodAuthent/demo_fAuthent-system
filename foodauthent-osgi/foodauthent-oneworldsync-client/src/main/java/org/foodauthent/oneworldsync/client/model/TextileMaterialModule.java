...
import org.foodauthent.oneworldsync.client.model.TextileMaterial;

/**
 * TextileMaterialModule
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-07-25T20:10:55.785Z")
public class TextileMaterialModule {
	@JsonProperty("textileMaterial")
	private List<TextileMaterial> textileMaterial = null;

	public TextileMaterialModule textileMaterial(List<TextileMaterial> textileMaterial) {
		this.textileMaterial = textileMaterial;
		return this;
	}

	public TextileMaterialModule addTextileMaterialItem(TextileMaterial textileMaterialItem) {
		if (this.textileMaterial == null) {
			this.textileMaterial = new ArrayList<TextileMaterial>();
		}
		this.textileMaterial.add(textileMaterialItem);
		return this;
	}
	...
	public List<TextileMaterial> getTextileMaterial() {
		return textileMaterial;
	}

	public void setTextileMaterial(List<TextileMaterial> textileMaterial) {
		this.textileMaterial = textileMaterial;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		TextileMaterialModule textileMaterialModule = (TextileMaterialModule) o;
		return Objects.equals(this.textileMaterial, textileMaterialModule.textileMaterial);
	}

	@Override
	public int hashCode() {
		return Objects.hash(textileMaterial);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class TextileMaterialModule {\n");

		sb.append("    textileMaterial: ").append(toIndentedString(textileMaterial)).append("\n");
		sb.append("}");
		return sb.toString();
	}
