...
public class RegulatedChemicalIdentifierCodeReference {
	...
	@JsonProperty("regulatedChemicalIdentifierCodeReferenceValue")
	private String regulatedChemicalIdentifierCodeReferenceValue = null;

	public RegulatedChemicalIdentifierCodeReference codeDescription(String codeDescription) {
	...
	public RegulatedChemicalIdentifierCodeReference codeListAgencyCode(String codeListAgencyCode) {
	...
	public RegulatedChemicalIdentifierCodeReference codeListAgencyCodeListVersion(
	...
	public RegulatedChemicalIdentifierCodeReference codeListAgencyName(String codeListAgencyName) {
	...
	public RegulatedChemicalIdentifierCodeReference codeListName(String codeListName) {
	...
	public RegulatedChemicalIdentifierCodeReference codeListURI(String codeListURI) {
	...
	public RegulatedChemicalIdentifierCodeReference codeListVersion(String codeListVersion) {
	...
	public RegulatedChemicalIdentifierCodeReference regulatedChemicalIdentifierCodeReferenceValue(
			String regulatedChemicalIdentifierCodeReferenceValue) {
		this.regulatedChemicalIdentifierCodeReferenceValue = regulatedChemicalIdentifierCodeReferenceValue;
		return this;
	}

	/**
	 * Get regulatedChemicalIdentifierCodeReferenceValue
	 * 
	 * @return regulatedChemicalIdentifierCodeReferenceValue
	 **/
	@ApiModelProperty(value = "")
	public String getRegulatedChemicalIdentifierCodeReferenceValue() {
		return regulatedChemicalIdentifierCodeReferenceValue;
	}

	public void setRegulatedChemicalIdentifierCodeReferenceValue(String regulatedChemicalIdentifierCodeReferenceValue) {
		this.regulatedChemicalIdentifierCodeReferenceValue = regulatedChemicalIdentifierCodeReferenceValue;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		RegulatedChemicalIdentifierCodeReference regulatedChemicalIdentifierCodeReference = (RegulatedChemicalIdentifierCodeReference) o;
		return Objects.equals(this.codeDescription, regulatedChemicalIdentifierCodeReference.codeDescription)
				&& Objects.equals(this.codeListAgencyCode, regulatedChemicalIdentifierCodeReference.codeListAgencyCode)
				&& Objects.equals(this.codeListAgencyCodeListVersion,
						regulatedChemicalIdentifierCodeReference.codeListAgencyCodeListVersion)
				&& Objects.equals(this.codeListAgencyName, regulatedChemicalIdentifierCodeReference.codeListAgencyName)
				&& Objects.equals(this.codeListName, regulatedChemicalIdentifierCodeReference.codeListName)
				&& Objects.equals(this.codeListURI, regulatedChemicalIdentifierCodeReference.codeListURI)
				&& Objects.equals(this.codeListVersion, regulatedChemicalIdentifierCodeReference.codeListVersion)
				&& Objects.equals(this.regulatedChemicalIdentifierCodeReferenceValue,
						regulatedChemicalIdentifierCodeReference.regulatedChemicalIdentifierCodeReferenceValue);
	}

	@Override
	public int hashCode() {
		return Objects.hash(codeDescription, codeListAgencyCode, codeListAgencyCodeListVersion, codeListAgencyName,
				codeListName, codeListURI, codeListVersion, regulatedChemicalIdentifierCodeReferenceValue);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class RegulatedChemicalIdentifierCodeReference {\n");
		...
		sb.append("    regulatedChemicalIdentifierCodeReferenceValue: ")
				.append(toIndentedString(regulatedChemicalIdentifierCodeReferenceValue)).append("\n");
		sb.append("}");
		return sb.toString();
	}
