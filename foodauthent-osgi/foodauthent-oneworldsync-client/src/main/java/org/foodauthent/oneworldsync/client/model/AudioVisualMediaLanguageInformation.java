...
public class AudioVisualMediaLanguageInformation {
	@JsonProperty("availableLanguageCode")
	private Values availableLanguageCode = null;

	@JsonProperty("closedCaptioningCode")
	private CodifiedValue closedCaptioningCode = null;

	@JsonProperty("originalLanguageCode")
	private String originalLanguageCode = null;

	public AudioVisualMediaLanguageInformation availableLanguageCode(Values availableLanguageCode) {
		this.availableLanguageCode = availableLanguageCode;
		return this;
	}

	/**
	 * Get availableLanguageCode
	 * 
	 * @return availableLanguageCode
	 **/
	@ApiModelProperty(value = "")
	public Values getAvailableLanguageCode() {
		return availableLanguageCode;
	}

	public void setAvailableLanguageCode(Values availableLanguageCode) {
		this.availableLanguageCode = availableLanguageCode;
	}

	public AudioVisualMediaLanguageInformation closedCaptioningCode(CodifiedValue closedCaptioningCode) {
		this.closedCaptioningCode = closedCaptioningCode;
		return this;
	}

	/**
	 * Get closedCaptioningCode
	 * 
	 * @return closedCaptioningCode
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getClosedCaptioningCode() {
		return closedCaptioningCode;
	}

	public void setClosedCaptioningCode(CodifiedValue closedCaptioningCode) {
		this.closedCaptioningCode = closedCaptioningCode;
	}

	public AudioVisualMediaLanguageInformation originalLanguageCode(String originalLanguageCode) {
		this.originalLanguageCode = originalLanguageCode;
		return this;
	}

	/**
	 * Get originalLanguageCode
	 * 
	...
	public boolean equals(java.lang.Object o) {
		...
		AudioVisualMediaLanguageInformation audioVisualMediaLanguageInformation = (AudioVisualMediaLanguageInformation) o;
		return Objects.equals(this.availableLanguageCode, audioVisualMediaLanguageInformation.availableLanguageCode)
				&& Objects.equals(this.closedCaptioningCode, audioVisualMediaLanguageInformation.closedCaptioningCode)
				&& Objects.equals(this.originalLanguageCode, audioVisualMediaLanguageInformation.originalLanguageCode);
	}

	@Override
	public int hashCode() {
		return Objects.hash(availableLanguageCode, closedCaptioningCode, originalLanguageCode);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class AudioVisualMediaLanguageInformation {\n");

		sb.append("    availableLanguageCode: ").append(toIndentedString(availableLanguageCode)).append("\n");
		sb.append("    closedCaptioningCode: ").append(toIndentedString(closedCaptioningCode)).append("\n");
		sb.append("    originalLanguageCode: ").append(toIndentedString(originalLanguageCode)).append("\n");
		sb.append("}");
		return sb.toString();
	}
