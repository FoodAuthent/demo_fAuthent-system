...
import org.foodauthent.oneworldsync.client.model.DutyFeeTaxInformation;
...
public class DutyFeeTaxInformationModule {
	@JsonProperty("dutyFeeTaxInformation")
	private List<DutyFeeTaxInformation> dutyFeeTaxInformation = null;

	public DutyFeeTaxInformationModule dutyFeeTaxInformation(List<DutyFeeTaxInformation> dutyFeeTaxInformation) {
		this.dutyFeeTaxInformation = dutyFeeTaxInformation;
		return this;
	}

	public DutyFeeTaxInformationModule addDutyFeeTaxInformationItem(DutyFeeTaxInformation dutyFeeTaxInformationItem) {
		if (this.dutyFeeTaxInformation == null) {
			this.dutyFeeTaxInformation = new ArrayList<DutyFeeTaxInformation>();
		}
		this.dutyFeeTaxInformation.add(dutyFeeTaxInformationItem);
		return this;
	}

	/**
	 * Get dutyFeeTaxInformation
	 * 
	 * @return dutyFeeTaxInformation
	 **/
	@ApiModelProperty(value = "")
	public List<DutyFeeTaxInformation> getDutyFeeTaxInformation() {
		return dutyFeeTaxInformation;
	}

	public void setDutyFeeTaxInformation(List<DutyFeeTaxInformation> dutyFeeTaxInformation) {
		this.dutyFeeTaxInformation = dutyFeeTaxInformation;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		DutyFeeTaxInformationModule dutyFeeTaxInformationModule = (DutyFeeTaxInformationModule) o;
		return Objects.equals(this.dutyFeeTaxInformation, dutyFeeTaxInformationModule.dutyFeeTaxInformation);
	}

	@Override
	public int hashCode() {
		return Objects.hash(dutyFeeTaxInformation);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class DutyFeeTaxInformationModule {\n");

		sb.append("    dutyFeeTaxInformation: ").append(toIndentedString(dutyFeeTaxInformation)).append("\n");
		sb.append("}");
		return sb.toString();
	}
