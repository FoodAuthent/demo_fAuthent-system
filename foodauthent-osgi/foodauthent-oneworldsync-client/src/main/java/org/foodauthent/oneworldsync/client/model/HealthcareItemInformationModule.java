...
import org.foodauthent.oneworldsync.client.model.HealthcareItemInformation;
...
public class HealthcareItemInformationModule {
	@JsonProperty("healthcareItemInformation")
	private List<HealthcareItemInformation> healthcareItemInformation = null;

	public HealthcareItemInformationModule healthcareItemInformation(
			List<HealthcareItemInformation> healthcareItemInformation) {
		this.healthcareItemInformation = healthcareItemInformation;
		return this;
	}

	public HealthcareItemInformationModule addHealthcareItemInformationItem(
			HealthcareItemInformation healthcareItemInformationItem) {
		if (this.healthcareItemInformation == null) {
			this.healthcareItemInformation = new ArrayList<HealthcareItemInformation>();
		}
		this.healthcareItemInformation.add(healthcareItemInformationItem);
		return this;
	}

	/**
	 * Get healthcareItemInformation
	 * 
	 * @return healthcareItemInformation
	 **/
	@ApiModelProperty(value = "")
	public List<HealthcareItemInformation> getHealthcareItemInformation() {
		return healthcareItemInformation;
	}

	public void setHealthcareItemInformation(List<HealthcareItemInformation> healthcareItemInformation) {
		this.healthcareItemInformation = healthcareItemInformation;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		HealthcareItemInformationModule healthcareItemInformationModule = (HealthcareItemInformationModule) o;
		return Objects.equals(this.healthcareItemInformation,
				healthcareItemInformationModule.healthcareItemInformation);
	}

	@Override
	public int hashCode() {
		return Objects.hash(healthcareItemInformation);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class HealthcareItemInformationModule {\n");

		sb.append("    healthcareItemInformation: ").append(toIndentedString(healthcareItemInformation)).append("\n");
		sb.append("}");
		return sb.toString();
	}
