...
import org.foodauthent.oneworldsync.client.model.AllergenRelatedInformation;
...
public class AllergenInformationModule {
	...
	private List<AllergenRelatedInformation> allergenRelatedInformation = null;

	public AllergenInformationModule allergenRelatedInformation(
			List<AllergenRelatedInformation> allergenRelatedInformation) {
		this.allergenRelatedInformation = allergenRelatedInformation;
		return this;
	}

	public AllergenInformationModule addAllergenRelatedInformationItem(
			AllergenRelatedInformation allergenRelatedInformationItem) {
		if (this.allergenRelatedInformation == null) {
			this.allergenRelatedInformation = new ArrayList<AllergenRelatedInformation>();
		}
		this.allergenRelatedInformation.add(allergenRelatedInformationItem);
		return this;
	}

	/**
	 * Get allergenRelatedInformation
	 * 
	 * @return allergenRelatedInformation
	 **/
	@ApiModelProperty(value = "")
	public List<AllergenRelatedInformation> getAllergenRelatedInformation() {
		return allergenRelatedInformation;
	}

	public void setAllergenRelatedInformation(List<AllergenRelatedInformation> allergenRelatedInformation) {
		this.allergenRelatedInformation = allergenRelatedInformation;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		AllergenInformationModule allergenInformationModule = (AllergenInformationModule) o;
		return Objects.equals(this.allergenRelatedInformation, allergenInformationModule.allergenRelatedInformation);
	}

	@Override
	public int hashCode() {
		return Objects.hash(allergenRelatedInformation);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class AllergenInformationModule {\n");

		sb.append("    allergenRelatedInformation: ").append(toIndentedString(allergenRelatedInformation)).append("\n");
		sb.append("}");
		return sb.toString();
	}
