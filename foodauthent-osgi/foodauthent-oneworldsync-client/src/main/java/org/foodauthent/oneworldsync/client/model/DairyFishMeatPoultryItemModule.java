...
import org.foodauthent.oneworldsync.client.model.DairyFishMeatPoultryInformation;
...
public class DairyFishMeatPoultryItemModule {
	@JsonProperty("dairyFishMeatPoultryInformation")
	private DairyFishMeatPoultryInformation dairyFishMeatPoultryInformation = null;

	public DairyFishMeatPoultryItemModule dairyFishMeatPoultryInformation(
			DairyFishMeatPoultryInformation dairyFishMeatPoultryInformation) {
		this.dairyFishMeatPoultryInformation = dairyFishMeatPoultryInformation;
		return this;
	}

	/**
	 * Get dairyFishMeatPoultryInformation
	 * 
	 * @return dairyFishMeatPoultryInformation
	 **/
	@ApiModelProperty(value = "")
	public DairyFishMeatPoultryInformation getDairyFishMeatPoultryInformation() {
		return dairyFishMeatPoultryInformation;
	}

	public void setDairyFishMeatPoultryInformation(DairyFishMeatPoultryInformation dairyFishMeatPoultryInformation) {
		this.dairyFishMeatPoultryInformation = dairyFishMeatPoultryInformation;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		DairyFishMeatPoultryItemModule dairyFishMeatPoultryItemModule = (DairyFishMeatPoultryItemModule) o;
		return Objects.equals(this.dairyFishMeatPoultryInformation,
				dairyFishMeatPoultryItemModule.dairyFishMeatPoultryInformation);
	}

	@Override
	public int hashCode() {
		return Objects.hash(dairyFishMeatPoultryInformation);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class DairyFishMeatPoultryItemModule {\n");

		sb.append("    dairyFishMeatPoultryInformation: ").append(toIndentedString(dairyFishMeatPoultryInformation))
				.append("\n");
		sb.append("}");
		return sb.toString();
	}
