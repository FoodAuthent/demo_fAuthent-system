...
import org.foodauthent.oneworldsync.client.model.TradeItemSize;
...
public class TradeItemSizeModule {
	@JsonProperty("tradeItemSize")
	private List<TradeItemSize> tradeItemSize = null;

	public TradeItemSizeModule tradeItemSize(List<TradeItemSize> tradeItemSize) {
		this.tradeItemSize = tradeItemSize;
		return this;
	}

	public TradeItemSizeModule addTradeItemSizeItem(TradeItemSize tradeItemSizeItem) {
		if (this.tradeItemSize == null) {
			this.tradeItemSize = new ArrayList<TradeItemSize>();
		}
		this.tradeItemSize.add(tradeItemSizeItem);
		return this;
	}
	 ...
	 * Get tradeItemSize
	 * 
	 * @return tradeItemSize
	 **/
	@ApiModelProperty(value = "")
	public List<TradeItemSize> getTradeItemSize() {
		return tradeItemSize;
	}

	public void setTradeItemSize(List<TradeItemSize> tradeItemSize) {
		this.tradeItemSize = tradeItemSize;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		TradeItemSizeModule tradeItemSizeModule = (TradeItemSizeModule) o;
		return Objects.equals(this.tradeItemSize, tradeItemSizeModule.tradeItemSize);
	}

	@Override
	public int hashCode() {
		return Objects.hash(tradeItemSize);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class TradeItemSizeModule {\n");

		sb.append("    tradeItemSize: ").append(toIndentedString(tradeItemSize)).append("\n");
		sb.append("}");
		return sb.toString();
	}
