...
import org.foodauthent.oneworldsync.client.model.ChemicalIngredient;

/**
 * ChemicalInformation
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-07-25T20:10:55.785Z")
public class ChemicalInformation {
	@JsonProperty("chemicalIngredient")
	private List<ChemicalIngredient> chemicalIngredient = null;

	@JsonProperty("chemicalIngredientOrganisation")
	private String chemicalIngredientOrganisation = null;

	@JsonProperty("chemicalIngredientScheme")
	private String chemicalIngredientScheme = null;

	public ChemicalInformation chemicalIngredient(List<ChemicalIngredient> chemicalIngredient) {
		this.chemicalIngredient = chemicalIngredient;
		return this;
	}

	public ChemicalInformation addChemicalIngredientItem(ChemicalIngredient chemicalIngredientItem) {
		if (this.chemicalIngredient == null) {
			this.chemicalIngredient = new ArrayList<ChemicalIngredient>();
		}
		this.chemicalIngredient.add(chemicalIngredientItem);
		return this;
	}

	/**
	 * Get chemicalIngredient
	 * 
	 * @return chemicalIngredient
	 **/
	@ApiModelProperty(value = "")
	public List<ChemicalIngredient> getChemicalIngredient() {
		return chemicalIngredient;
	}

	public void setChemicalIngredient(List<ChemicalIngredient> chemicalIngredient) {
		this.chemicalIngredient = chemicalIngredient;
	}

	public ChemicalInformation chemicalIngredientOrganisation(String chemicalIngredientOrganisation) {
		this.chemicalIngredientOrganisation = chemicalIngredientOrganisation;
		return this;
	}

	/**
	 * Get chemicalIngredientOrganisation
	 * 
	...
	public void setChemicalIngredientOrganisation(String chemicalIngredientOrganisation) {
		this.chemicalIngredientOrganisation = chemicalIngredientOrganisation;
	}

	public ChemicalInformation chemicalIngredientScheme(String chemicalIngredientScheme) {
		this.chemicalIngredientScheme = chemicalIngredientScheme;
		return this;
	}

	/**
	 * Get chemicalIngredientScheme
	 * 
	...
	public void setChemicalIngredientScheme(String chemicalIngredientScheme) {
		this.chemicalIngredientScheme = chemicalIngredientScheme;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		ChemicalInformation chemicalInformation = (ChemicalInformation) o;
		return Objects.equals(this.chemicalIngredient, chemicalInformation.chemicalIngredient)
				&& Objects.equals(this.chemicalIngredientOrganisation,
						chemicalInformation.chemicalIngredientOrganisation)
				&& Objects.equals(this.chemicalIngredientScheme, chemicalInformation.chemicalIngredientScheme);
	}

	@Override
	public int hashCode() {
		return Objects.hash(chemicalIngredient, chemicalIngredientOrganisation, chemicalIngredientScheme);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class ChemicalInformation {\n");

		sb.append("    chemicalIngredient: ").append(toIndentedString(chemicalIngredient)).append("\n");
		sb.append("    chemicalIngredientOrganisation: ").append(toIndentedString(chemicalIngredientOrganisation))
				.append("\n");
		sb.append("    chemicalIngredientScheme: ").append(toIndentedString(chemicalIngredientScheme)).append("\n");
		sb.append("}");
		return sb.toString();
	}
