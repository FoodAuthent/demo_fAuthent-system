...
public class HazardStatement {
	@JsonProperty("hazardStatementsCode")
	private String hazardStatementsCode = null;

	@JsonProperty("hazardStatementsDescription")
	private LanguageLabels hazardStatementsDescription = null;

	public HazardStatement hazardStatementsCode(String hazardStatementsCode) {
		this.hazardStatementsCode = hazardStatementsCode;
		return this;
	}

	/**
	 * Get hazardStatementsCode
	 * 
	...
	public void setHazardStatementsCode(String hazardStatementsCode) {
		this.hazardStatementsCode = hazardStatementsCode;
	}

	public HazardStatement hazardStatementsDescription(LanguageLabels hazardStatementsDescription) {
		this.hazardStatementsDescription = hazardStatementsDescription;
		return this;
	}

	/**
	 * Get hazardStatementsDescription
	 * 
	 * @return hazardStatementsDescription
	 **/
	@ApiModelProperty(value = "")
	public LanguageLabels getHazardStatementsDescription() {
		return hazardStatementsDescription;
	}

	public void setHazardStatementsDescription(LanguageLabels hazardStatementsDescription) {
		this.hazardStatementsDescription = hazardStatementsDescription;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.hazardStatementsCode, hazardStatement.hazardStatementsCode)
				&& Objects.equals(this.hazardStatementsDescription, hazardStatement.hazardStatementsDescription);
	}

	@Override
	public int hashCode() {
		return Objects.hash(hazardStatementsCode, hazardStatementsDescription);
	}
	...
	public String toString() {
		...
		sb.append("    hazardStatementsCode: ").append(toIndentedString(hazardStatementsCode)).append("\n");
		sb.append("    hazardStatementsDescription: ").append(toIndentedString(hazardStatementsDescription))
				.append("\n");
		sb.append("}");
		return sb.toString();
	}
