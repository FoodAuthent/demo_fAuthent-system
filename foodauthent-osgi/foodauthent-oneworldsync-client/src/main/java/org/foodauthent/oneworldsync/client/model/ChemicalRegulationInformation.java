...
import org.foodauthent.oneworldsync.client.model.ChemicalRegulation;
...
public class ChemicalRegulationInformation {
	@JsonProperty("chemicalRegulation")
	private List<ChemicalRegulation> chemicalRegulation = null;

	@JsonProperty("chemicalRegulationAgency")
	private String chemicalRegulationAgency = null;

	public ChemicalRegulationInformation chemicalRegulation(List<ChemicalRegulation> chemicalRegulation) {
		this.chemicalRegulation = chemicalRegulation;
		return this;
	}

	public ChemicalRegulationInformation addChemicalRegulationItem(ChemicalRegulation chemicalRegulationItem) {
		if (this.chemicalRegulation == null) {
			this.chemicalRegulation = new ArrayList<ChemicalRegulation>();
		}
		this.chemicalRegulation.add(chemicalRegulationItem);
		return this;
	}

	/**
	 * Get chemicalRegulation
	 * 
	 * @return chemicalRegulation
	 **/
	@ApiModelProperty(value = "")
	public List<ChemicalRegulation> getChemicalRegulation() {
		return chemicalRegulation;
	}

	public void setChemicalRegulation(List<ChemicalRegulation> chemicalRegulation) {
		this.chemicalRegulation = chemicalRegulation;
	}

	public ChemicalRegulationInformation chemicalRegulationAgency(String chemicalRegulationAgency) {
		this.chemicalRegulationAgency = chemicalRegulationAgency;
		return this;
	}

	/**
	 * Get chemicalRegulationAgency
	 * 
	...
	public void setChemicalRegulationAgency(String chemicalRegulationAgency) {
		this.chemicalRegulationAgency = chemicalRegulationAgency;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		ChemicalRegulationInformation chemicalRegulationInformation = (ChemicalRegulationInformation) o;
		return Objects.equals(this.chemicalRegulation, chemicalRegulationInformation.chemicalRegulation) && Objects
				.equals(this.chemicalRegulationAgency, chemicalRegulationInformation.chemicalRegulationAgency);
	}

	@Override
	public int hashCode() {
		return Objects.hash(chemicalRegulation, chemicalRegulationAgency);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class ChemicalRegulationInformation {\n");

		sb.append("    chemicalRegulation: ").append(toIndentedString(chemicalRegulation)).append("\n");
		sb.append("    chemicalRegulationAgency: ").append(toIndentedString(chemicalRegulationAgency)).append("\n");
		sb.append("}");
		return sb.toString();
	}
