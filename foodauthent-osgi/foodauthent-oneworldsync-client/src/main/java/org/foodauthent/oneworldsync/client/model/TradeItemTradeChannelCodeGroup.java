...
/**
 * TradeItemTradeChannelCodeGroup
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-07-25T20:10:55.785Z")
public class TradeItemTradeChannelCodeGroup {
	@JsonProperty("recipient")
	private Recipient recipient = null;

	@JsonProperty("tradeItemTradeChannelCode")
	private CodifiedValues tradeItemTradeChannelCode = null;

	public TradeItemTradeChannelCodeGroup recipient(Recipient recipient) {
	...
	public TradeItemTradeChannelCodeGroup tradeItemTradeChannelCode(CodifiedValues tradeItemTradeChannelCode) {
		this.tradeItemTradeChannelCode = tradeItemTradeChannelCode;
		return this;
	}

	/**
	 * Get tradeItemTradeChannelCode
	 * 
	 * @return tradeItemTradeChannelCode
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValues getTradeItemTradeChannelCode() {
		return tradeItemTradeChannelCode;
	}

	public void setTradeItemTradeChannelCode(CodifiedValues tradeItemTradeChannelCode) {
		this.tradeItemTradeChannelCode = tradeItemTradeChannelCode;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		TradeItemTradeChannelCodeGroup tradeItemTradeChannelCodeGroup = (TradeItemTradeChannelCodeGroup) o;
		return Objects.equals(this.recipient, tradeItemTradeChannelCodeGroup.recipient) && Objects
				.equals(this.tradeItemTradeChannelCode, tradeItemTradeChannelCodeGroup.tradeItemTradeChannelCode);
	}

	@Override
	public int hashCode() {
		return Objects.hash(recipient, tradeItemTradeChannelCode);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class TradeItemTradeChannelCodeGroup {\n");

		sb.append("    recipient: ").append(toIndentedString(recipient)).append("\n");
		sb.append("    tradeItemTradeChannelCode: ").append(toIndentedString(tradeItemTradeChannelCode)).append("\n");
		sb.append("}");
		return sb.toString();
	}
