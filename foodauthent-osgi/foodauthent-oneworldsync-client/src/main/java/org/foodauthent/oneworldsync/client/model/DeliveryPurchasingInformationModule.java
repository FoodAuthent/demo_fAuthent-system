...
import org.foodauthent.oneworldsync.client.model.DeliveryPurchasingInformation;
...
public class DeliveryPurchasingInformationModule {
	...
	private DeliveryPurchasingInformation deliveryPurchasingInformation = null;

	public DeliveryPurchasingInformationModule deliveryPurchasingInformation(
			DeliveryPurchasingInformation deliveryPurchasingInformation) {
		this.deliveryPurchasingInformation = deliveryPurchasingInformation;
		return this;
	}

	/**
	 * Get deliveryPurchasingInformation
	 * 
	 * @return deliveryPurchasingInformation
	 **/
	@ApiModelProperty(value = "")
	public DeliveryPurchasingInformation getDeliveryPurchasingInformation() {
		return deliveryPurchasingInformation;
	}

	public void setDeliveryPurchasingInformation(DeliveryPurchasingInformation deliveryPurchasingInformation) {
		this.deliveryPurchasingInformation = deliveryPurchasingInformation;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		DeliveryPurchasingInformationModule deliveryPurchasingInformationModule = (DeliveryPurchasingInformationModule) o;
		return Objects.equals(this.deliveryPurchasingInformation,
				deliveryPurchasingInformationModule.deliveryPurchasingInformation);
	}

	@Override
	public int hashCode() {
		return Objects.hash(deliveryPurchasingInformation);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class DeliveryPurchasingInformationModule {\n");

		sb.append("    deliveryPurchasingInformation: ").append(toIndentedString(deliveryPurchasingInformation))
				.append("\n");
		sb.append("}");
		return sb.toString();
	}
