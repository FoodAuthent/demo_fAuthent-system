...
public class ManufacturerTakeBackProgram {
	@JsonProperty("doesManufacturerHaveTakeBackProgram")
	private CodifiedValue doesManufacturerHaveTakeBackProgram = null;

	@JsonProperty("manufacturerTakeBackProgramFee")
	private QualifiedValues manufacturerTakeBackProgramFee = null;

	public ManufacturerTakeBackProgram doesManufacturerHaveTakeBackProgram(
			CodifiedValue doesManufacturerHaveTakeBackProgram) {
		this.doesManufacturerHaveTakeBackProgram = doesManufacturerHaveTakeBackProgram;
		return this;
	}

	/**
	 * Get doesManufacturerHaveTakeBackProgram
	 * 
	 * @return doesManufacturerHaveTakeBackProgram
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getDoesManufacturerHaveTakeBackProgram() {
		return doesManufacturerHaveTakeBackProgram;
	}

	public void setDoesManufacturerHaveTakeBackProgram(CodifiedValue doesManufacturerHaveTakeBackProgram) {
		this.doesManufacturerHaveTakeBackProgram = doesManufacturerHaveTakeBackProgram;
	}

	public ManufacturerTakeBackProgram manufacturerTakeBackProgramFee(QualifiedValues manufacturerTakeBackProgramFee) {
		this.manufacturerTakeBackProgramFee = manufacturerTakeBackProgramFee;
		return this;
	}

	/**
	 * Get manufacturerTakeBackProgramFee
	 * 
	 * @return manufacturerTakeBackProgramFee
	 **/
	@ApiModelProperty(value = "")
	public QualifiedValues getManufacturerTakeBackProgramFee() {
		return manufacturerTakeBackProgramFee;
	}

	public void setManufacturerTakeBackProgramFee(QualifiedValues manufacturerTakeBackProgramFee) {
		this.manufacturerTakeBackProgramFee = manufacturerTakeBackProgramFee;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		ManufacturerTakeBackProgram manufacturerTakeBackProgram = (ManufacturerTakeBackProgram) o;
		return Objects.equals(this.doesManufacturerHaveTakeBackProgram,
				manufacturerTakeBackProgram.doesManufacturerHaveTakeBackProgram)
				&& Objects.equals(this.manufacturerTakeBackProgramFee,
						manufacturerTakeBackProgram.manufacturerTakeBackProgramFee);
	}

	@Override
	public int hashCode() {
		return Objects.hash(doesManufacturerHaveTakeBackProgram, manufacturerTakeBackProgramFee);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class ManufacturerTakeBackProgram {\n");

		sb.append("    doesManufacturerHaveTakeBackProgram: ")
				.append(toIndentedString(doesManufacturerHaveTakeBackProgram)).append("\n");
		sb.append("    manufacturerTakeBackProgramFee: ").append(toIndentedString(manufacturerTakeBackProgramFee))
				.append("\n");
		sb.append("}");
		return sb.toString();
	}
