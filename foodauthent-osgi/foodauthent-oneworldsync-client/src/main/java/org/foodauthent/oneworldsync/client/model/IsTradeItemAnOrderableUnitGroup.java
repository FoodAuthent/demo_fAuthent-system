...
/**
 * IsTradeItemAnOrderableUnitGroup
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-07-25T20:10:55.785Z")
public class IsTradeItemAnOrderableUnitGroup {
	@JsonProperty("isTradeItemAnOrderableUnit")
	private String isTradeItemAnOrderableUnit = null;

	@JsonProperty("recipient")
	private Recipient recipient = null;

	public IsTradeItemAnOrderableUnitGroup isTradeItemAnOrderableUnit(String isTradeItemAnOrderableUnit) {
		this.isTradeItemAnOrderableUnit = isTradeItemAnOrderableUnit;
		return this;
	}

	/**
	 * Get isTradeItemAnOrderableUnit
	 * 
	 * @return isTradeItemAnOrderableUnit
	 **/
	@ApiModelProperty(value = "")
	public String getIsTradeItemAnOrderableUnit() {
		return isTradeItemAnOrderableUnit;
	}

	public void setIsTradeItemAnOrderableUnit(String isTradeItemAnOrderableUnit) {
		this.isTradeItemAnOrderableUnit = isTradeItemAnOrderableUnit;
	}

	public IsTradeItemAnOrderableUnitGroup recipient(Recipient recipient) {
	...
	public boolean equals(java.lang.Object o) {
		...
		IsTradeItemAnOrderableUnitGroup isTradeItemAnOrderableUnitGroup = (IsTradeItemAnOrderableUnitGroup) o;
		return Objects.equals(this.isTradeItemAnOrderableUnit,
				isTradeItemAnOrderableUnitGroup.isTradeItemAnOrderableUnit)
				&& Objects.equals(this.recipient, isTradeItemAnOrderableUnitGroup.recipient);
	}

	@Override
	public int hashCode() {
		return Objects.hash(isTradeItemAnOrderableUnit, recipient);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class IsTradeItemAnOrderableUnitGroup {\n");

		sb.append("    isTradeItemAnOrderableUnit: ").append(toIndentedString(isTradeItemAnOrderableUnit)).append("\n");
