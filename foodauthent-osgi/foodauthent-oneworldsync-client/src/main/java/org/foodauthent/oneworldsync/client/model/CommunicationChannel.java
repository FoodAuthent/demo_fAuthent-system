...
public class CommunicationChannel {
	...
	private CodifiedValue communicationChannelCode = null;

	@JsonProperty("communicationChannelName")
	private String communicationChannelName = null;

	@JsonProperty("communicationValue")
	private String communicationValue = null;

	public CommunicationChannel communicationChannelCode(CodifiedValue communicationChannelCode) {
		this.communicationChannelCode = communicationChannelCode;
		return this;
	}

	/**
	 * Get communicationChannelCode
	 * 
	 * @return communicationChannelCode
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getCommunicationChannelCode() {
		return communicationChannelCode;
	}

	public void setCommunicationChannelCode(CodifiedValue communicationChannelCode) {
		this.communicationChannelCode = communicationChannelCode;
	}

	public CommunicationChannel communicationChannelName(String communicationChannelName) {
	...
	public CommunicationChannel communicationValue(String communicationValue) {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.communicationChannelCode, communicationChannel.communicationChannelCode)
				&& Objects.equals(this.communicationChannelName, communicationChannel.communicationChannelName)
				&& Objects.equals(this.communicationValue, communicationChannel.communicationValue);
	}

	@Override
	public int hashCode() {
		return Objects.hash(communicationChannelCode, communicationChannelName, communicationValue);
	}
	...
	public String toString() {
		...
		sb.append("    communicationChannelCode: ").append(toIndentedString(communicationChannelCode)).append("\n");
		sb.append("    communicationChannelName: ").append(toIndentedString(communicationChannelName)).append("\n");
		sb.append("    communicationValue: ").append(toIndentedString(communicationValue)).append("\n");
		sb.append("}");
		return sb.toString();
	}
