...
public class DataStorageDeviceInformation {
	@JsonProperty("externalMemoryTypeCode")
	private CodifiedValues externalMemoryTypeCode = null;

	@JsonProperty("internalMemoryTypeCode")
	private CodifiedValue internalMemoryTypeCode = null;

	@JsonProperty("maximumAvailableStorageCapacity")
	private QualifiedValues maximumAvailableStorageCapacity = null;

	public DataStorageDeviceInformation externalMemoryTypeCode(CodifiedValues externalMemoryTypeCode) {
		this.externalMemoryTypeCode = externalMemoryTypeCode;
		return this;
	}

	/**
	 * Get externalMemoryTypeCode
	 * 
	 * @return externalMemoryTypeCode
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValues getExternalMemoryTypeCode() {
		return externalMemoryTypeCode;
	}

	public void setExternalMemoryTypeCode(CodifiedValues externalMemoryTypeCode) {
		this.externalMemoryTypeCode = externalMemoryTypeCode;
	}

	public DataStorageDeviceInformation internalMemoryTypeCode(CodifiedValue internalMemoryTypeCode) {
		this.internalMemoryTypeCode = internalMemoryTypeCode;
		return this;
	}

	/**
	 * Get internalMemoryTypeCode
	 * 
	 * @return internalMemoryTypeCode
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getInternalMemoryTypeCode() {
		return internalMemoryTypeCode;
	}

	public void setInternalMemoryTypeCode(CodifiedValue internalMemoryTypeCode) {
		this.internalMemoryTypeCode = internalMemoryTypeCode;
	}

	public DataStorageDeviceInformation maximumAvailableStorageCapacity(
			QualifiedValues maximumAvailableStorageCapacity) {
		this.maximumAvailableStorageCapacity = maximumAvailableStorageCapacity;
		return this;
	}

	/**
	 * Get maximumAvailableStorageCapacity
	 * 
	 * @return maximumAvailableStorageCapacity
	 **/
	@ApiModelProperty(value = "")
	public QualifiedValues getMaximumAvailableStorageCapacity() {
		return maximumAvailableStorageCapacity;
	}

	public void setMaximumAvailableStorageCapacity(QualifiedValues maximumAvailableStorageCapacity) {
		this.maximumAvailableStorageCapacity = maximumAvailableStorageCapacity;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		DataStorageDeviceInformation dataStorageDeviceInformation = (DataStorageDeviceInformation) o;
		return Objects.equals(this.externalMemoryTypeCode, dataStorageDeviceInformation.externalMemoryTypeCode)
				&& Objects.equals(this.internalMemoryTypeCode, dataStorageDeviceInformation.internalMemoryTypeCode)
				&& Objects.equals(this.maximumAvailableStorageCapacity,
						dataStorageDeviceInformation.maximumAvailableStorageCapacity);
	}

	@Override
	public int hashCode() {
		return Objects.hash(externalMemoryTypeCode, internalMemoryTypeCode, maximumAvailableStorageCapacity);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class DataStorageDeviceInformation {\n");

		sb.append("    externalMemoryTypeCode: ").append(toIndentedString(externalMemoryTypeCode)).append("\n");
		sb.append("    internalMemoryTypeCode: ").append(toIndentedString(internalMemoryTypeCode)).append("\n");
		sb.append("    maximumAvailableStorageCapacity: ").append(toIndentedString(maximumAvailableStorageCapacity))
				.append("\n");
		sb.append("}");
		return sb.toString();
	}
