...
public class SecurityTagInformation {
	@JsonProperty("securityTagLocationCode")
	private CodifiedValue securityTagLocationCode = null;

	@JsonProperty("securityTagTypeCode")
	private CodifiedValue securityTagTypeCode = null;

	public SecurityTagInformation securityTagLocationCode(CodifiedValue securityTagLocationCode) {
		this.securityTagLocationCode = securityTagLocationCode;
		return this;
	}

	/**
	 * Get securityTagLocationCode
	 * 
	 * @return securityTagLocationCode
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getSecurityTagLocationCode() {
		return securityTagLocationCode;
	}

	public void setSecurityTagLocationCode(CodifiedValue securityTagLocationCode) {
		this.securityTagLocationCode = securityTagLocationCode;
	}

	public SecurityTagInformation securityTagTypeCode(CodifiedValue securityTagTypeCode) {
		this.securityTagTypeCode = securityTagTypeCode;
		return this;
	}

	/**
	 * Get securityTagTypeCode
	 * 
	 * @return securityTagTypeCode
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getSecurityTagTypeCode() {
		return securityTagTypeCode;
	}

	public void setSecurityTagTypeCode(CodifiedValue securityTagTypeCode) {
		this.securityTagTypeCode = securityTagTypeCode;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		SecurityTagInformation securityTagInformation = (SecurityTagInformation) o;
		return Objects.equals(this.securityTagLocationCode, securityTagInformation.securityTagLocationCode)
				&& Objects.equals(this.securityTagTypeCode, securityTagInformation.securityTagTypeCode);
	}

	@Override
	public int hashCode() {
		return Objects.hash(securityTagLocationCode, securityTagTypeCode);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class SecurityTagInformation {\n");

		sb.append("    securityTagLocationCode: ").append(toIndentedString(securityTagLocationCode)).append("\n");
		sb.append("    securityTagTypeCode: ").append(toIndentedString(securityTagTypeCode)).append("\n");
		sb.append("}");
		return sb.toString();
	}
