...
public class PrecautionaryStatement {
	@JsonProperty("precautionaryStatementsCode")
	private String precautionaryStatementsCode = null;

	@JsonProperty("precautionaryStatementsDescription")
	private LanguageLabels precautionaryStatementsDescription = null;

	public PrecautionaryStatement precautionaryStatementsCode(String precautionaryStatementsCode) {
		this.precautionaryStatementsCode = precautionaryStatementsCode;
		return this;
	}

	/**
	 * Get precautionaryStatementsCode
	 * 
	...
	public void setPrecautionaryStatementsCode(String precautionaryStatementsCode) {
		this.precautionaryStatementsCode = precautionaryStatementsCode;
	}

	public PrecautionaryStatement precautionaryStatementsDescription(
			LanguageLabels precautionaryStatementsDescription) {
		this.precautionaryStatementsDescription = precautionaryStatementsDescription;
		return this;
	}

	/**
	 * Get precautionaryStatementsDescription
	 * 
	 * @return precautionaryStatementsDescription
	 **/
	@ApiModelProperty(value = "")
	public LanguageLabels getPrecautionaryStatementsDescription() {
		return precautionaryStatementsDescription;
	}

	public void setPrecautionaryStatementsDescription(LanguageLabels precautionaryStatementsDescription) {
		this.precautionaryStatementsDescription = precautionaryStatementsDescription;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		PrecautionaryStatement precautionaryStatement = (PrecautionaryStatement) o;
		return Objects.equals(this.precautionaryStatementsCode, precautionaryStatement.precautionaryStatementsCode)
				&& Objects.equals(this.precautionaryStatementsDescription,
						precautionaryStatement.precautionaryStatementsDescription);
	}

	@Override
	public int hashCode() {
		return Objects.hash(precautionaryStatementsCode, precautionaryStatementsDescription);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class PrecautionaryStatement {\n");

		sb.append("    precautionaryStatementsCode: ").append(toIndentedString(precautionaryStatementsCode))
				.append("\n");
		sb.append("    precautionaryStatementsDescription: ")
				.append(toIndentedString(precautionaryStatementsDescription)).append("\n");
		sb.append("}");
		return sb.toString();
	}
