...
import org.foodauthent.oneworldsync.client.model.ValueQualifier;

/**
 * CodifiedQualifiedValues
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-07-25T20:10:55.785Z")
public class CodifiedQualifiedValues {
	@JsonProperty("values")
	private List<ValueQualifier> values = null;

	@JsonProperty("valueDefinition")
	private String valueDefinition = null;

	@JsonProperty("qualDefinition")
	private String qualDefinition = null;

	public CodifiedQualifiedValues values(List<ValueQualifier> values) {
		this.values = values;
		return this;
	}

	public CodifiedQualifiedValues addValuesItem(ValueQualifier valuesItem) {
		if (this.values == null) {
			this.values = new ArrayList<ValueQualifier>();
		}
	...
	public List<ValueQualifier> getValues() {
		return values;
	}

	public void setValues(List<ValueQualifier> values) {
		this.values = values;
	}

	public CodifiedQualifiedValues valueDefinition(String valueDefinition) {
	...
	public CodifiedQualifiedValues qualDefinition(String qualDefinition) {
		this.qualDefinition = qualDefinition;
		return this;
	}
	 ...
	 * Get qualDefinition
	 * 
	 * @return qualDefinition
	 **/
	@ApiModelProperty(value = "")
	public String getQualDefinition() {
		return qualDefinition;
	}

	public void setQualDefinition(String qualDefinition) {
		this.qualDefinition = qualDefinition;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		CodifiedQualifiedValues codifiedQualifiedValues = (CodifiedQualifiedValues) o;
		return Objects.equals(this.values, codifiedQualifiedValues.values)
				&& Objects.equals(this.valueDefinition, codifiedQualifiedValues.valueDefinition)
				&& Objects.equals(this.qualDefinition, codifiedQualifiedValues.qualDefinition);
	}

	@Override
	public int hashCode() {
		return Objects.hash(values, valueDefinition, qualDefinition);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class CodifiedQualifiedValues {\n");

		sb.append("    values: ").append(toIndentedString(values)).append("\n");
		sb.append("    valueDefinition: ").append(toIndentedString(valueDefinition)).append("\n");
		sb.append("    qualDefinition: ").append(toIndentedString(qualDefinition)).append("\n");
		sb.append("}");
		return sb.toString();
	}
