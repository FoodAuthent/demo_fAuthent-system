...
public class ControlledSubstance {
	@JsonProperty("controlledSubstanceAmount")
	private QualifiedValue controlledSubstanceAmount = null;

	@JsonProperty("controlledSubstanceCode")
	private String controlledSubstanceCode = null;

	@JsonProperty("controlledSubstanceName")
	private String controlledSubstanceName = null;

	public ControlledSubstance controlledSubstanceAmount(QualifiedValue controlledSubstanceAmount) {
		this.controlledSubstanceAmount = controlledSubstanceAmount;
		return this;
	}

	/**
	 * Get controlledSubstanceAmount
	 * 
	 * @return controlledSubstanceAmount
	 **/
	@ApiModelProperty(value = "")
	public QualifiedValue getControlledSubstanceAmount() {
		return controlledSubstanceAmount;
	}

	public void setControlledSubstanceAmount(QualifiedValue controlledSubstanceAmount) {
		this.controlledSubstanceAmount = controlledSubstanceAmount;
	}

	public ControlledSubstance controlledSubstanceCode(String controlledSubstanceCode) {
		this.controlledSubstanceCode = controlledSubstanceCode;
		return this;
	}

	/**
	 * Get controlledSubstanceCode
	 * 
	...
	public ControlledSubstance controlledSubstanceName(String controlledSubstanceName) {
		this.controlledSubstanceName = controlledSubstanceName;
		return this;
	}

	/**
	 * Get controlledSubstanceName
	 * 
	...
	public void setControlledSubstanceName(String controlledSubstanceName) {
		this.controlledSubstanceName = controlledSubstanceName;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		ControlledSubstance controlledSubstance = (ControlledSubstance) o;
		return Objects.equals(this.controlledSubstanceAmount, controlledSubstance.controlledSubstanceAmount)
				&& Objects.equals(this.controlledSubstanceCode, controlledSubstance.controlledSubstanceCode)
				&& Objects.equals(this.controlledSubstanceName, controlledSubstance.controlledSubstanceName);
	}

	@Override
	public int hashCode() {
		return Objects.hash(controlledSubstanceAmount, controlledSubstanceCode, controlledSubstanceName);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class ControlledSubstance {\n");

		sb.append("    controlledSubstanceAmount: ").append(toIndentedString(controlledSubstanceAmount)).append("\n");
		sb.append("    controlledSubstanceCode: ").append(toIndentedString(controlledSubstanceCode)).append("\n");
		sb.append("    controlledSubstanceName: ").append(toIndentedString(controlledSubstanceName)).append("\n");
		sb.append("}");
		return sb.toString();
	}
