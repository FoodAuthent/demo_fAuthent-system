...
public class TradeItemGroupIdentificationCodeReference {
	...
	@JsonProperty("tradeItemGroupIdentificationCodeReferenceValue")
	private String tradeItemGroupIdentificationCodeReferenceValue = null;

	public TradeItemGroupIdentificationCodeReference codeDescription(String codeDescription) {
	...
	public TradeItemGroupIdentificationCodeReference codeListAgencyCode(String codeListAgencyCode) {
	...
	public TradeItemGroupIdentificationCodeReference codeListAgencyCodeListVersion(
	...
	public TradeItemGroupIdentificationCodeReference codeListAgencyName(String codeListAgencyName) {
	...
	public TradeItemGroupIdentificationCodeReference codeListName(String codeListName) {
	...
	public TradeItemGroupIdentificationCodeReference codeListURI(String codeListURI) {
	...
	public TradeItemGroupIdentificationCodeReference codeListVersion(String codeListVersion) {
	...
	public TradeItemGroupIdentificationCodeReference tradeItemGroupIdentificationCodeReferenceValue(
			String tradeItemGroupIdentificationCodeReferenceValue) {
		this.tradeItemGroupIdentificationCodeReferenceValue = tradeItemGroupIdentificationCodeReferenceValue;
		return this;
	}

	/**
	 * Get tradeItemGroupIdentificationCodeReferenceValue
	 * 
	 * @return tradeItemGroupIdentificationCodeReferenceValue
	 **/
	@ApiModelProperty(value = "")
	public String getTradeItemGroupIdentificationCodeReferenceValue() {
		return tradeItemGroupIdentificationCodeReferenceValue;
	}

	public void setTradeItemGroupIdentificationCodeReferenceValue(
			String tradeItemGroupIdentificationCodeReferenceValue) {
		this.tradeItemGroupIdentificationCodeReferenceValue = tradeItemGroupIdentificationCodeReferenceValue;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		TradeItemGroupIdentificationCodeReference tradeItemGroupIdentificationCodeReference = (TradeItemGroupIdentificationCodeReference) o;
		return Objects.equals(this.codeDescription, tradeItemGroupIdentificationCodeReference.codeDescription)
				&& Objects.equals(this.codeListAgencyCode, tradeItemGroupIdentificationCodeReference.codeListAgencyCode)
				&& Objects.equals(this.codeListAgencyCodeListVersion,
						tradeItemGroupIdentificationCodeReference.codeListAgencyCodeListVersion)
				&& Objects.equals(this.codeListAgencyName, tradeItemGroupIdentificationCodeReference.codeListAgencyName)
				&& Objects.equals(this.codeListName, tradeItemGroupIdentificationCodeReference.codeListName)
				&& Objects.equals(this.codeListURI, tradeItemGroupIdentificationCodeReference.codeListURI)
				&& Objects.equals(this.codeListVersion, tradeItemGroupIdentificationCodeReference.codeListVersion)
				&& Objects.equals(this.tradeItemGroupIdentificationCodeReferenceValue,
						tradeItemGroupIdentificationCodeReference.tradeItemGroupIdentificationCodeReferenceValue);
	}

	@Override
	public int hashCode() {
		return Objects.hash(codeDescription, codeListAgencyCode, codeListAgencyCodeListVersion, codeListAgencyName,
				codeListName, codeListURI, codeListVersion, tradeItemGroupIdentificationCodeReferenceValue);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class TradeItemGroupIdentificationCodeReference {\n");
		...
		sb.append("    tradeItemGroupIdentificationCodeReferenceValue: ")
				.append(toIndentedString(tradeItemGroupIdentificationCodeReferenceValue)).append("\n");
		sb.append("}");
		return sb.toString();
	}
