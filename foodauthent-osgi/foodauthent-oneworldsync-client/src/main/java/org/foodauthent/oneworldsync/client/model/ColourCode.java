...
public class ColourCode {
	...
	@JsonProperty("colourCodeListCode")
	private CodifiedValue colourCodeListCode = null;

	@JsonProperty("colourCodeListVersion")
	private String colourCodeListVersion = null;

	@JsonProperty("colourCodeValue")
	private String colourCodeValue = null;

	public ColourCode codeListVersion(String codeListVersion) {
	...
	public ColourCode colourCodeListCode(CodifiedValue colourCodeListCode) {
		this.colourCodeListCode = colourCodeListCode;
		return this;
	}

	/**
	 * Get colourCodeListCode
	 * 
	 * @return colourCodeListCode
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getColourCodeListCode() {
		return colourCodeListCode;
	}

	public void setColourCodeListCode(CodifiedValue colourCodeListCode) {
		this.colourCodeListCode = colourCodeListCode;
	}

	public ColourCode colourCodeListVersion(String colourCodeListVersion) {
		this.colourCodeListVersion = colourCodeListVersion;
		return this;
	}

	/**
	 * Get colourCodeListVersion
	 * 
	...
	public void setColourCodeListVersion(String colourCodeListVersion) {
		this.colourCodeListVersion = colourCodeListVersion;
	}

	public ColourCode colourCodeValue(String colourCodeValue) {
	...
	public boolean equals(java.lang.Object o) {
		...
		ColourCode colourCode = (ColourCode) o;
		return Objects.equals(this.codeListVersion, colourCode.codeListVersion)
				&& Objects.equals(this.colourCodeListCode, colourCode.colourCodeListCode)
				&& Objects.equals(this.colourCodeListVersion, colourCode.colourCodeListVersion)
				&& Objects.equals(this.colourCodeValue, colourCode.colourCodeValue);
	}

	@Override
	public int hashCode() {
		return Objects.hash(codeListVersion, colourCodeListCode, colourCodeListVersion, colourCodeValue);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class ColourCode {\n");

		sb.append("    codeListVersion: ").append(toIndentedString(codeListVersion)).append("\n");
		sb.append("    colourCodeListCode: ").append(toIndentedString(colourCodeListCode)).append("\n");
		sb.append("    colourCodeListVersion: ").append(toIndentedString(colourCodeListVersion)).append("\n");
		sb.append("    colourCodeValue: ").append(toIndentedString(colourCodeValue)).append("\n");
		sb.append("}");
		return sb.toString();
	}
