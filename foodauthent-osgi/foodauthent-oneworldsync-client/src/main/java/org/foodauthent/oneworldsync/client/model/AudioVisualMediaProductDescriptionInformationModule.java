...
import org.foodauthent.oneworldsync.client.model.AudioVisualMediaProductDescription;

/**
 * AudioVisualMediaProductDescriptionInformationModule
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-07-25T20:10:55.785Z")
public class AudioVisualMediaProductDescriptionInformationModule {
	@JsonProperty("audioVisualMediaProductDescription")
	private AudioVisualMediaProductDescription audioVisualMediaProductDescription = null;

	public AudioVisualMediaProductDescriptionInformationModule audioVisualMediaProductDescription(
			AudioVisualMediaProductDescription audioVisualMediaProductDescription) {
		this.audioVisualMediaProductDescription = audioVisualMediaProductDescription;
		return this;
	}

	/**
	 * Get audioVisualMediaProductDescription
	 * 
	 * @return audioVisualMediaProductDescription
	 **/
	@ApiModelProperty(value = "")
	public AudioVisualMediaProductDescription getAudioVisualMediaProductDescription() {
		return audioVisualMediaProductDescription;
	}

	public void setAudioVisualMediaProductDescription(
			AudioVisualMediaProductDescription audioVisualMediaProductDescription) {
		this.audioVisualMediaProductDescription = audioVisualMediaProductDescription;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		AudioVisualMediaProductDescriptionInformationModule audioVisualMediaProductDescriptionInformationModule = (AudioVisualMediaProductDescriptionInformationModule) o;
		return Objects.equals(this.audioVisualMediaProductDescription,
				audioVisualMediaProductDescriptionInformationModule.audioVisualMediaProductDescription);
	}

	@Override
	public int hashCode() {
		return Objects.hash(audioVisualMediaProductDescription);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class AudioVisualMediaProductDescriptionInformationModule {\n");

		sb.append("    audioVisualMediaProductDescription: ")
				.append(toIndentedString(audioVisualMediaProductDescription)).append("\n");
		sb.append("}");
		return sb.toString();
	}
