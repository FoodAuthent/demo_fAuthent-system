...
import org.foodauthent.oneworldsync.client.model.SustainabilityInformation;

/**
 * SustainabilityModule
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-07-25T20:10:55.785Z")
public class SustainabilityModule {
	@JsonProperty("sustainabilityInformation")
	private SustainabilityInformation sustainabilityInformation = null;

	public SustainabilityModule sustainabilityInformation(SustainabilityInformation sustainabilityInformation) {
		this.sustainabilityInformation = sustainabilityInformation;
		return this;
	}

	/**
	 * Get sustainabilityInformation
	 * 
	 * @return sustainabilityInformation
	 **/
	@ApiModelProperty(value = "")
	public SustainabilityInformation getSustainabilityInformation() {
		return sustainabilityInformation;
	}

	public void setSustainabilityInformation(SustainabilityInformation sustainabilityInformation) {
		this.sustainabilityInformation = sustainabilityInformation;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		SustainabilityModule sustainabilityModule = (SustainabilityModule) o;
		return Objects.equals(this.sustainabilityInformation, sustainabilityModule.sustainabilityInformation);
	}

	@Override
	public int hashCode() {
		return Objects.hash(sustainabilityInformation);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class SustainabilityModule {\n");

		sb.append("    sustainabilityInformation: ").append(toIndentedString(sustainabilityInformation)).append("\n");
		sb.append("}");
		return sb.toString();
	}
