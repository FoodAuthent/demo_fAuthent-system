...
import org.foodauthent.oneworldsync.client.model.TradeItemLifespan;
...
public class TradeItemLifespanModule {
	...
	private TradeItemLifespan tradeItemLifespan = null;

	public TradeItemLifespanModule tradeItemLifespan(TradeItemLifespan tradeItemLifespan) {
		this.tradeItemLifespan = tradeItemLifespan;
		return this;
	}

	/**
	 * Get tradeItemLifespan
	 * 
	 * @return tradeItemLifespan
	 **/
	@ApiModelProperty(value = "")
	public TradeItemLifespan getTradeItemLifespan() {
		return tradeItemLifespan;
	}

	public void setTradeItemLifespan(TradeItemLifespan tradeItemLifespan) {
		this.tradeItemLifespan = tradeItemLifespan;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		TradeItemLifespanModule tradeItemLifespanModule = (TradeItemLifespanModule) o;
		return Objects.equals(this.tradeItemLifespan, tradeItemLifespanModule.tradeItemLifespan);
	}

	@Override
	public int hashCode() {
		return Objects.hash(tradeItemLifespan);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class TradeItemLifespanModule {\n");

		sb.append("    tradeItemLifespan: ").append(toIndentedString(tradeItemLifespan)).append("\n");
		sb.append("}");
		return sb.toString();
	}
