...
import org.foodauthent.oneworldsync.client.model.ChildNutritionLabel;

/**
 * ChildNutritionInformationModule
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-07-25T20:10:55.785Z")
public class ChildNutritionInformationModule {
	@JsonProperty("childNutritionLabel")
	private List<ChildNutritionLabel> childNutritionLabel = null;

	public ChildNutritionInformationModule childNutritionLabel(List<ChildNutritionLabel> childNutritionLabel) {
		this.childNutritionLabel = childNutritionLabel;
		return this;
	}

	public ChildNutritionInformationModule addChildNutritionLabelItem(ChildNutritionLabel childNutritionLabelItem) {
		if (this.childNutritionLabel == null) {
			this.childNutritionLabel = new ArrayList<ChildNutritionLabel>();
		}
		this.childNutritionLabel.add(childNutritionLabelItem);
		return this;
	}

	/**
	 * Get childNutritionLabel
	 * 
	 * @return childNutritionLabel
	 **/
	@ApiModelProperty(value = "")
	public List<ChildNutritionLabel> getChildNutritionLabel() {
		return childNutritionLabel;
	}

	public void setChildNutritionLabel(List<ChildNutritionLabel> childNutritionLabel) {
		this.childNutritionLabel = childNutritionLabel;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		ChildNutritionInformationModule childNutritionInformationModule = (ChildNutritionInformationModule) o;
		return Objects.equals(this.childNutritionLabel, childNutritionInformationModule.childNutritionLabel);
	}

	@Override
	public int hashCode() {
		return Objects.hash(childNutritionLabel);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class ChildNutritionInformationModule {\n");

		sb.append("    childNutritionLabel: ").append(toIndentedString(childNutritionLabel)).append("\n");
		sb.append("}");
		return sb.toString();
	}
