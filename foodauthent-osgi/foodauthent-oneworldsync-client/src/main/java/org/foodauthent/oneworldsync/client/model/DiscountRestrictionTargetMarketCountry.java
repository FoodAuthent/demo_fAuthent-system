...
public class DiscountRestrictionTargetMarketCountry {
	@JsonProperty("countryCode")
	private CodifiedValue countryCode = null;

	@JsonProperty("countrySubdivisionCode")
	private Values countrySubdivisionCode = null;

	public DiscountRestrictionTargetMarketCountry countryCode(CodifiedValue countryCode) {
	...
	public CodifiedValue getCountryCode() {
		return countryCode;
	}

	public void setCountryCode(CodifiedValue countryCode) {
		this.countryCode = countryCode;
	}

	public DiscountRestrictionTargetMarketCountry countrySubdivisionCode(Values countrySubdivisionCode) {
	 ...
	 **/
	@ApiModelProperty(value = "")
	public Values getCountrySubdivisionCode() {
		return countrySubdivisionCode;
	}

	public void setCountrySubdivisionCode(Values countrySubdivisionCode) {
		this.countrySubdivisionCode = countrySubdivisionCode;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		DiscountRestrictionTargetMarketCountry discountRestrictionTargetMarketCountry = (DiscountRestrictionTargetMarketCountry) o;
		return Objects.equals(this.countryCode, discountRestrictionTargetMarketCountry.countryCode) && Objects
				.equals(this.countrySubdivisionCode, discountRestrictionTargetMarketCountry.countrySubdivisionCode);
	}

	@Override
	public int hashCode() {
		return Objects.hash(countryCode, countrySubdivisionCode);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class DiscountRestrictionTargetMarketCountry {\n");
