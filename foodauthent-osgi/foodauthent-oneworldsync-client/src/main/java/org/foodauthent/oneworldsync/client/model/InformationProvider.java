...
public class InformationProvider {
	...
	private CodifiedValue informationProviderIdType = null;

	@JsonProperty("informationProviderName")
	private String informationProviderName = null;

	@JsonProperty("isPrimary")
	private String isPrimary = null;

	public InformationProvider informationProviderId(String informationProviderId) {
	...
	public InformationProvider informationProviderIdType(CodifiedValue informationProviderIdType) {
		this.informationProviderIdType = informationProviderIdType;
		return this;
	}

	/**
	 * Get informationProviderIdType
	 * 
	 * @return informationProviderIdType
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getInformationProviderIdType() {
		return informationProviderIdType;
	}

	public void setInformationProviderIdType(CodifiedValue informationProviderIdType) {
		this.informationProviderIdType = informationProviderIdType;
	}

	public InformationProvider informationProviderName(String informationProviderName) {
		this.informationProviderName = informationProviderName;
		return this;
	}

	/**
	 * Get informationProviderName
	 * 
	...
	public InformationProvider isPrimary(String isPrimary) {
	...
	public boolean equals(java.lang.Object o) {
		...
		InformationProvider informationProvider = (InformationProvider) o;
		return Objects.equals(this.informationProviderId, informationProvider.informationProviderId)
				&& Objects.equals(this.informationProviderIdType, informationProvider.informationProviderIdType)
				&& Objects.equals(this.informationProviderName, informationProvider.informationProviderName)
				&& Objects.equals(this.isPrimary, informationProvider.isPrimary);
	}

	@Override
	public int hashCode() {
		return Objects.hash(informationProviderId, informationProviderIdType, informationProviderName, isPrimary);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class InformationProvider {\n");

		sb.append("    informationProviderId: ").append(toIndentedString(informationProviderId)).append("\n");
		sb.append("    informationProviderIdType: ").append(toIndentedString(informationProviderIdType)).append("\n");
		sb.append("    informationProviderName: ").append(toIndentedString(informationProviderName)).append("\n");
