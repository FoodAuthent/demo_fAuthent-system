...
import org.foodauthent.oneworldsync.client.model.MedicalDeviceInformation;
...
public class MedicalDeviceTradeItemModule {
	@JsonProperty("medicalDeviceInformation")
	private MedicalDeviceInformation medicalDeviceInformation = null;

	public MedicalDeviceTradeItemModule medicalDeviceInformation(MedicalDeviceInformation medicalDeviceInformation) {
		this.medicalDeviceInformation = medicalDeviceInformation;
		return this;
	}

	/**
	 * Get medicalDeviceInformation
	 * 
	 * @return medicalDeviceInformation
	 **/
	@ApiModelProperty(value = "")
	public MedicalDeviceInformation getMedicalDeviceInformation() {
		return medicalDeviceInformation;
	}

	public void setMedicalDeviceInformation(MedicalDeviceInformation medicalDeviceInformation) {
		this.medicalDeviceInformation = medicalDeviceInformation;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		MedicalDeviceTradeItemModule medicalDeviceTradeItemModule = (MedicalDeviceTradeItemModule) o;
		return Objects.equals(this.medicalDeviceInformation, medicalDeviceTradeItemModule.medicalDeviceInformation);
	}

	@Override
	public int hashCode() {
		return Objects.hash(medicalDeviceInformation);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class MedicalDeviceTradeItemModule {\n");

		sb.append("    medicalDeviceInformation: ").append(toIndentedString(medicalDeviceInformation)).append("\n");
		sb.append("}");
		return sb.toString();
	}
