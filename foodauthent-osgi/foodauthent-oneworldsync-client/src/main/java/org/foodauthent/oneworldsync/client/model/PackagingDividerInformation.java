...
public class PackagingDividerInformation {
	@JsonProperty("numberOfDividersHorizontal")
	private String numberOfDividersHorizontal = null;

	@JsonProperty("numberOfDividersVertical")
	private String numberOfDividersVertical = null;

	@JsonProperty("placementOfDivider")
	private Values placementOfDivider = null;

	public PackagingDividerInformation numberOfDividersHorizontal(String numberOfDividersHorizontal) {
		this.numberOfDividersHorizontal = numberOfDividersHorizontal;
		return this;
	}

	/**
	 * Get numberOfDividersHorizontal
	 * 
	 * @return numberOfDividersHorizontal
	 **/
	@ApiModelProperty(value = "")
	public String getNumberOfDividersHorizontal() {
		return numberOfDividersHorizontal;
	}

	public void setNumberOfDividersHorizontal(String numberOfDividersHorizontal) {
		this.numberOfDividersHorizontal = numberOfDividersHorizontal;
	}

	public PackagingDividerInformation numberOfDividersVertical(String numberOfDividersVertical) {
		this.numberOfDividersVertical = numberOfDividersVertical;
		return this;
	}

	/**
	 * Get numberOfDividersVertical
	 * 
	 * @return numberOfDividersVertical
	 **/
	@ApiModelProperty(value = "")
	public String getNumberOfDividersVertical() {
		return numberOfDividersVertical;
	}

	public void setNumberOfDividersVertical(String numberOfDividersVertical) {
		this.numberOfDividersVertical = numberOfDividersVertical;
	}

	public PackagingDividerInformation placementOfDivider(Values placementOfDivider) {
		this.placementOfDivider = placementOfDivider;
		return this;
	}

	/**
	 * Get placementOfDivider
	 * 
	 * @return placementOfDivider
	 **/
	@ApiModelProperty(value = "")
	public Values getPlacementOfDivider() {
		return placementOfDivider;
	}

	public void setPlacementOfDivider(Values placementOfDivider) {
		this.placementOfDivider = placementOfDivider;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		PackagingDividerInformation packagingDividerInformation = (PackagingDividerInformation) o;
		return Objects.equals(this.numberOfDividersHorizontal, packagingDividerInformation.numberOfDividersHorizontal)
				&& Objects.equals(this.numberOfDividersVertical, packagingDividerInformation.numberOfDividersVertical)
				&& Objects.equals(this.placementOfDivider, packagingDividerInformation.placementOfDivider);
	}

	@Override
	public int hashCode() {
		return Objects.hash(numberOfDividersHorizontal, numberOfDividersVertical, placementOfDivider);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class PackagingDividerInformation {\n");

		sb.append("    numberOfDividersHorizontal: ").append(toIndentedString(numberOfDividersHorizontal)).append("\n");
		sb.append("    numberOfDividersVertical: ").append(toIndentedString(numberOfDividersVertical)).append("\n");
		sb.append("    placementOfDivider: ").append(toIndentedString(placementOfDivider)).append("\n");
		sb.append("}");
		return sb.toString();
	}
