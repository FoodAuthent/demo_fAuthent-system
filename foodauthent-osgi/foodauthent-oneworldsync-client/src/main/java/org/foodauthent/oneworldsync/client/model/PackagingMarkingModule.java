...
import org.foodauthent.oneworldsync.client.model.PackagingMarking;
...
public class PackagingMarkingModule {
	...
	private List<PackagingMarking> packagingMarking = null;

	public PackagingMarkingModule packagingMarking(List<PackagingMarking> packagingMarking) {
		this.packagingMarking = packagingMarking;
		return this;
	}

	public PackagingMarkingModule addPackagingMarkingItem(PackagingMarking packagingMarkingItem) {
		if (this.packagingMarking == null) {
			this.packagingMarking = new ArrayList<PackagingMarking>();
		}
		this.packagingMarking.add(packagingMarkingItem);
		return this;
	}

	/**
	 * Get packagingMarking
	 * 
	 * @return packagingMarking
	 **/
	@ApiModelProperty(value = "")
	public List<PackagingMarking> getPackagingMarking() {
		return packagingMarking;
	}

	public void setPackagingMarking(List<PackagingMarking> packagingMarking) {
		this.packagingMarking = packagingMarking;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		PackagingMarkingModule packagingMarkingModule = (PackagingMarkingModule) o;
		return Objects.equals(this.packagingMarking, packagingMarkingModule.packagingMarking);
	}

	@Override
	public int hashCode() {
		return Objects.hash(packagingMarking);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class PackagingMarkingModule {\n");

		sb.append("    packagingMarking: ").append(toIndentedString(packagingMarking)).append("\n");
		sb.append("}");
		return sb.toString();
	}
