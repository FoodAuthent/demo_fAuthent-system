...
public class CreditableGrain {
	@JsonProperty("creditableGrainGroupCode")
	private String creditableGrainGroupCode = null;

	@JsonProperty("exhibitGroup")
	private String exhibitGroup = null;

	public CreditableGrain creditableGrainGroupCode(String creditableGrainGroupCode) {
		this.creditableGrainGroupCode = creditableGrainGroupCode;
		return this;
	}

	/**
	 * Get creditableGrainGroupCode
	 * 
	...
	public void setCreditableGrainGroupCode(String creditableGrainGroupCode) {
		this.creditableGrainGroupCode = creditableGrainGroupCode;
	}

	public CreditableGrain exhibitGroup(String exhibitGroup) {
	...
	public void setExhibitGroup(String exhibitGroup) {
		this.exhibitGroup = exhibitGroup;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		CreditableGrain creditableGrain = (CreditableGrain) o;
		return Objects.equals(this.creditableGrainGroupCode, creditableGrain.creditableGrainGroupCode)
				&& Objects.equals(this.exhibitGroup, creditableGrain.exhibitGroup);
	}

	@Override
	public int hashCode() {
		return Objects.hash(creditableGrainGroupCode, exhibitGroup);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class CreditableGrain {\n");

		sb.append("    creditableGrainGroupCode: ").append(toIndentedString(creditableGrainGroupCode)).append("\n");
		sb.append("    exhibitGroup: ").append(toIndentedString(exhibitGroup)).append("\n");
		sb.append("}");
		return sb.toString();
	}
