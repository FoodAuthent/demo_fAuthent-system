...
/**
 * IsTradeItemADespatchUnitGroup
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-07-25T20:10:55.785Z")
public class IsTradeItemADespatchUnitGroup {
	@JsonProperty("isTradeItemADespatchUnit")
	private String isTradeItemADespatchUnit = null;

	@JsonProperty("recipient")
	private Recipient recipient = null;

	public IsTradeItemADespatchUnitGroup isTradeItemADespatchUnit(String isTradeItemADespatchUnit) {
		this.isTradeItemADespatchUnit = isTradeItemADespatchUnit;
		return this;
	}

	/**
	 * Get isTradeItemADespatchUnit
	 * 
	 * @return isTradeItemADespatchUnit
	 **/
	@ApiModelProperty(value = "")
	public String getIsTradeItemADespatchUnit() {
		return isTradeItemADespatchUnit;
	}

	public void setIsTradeItemADespatchUnit(String isTradeItemADespatchUnit) {
		this.isTradeItemADespatchUnit = isTradeItemADespatchUnit;
	}

	public IsTradeItemADespatchUnitGroup recipient(Recipient recipient) {
	...
	public boolean equals(java.lang.Object o) {
		...
		IsTradeItemADespatchUnitGroup isTradeItemADespatchUnitGroup = (IsTradeItemADespatchUnitGroup) o;
		return Objects.equals(this.isTradeItemADespatchUnit, isTradeItemADespatchUnitGroup.isTradeItemADespatchUnit)
				&& Objects.equals(this.recipient, isTradeItemADespatchUnitGroup.recipient);
	}

	@Override
	public int hashCode() {
		return Objects.hash(isTradeItemADespatchUnit, recipient);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class IsTradeItemADespatchUnitGroup {\n");

		sb.append("    isTradeItemADespatchUnit: ").append(toIndentedString(isTradeItemADespatchUnit)).append("\n");
