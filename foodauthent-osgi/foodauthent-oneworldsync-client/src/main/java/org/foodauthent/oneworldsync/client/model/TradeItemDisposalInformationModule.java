...
import org.foodauthent.oneworldsync.client.model.TradeItemDisposalInformation;
...
public class TradeItemDisposalInformationModule {
	@JsonProperty("tradeItemDisposalInformation")
	private TradeItemDisposalInformation tradeItemDisposalInformation = null;

	public TradeItemDisposalInformationModule tradeItemDisposalInformation(
			TradeItemDisposalInformation tradeItemDisposalInformation) {
		this.tradeItemDisposalInformation = tradeItemDisposalInformation;
		return this;
	}

	/**
	 * Get tradeItemDisposalInformation
	 * 
	 * @return tradeItemDisposalInformation
	 **/
	@ApiModelProperty(value = "")
	public TradeItemDisposalInformation getTradeItemDisposalInformation() {
		return tradeItemDisposalInformation;
	}

	public void setTradeItemDisposalInformation(TradeItemDisposalInformation tradeItemDisposalInformation) {
		this.tradeItemDisposalInformation = tradeItemDisposalInformation;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		TradeItemDisposalInformationModule tradeItemDisposalInformationModule = (TradeItemDisposalInformationModule) o;
		return Objects.equals(this.tradeItemDisposalInformation,
				tradeItemDisposalInformationModule.tradeItemDisposalInformation);
	}

	@Override
	public int hashCode() {
		return Objects.hash(tradeItemDisposalInformation);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class TradeItemDisposalInformationModule {\n");

		sb.append("    tradeItemDisposalInformation: ").append(toIndentedString(tradeItemDisposalInformation))
				.append("\n");
		sb.append("}");
		return sb.toString();
	}
