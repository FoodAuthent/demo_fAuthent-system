...
public class ChildNutritionQualifier {
	@JsonProperty("childNutritionQualifiedValue")
	private QualifiedValues childNutritionQualifiedValue = null;

	@JsonProperty("childNutritionQualifierCode")
	private CodifiedValue childNutritionQualifierCode = null;

	@JsonProperty("childNutritionValue")
	private QualifiedValues childNutritionValue = null;

	public ChildNutritionQualifier childNutritionQualifiedValue(QualifiedValues childNutritionQualifiedValue) {
		this.childNutritionQualifiedValue = childNutritionQualifiedValue;
		return this;
	}

	/**
	 * Get childNutritionQualifiedValue
	 * 
	 * @return childNutritionQualifiedValue
	 **/
	@ApiModelProperty(value = "")
	public QualifiedValues getChildNutritionQualifiedValue() {
		return childNutritionQualifiedValue;
	}

	public void setChildNutritionQualifiedValue(QualifiedValues childNutritionQualifiedValue) {
		this.childNutritionQualifiedValue = childNutritionQualifiedValue;
	}

	public ChildNutritionQualifier childNutritionQualifierCode(CodifiedValue childNutritionQualifierCode) {
		this.childNutritionQualifierCode = childNutritionQualifierCode;
		return this;
	}

	/**
	 * Get childNutritionQualifierCode
	 * 
	 * @return childNutritionQualifierCode
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getChildNutritionQualifierCode() {
		return childNutritionQualifierCode;
	}

	public void setChildNutritionQualifierCode(CodifiedValue childNutritionQualifierCode) {
		this.childNutritionQualifierCode = childNutritionQualifierCode;
	}

	public ChildNutritionQualifier childNutritionValue(QualifiedValues childNutritionValue) {
		this.childNutritionValue = childNutritionValue;
		return this;
	}

	/**
	 * Get childNutritionValue
	 * 
	 * @return childNutritionValue
	 **/
	@ApiModelProperty(value = "")
	public QualifiedValues getChildNutritionValue() {
		return childNutritionValue;
	}

	public void setChildNutritionValue(QualifiedValues childNutritionValue) {
		this.childNutritionValue = childNutritionValue;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		ChildNutritionQualifier childNutritionQualifier = (ChildNutritionQualifier) o;
		return Objects.equals(this.childNutritionQualifiedValue, childNutritionQualifier.childNutritionQualifiedValue)
				&& Objects.equals(this.childNutritionQualifierCode, childNutritionQualifier.childNutritionQualifierCode)
				&& Objects.equals(this.childNutritionValue, childNutritionQualifier.childNutritionValue);
	}

	@Override
	public int hashCode() {
		return Objects.hash(childNutritionQualifiedValue, childNutritionQualifierCode, childNutritionValue);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class ChildNutritionQualifier {\n");

		sb.append("    childNutritionQualifiedValue: ").append(toIndentedString(childNutritionQualifiedValue))
				.append("\n");
		sb.append("    childNutritionQualifierCode: ").append(toIndentedString(childNutritionQualifierCode))
				.append("\n");
		sb.append("    childNutritionValue: ").append(toIndentedString(childNutritionValue)).append("\n");
		sb.append("}");
		return sb.toString();
	}
