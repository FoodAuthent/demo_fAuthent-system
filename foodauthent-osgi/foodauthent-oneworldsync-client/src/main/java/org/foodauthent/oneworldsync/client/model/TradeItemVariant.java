...
public class TradeItemVariant {
	@JsonProperty("tradeItemVariantTypeCode")
	private CodifiedValue tradeItemVariantTypeCode = null;

	@JsonProperty("tradeItemVariantValue")
	private LanguageLabels tradeItemVariantValue = null;

	public TradeItemVariant tradeItemVariantTypeCode(CodifiedValue tradeItemVariantTypeCode) {
		this.tradeItemVariantTypeCode = tradeItemVariantTypeCode;
		return this;
	}

	/**
	 * Get tradeItemVariantTypeCode
	 * 
	 * @return tradeItemVariantTypeCode
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getTradeItemVariantTypeCode() {
		return tradeItemVariantTypeCode;
	}

	public void setTradeItemVariantTypeCode(CodifiedValue tradeItemVariantTypeCode) {
		this.tradeItemVariantTypeCode = tradeItemVariantTypeCode;
	}

	public TradeItemVariant tradeItemVariantValue(LanguageLabels tradeItemVariantValue) {
		this.tradeItemVariantValue = tradeItemVariantValue;
		return this;
	}

	/**
	 * Get tradeItemVariantValue
	 * 
	 * @return tradeItemVariantValue
	 **/
	@ApiModelProperty(value = "")
	public LanguageLabels getTradeItemVariantValue() {
		return tradeItemVariantValue;
	}

	public void setTradeItemVariantValue(LanguageLabels tradeItemVariantValue) {
		this.tradeItemVariantValue = tradeItemVariantValue;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		TradeItemVariant tradeItemVariant = (TradeItemVariant) o;
		return Objects.equals(this.tradeItemVariantTypeCode, tradeItemVariant.tradeItemVariantTypeCode)
				&& Objects.equals(this.tradeItemVariantValue, tradeItemVariant.tradeItemVariantValue);
	}

	@Override
	public int hashCode() {
		return Objects.hash(tradeItemVariantTypeCode, tradeItemVariantValue);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class TradeItemVariant {\n");

		sb.append("    tradeItemVariantTypeCode: ").append(toIndentedString(tradeItemVariantTypeCode)).append("\n");
		sb.append("    tradeItemVariantValue: ").append(toIndentedString(tradeItemVariantValue)).append("\n");
		sb.append("}");
		return sb.toString();
	}
