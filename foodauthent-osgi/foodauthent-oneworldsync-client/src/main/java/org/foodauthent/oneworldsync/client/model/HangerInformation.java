...
public class HangerInformation {
	@JsonProperty("doesItemComeWithHanger")
	private CodifiedValue doesItemComeWithHanger = null;

	@JsonProperty("isTradeItemHanging")
	private CodifiedValue isTradeItemHanging = null;

	@JsonProperty("standardTypeHangerAgencyCode")
	private CodifiedValue standardTypeHangerAgencyCode = null;

	public HangerInformation doesItemComeWithHanger(CodifiedValue doesItemComeWithHanger) {
		this.doesItemComeWithHanger = doesItemComeWithHanger;
		return this;
	}

	/**
	 * Get doesItemComeWithHanger
	 * 
	 * @return doesItemComeWithHanger
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getDoesItemComeWithHanger() {
		return doesItemComeWithHanger;
	}

	public void setDoesItemComeWithHanger(CodifiedValue doesItemComeWithHanger) {
		this.doesItemComeWithHanger = doesItemComeWithHanger;
	}

	public HangerInformation isTradeItemHanging(CodifiedValue isTradeItemHanging) {
		this.isTradeItemHanging = isTradeItemHanging;
		return this;
	}

	/**
	 * Get isTradeItemHanging
	 * 
	 * @return isTradeItemHanging
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getIsTradeItemHanging() {
		return isTradeItemHanging;
	}

	public void setIsTradeItemHanging(CodifiedValue isTradeItemHanging) {
		this.isTradeItemHanging = isTradeItemHanging;
	}

	public HangerInformation standardTypeHangerAgencyCode(CodifiedValue standardTypeHangerAgencyCode) {
		this.standardTypeHangerAgencyCode = standardTypeHangerAgencyCode;
		return this;
	}

	/**
	 * Get standardTypeHangerAgencyCode
	 * 
	 * @return standardTypeHangerAgencyCode
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getStandardTypeHangerAgencyCode() {
		return standardTypeHangerAgencyCode;
	}

	public void setStandardTypeHangerAgencyCode(CodifiedValue standardTypeHangerAgencyCode) {
		this.standardTypeHangerAgencyCode = standardTypeHangerAgencyCode;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		HangerInformation hangerInformation = (HangerInformation) o;
		return Objects.equals(this.doesItemComeWithHanger, hangerInformation.doesItemComeWithHanger)
				&& Objects.equals(this.isTradeItemHanging, hangerInformation.isTradeItemHanging)
				&& Objects.equals(this.standardTypeHangerAgencyCode, hangerInformation.standardTypeHangerAgencyCode);
	}

	@Override
	public int hashCode() {
		return Objects.hash(doesItemComeWithHanger, isTradeItemHanging, standardTypeHangerAgencyCode);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class HangerInformation {\n");

		sb.append("    doesItemComeWithHanger: ").append(toIndentedString(doesItemComeWithHanger)).append("\n");
		sb.append("    isTradeItemHanging: ").append(toIndentedString(isTradeItemHanging)).append("\n");
		sb.append("    standardTypeHangerAgencyCode: ").append(toIndentedString(standardTypeHangerAgencyCode))
				.append("\n");
		sb.append("}");
		return sb.toString();
	}
