...
public class WarrantyConditions {
	@JsonProperty("warrantyConstraint")
	private String warrantyConstraint = null;

	@JsonProperty("warrantyDuration")
	private QualifiedValue warrantyDuration = null;

	public WarrantyConditions warrantyConstraint(String warrantyConstraint) {
		this.warrantyConstraint = warrantyConstraint;
		return this;
	}

	/**
	 * Get warrantyConstraint
	 * 
	...
	public void setWarrantyConstraint(String warrantyConstraint) {
		this.warrantyConstraint = warrantyConstraint;
	}

	public WarrantyConditions warrantyDuration(QualifiedValue warrantyDuration) {
	 ...
	 **/
	@ApiModelProperty(value = "")
	public QualifiedValue getWarrantyDuration() {
		return warrantyDuration;
	}

	public void setWarrantyDuration(QualifiedValue warrantyDuration) {
		this.warrantyDuration = warrantyDuration;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		WarrantyConditions warrantyConditions = (WarrantyConditions) o;
		return Objects.equals(this.warrantyConstraint, warrantyConditions.warrantyConstraint)
				&& Objects.equals(this.warrantyDuration, warrantyConditions.warrantyDuration);
	}

	@Override
	public int hashCode() {
		return Objects.hash(warrantyConstraint, warrantyDuration);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class WarrantyConditions {\n");

		sb.append("    warrantyConstraint: ").append(toIndentedString(warrantyConstraint)).append("\n");
