...
import org.foodauthent.oneworldsync.client.model.TradeItemLicense;
...
public class TradeItemLicensingModule {
	@JsonProperty("tradeItemLicense")
	private List<TradeItemLicense> tradeItemLicense = null;

	public TradeItemLicensingModule tradeItemLicense(List<TradeItemLicense> tradeItemLicense) {
		this.tradeItemLicense = tradeItemLicense;
		return this;
	}

	public TradeItemLicensingModule addTradeItemLicenseItem(TradeItemLicense tradeItemLicenseItem) {
		if (this.tradeItemLicense == null) {
			this.tradeItemLicense = new ArrayList<TradeItemLicense>();
		}
		this.tradeItemLicense.add(tradeItemLicenseItem);
		return this;
	}

	/**
	 * Get tradeItemLicense
	 * 
	 * @return tradeItemLicense
	 **/
	@ApiModelProperty(value = "")
	public List<TradeItemLicense> getTradeItemLicense() {
		return tradeItemLicense;
	}

	public void setTradeItemLicense(List<TradeItemLicense> tradeItemLicense) {
		this.tradeItemLicense = tradeItemLicense;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		TradeItemLicensingModule tradeItemLicensingModule = (TradeItemLicensingModule) o;
		return Objects.equals(this.tradeItemLicense, tradeItemLicensingModule.tradeItemLicense);
	}

	@Override
	public int hashCode() {
		return Objects.hash(tradeItemLicense);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class TradeItemLicensingModule {\n");

		sb.append("    tradeItemLicense: ").append(toIndentedString(tradeItemLicense)).append("\n");
		sb.append("}");
		return sb.toString();
	}
