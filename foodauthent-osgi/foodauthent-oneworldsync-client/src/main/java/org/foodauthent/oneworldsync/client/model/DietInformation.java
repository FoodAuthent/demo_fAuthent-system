...
import org.foodauthent.oneworldsync.client.model.DietTypeInformation;
...
public class DietInformation {
	...
	private LanguageLabels dietTypeDescription = null;

	@JsonProperty("dietTypeInformation")
	private List<DietTypeInformation> dietTypeInformation = null;

	public DietInformation dietTypeDescription(LanguageLabels dietTypeDescription) {
		this.dietTypeDescription = dietTypeDescription;
		return this;
	}

	/**
	 * Get dietTypeDescription
	 * 
	 * @return dietTypeDescription
	 **/
	@ApiModelProperty(value = "")
	public LanguageLabels getDietTypeDescription() {
		return dietTypeDescription;
	}

	public void setDietTypeDescription(LanguageLabels dietTypeDescription) {
		this.dietTypeDescription = dietTypeDescription;
	}

	public DietInformation dietTypeInformation(List<DietTypeInformation> dietTypeInformation) {
		this.dietTypeInformation = dietTypeInformation;
		return this;
	}

	public DietInformation addDietTypeInformationItem(DietTypeInformation dietTypeInformationItem) {
		if (this.dietTypeInformation == null) {
			this.dietTypeInformation = new ArrayList<DietTypeInformation>();
		}
		this.dietTypeInformation.add(dietTypeInformationItem);
		return this;
	}

	/**
	 * Get dietTypeInformation
	 * 
	 * @return dietTypeInformation
	 **/
	@ApiModelProperty(value = "")
	public List<DietTypeInformation> getDietTypeInformation() {
		return dietTypeInformation;
	}

	public void setDietTypeInformation(List<DietTypeInformation> dietTypeInformation) {
		this.dietTypeInformation = dietTypeInformation;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		DietInformation dietInformation = (DietInformation) o;
		return Objects.equals(this.dietTypeDescription, dietInformation.dietTypeDescription)
				&& Objects.equals(this.dietTypeInformation, dietInformation.dietTypeInformation);
	}

	@Override
	public int hashCode() {
		return Objects.hash(dietTypeDescription, dietTypeInformation);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class DietInformation {\n");

		sb.append("    dietTypeDescription: ").append(toIndentedString(dietTypeDescription)).append("\n");
		sb.append("    dietTypeInformation: ").append(toIndentedString(dietTypeInformation)).append("\n");
		sb.append("}");
		return sb.toString();
	}
