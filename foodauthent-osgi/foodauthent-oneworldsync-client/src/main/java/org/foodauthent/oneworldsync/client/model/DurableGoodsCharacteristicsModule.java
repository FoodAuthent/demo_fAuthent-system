...
import org.foodauthent.oneworldsync.client.model.DurableGoodsCharacteristics;
...
public class DurableGoodsCharacteristicsModule {
	@JsonProperty("durableGoodsCharacteristics")
	private DurableGoodsCharacteristics durableGoodsCharacteristics = null;

	public DurableGoodsCharacteristicsModule durableGoodsCharacteristics(
			DurableGoodsCharacteristics durableGoodsCharacteristics) {
		this.durableGoodsCharacteristics = durableGoodsCharacteristics;
		return this;
	}

	/**
	 * Get durableGoodsCharacteristics
	 * 
	 * @return durableGoodsCharacteristics
	 **/
	@ApiModelProperty(value = "")
	public DurableGoodsCharacteristics getDurableGoodsCharacteristics() {
		return durableGoodsCharacteristics;
	}

	public void setDurableGoodsCharacteristics(DurableGoodsCharacteristics durableGoodsCharacteristics) {
		this.durableGoodsCharacteristics = durableGoodsCharacteristics;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		DurableGoodsCharacteristicsModule durableGoodsCharacteristicsModule = (DurableGoodsCharacteristicsModule) o;
		return Objects.equals(this.durableGoodsCharacteristics,
				durableGoodsCharacteristicsModule.durableGoodsCharacteristics);
	}

	@Override
	public int hashCode() {
		return Objects.hash(durableGoodsCharacteristics);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class DurableGoodsCharacteristicsModule {\n");

		sb.append("    durableGoodsCharacteristics: ").append(toIndentedString(durableGoodsCharacteristics))
				.append("\n");
		sb.append("}");
		return sb.toString();
	}
