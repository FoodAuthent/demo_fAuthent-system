...
public class NoncreditableGrain {
	@JsonProperty("noncreditableGrainAmount")
	private QualifiedValues noncreditableGrainAmount = null;

	@JsonProperty("noncreditableGrainDescription")
	private LanguageLabels noncreditableGrainDescription = null;

	public NoncreditableGrain noncreditableGrainAmount(QualifiedValues noncreditableGrainAmount) {
		this.noncreditableGrainAmount = noncreditableGrainAmount;
		return this;
	}

	/**
	 * Get noncreditableGrainAmount
	 * 
	 * @return noncreditableGrainAmount
	 **/
	@ApiModelProperty(value = "")
	public QualifiedValues getNoncreditableGrainAmount() {
		return noncreditableGrainAmount;
	}

	public void setNoncreditableGrainAmount(QualifiedValues noncreditableGrainAmount) {
		this.noncreditableGrainAmount = noncreditableGrainAmount;
	}

	public NoncreditableGrain noncreditableGrainDescription(LanguageLabels noncreditableGrainDescription) {
		this.noncreditableGrainDescription = noncreditableGrainDescription;
		return this;
	}

	/**
	 * Get noncreditableGrainDescription
	 * 
	 * @return noncreditableGrainDescription
	 **/
	@ApiModelProperty(value = "")
	public LanguageLabels getNoncreditableGrainDescription() {
		return noncreditableGrainDescription;
	}

	public void setNoncreditableGrainDescription(LanguageLabels noncreditableGrainDescription) {
		this.noncreditableGrainDescription = noncreditableGrainDescription;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		NoncreditableGrain noncreditableGrain = (NoncreditableGrain) o;
		return Objects.equals(this.noncreditableGrainAmount, noncreditableGrain.noncreditableGrainAmount)
				&& Objects.equals(this.noncreditableGrainDescription, noncreditableGrain.noncreditableGrainDescription);
	}

	@Override
	public int hashCode() {
		return Objects.hash(noncreditableGrainAmount, noncreditableGrainDescription);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class NoncreditableGrain {\n");

		sb.append("    noncreditableGrainAmount: ").append(toIndentedString(noncreditableGrainAmount)).append("\n");
		sb.append("    noncreditableGrainDescription: ").append(toIndentedString(noncreditableGrainDescription))
				.append("\n");
		sb.append("}");
		return sb.toString();
	}
