...
public class PhysicalResourceUsageAgencyCodeReference {
	...
	@JsonProperty("physicalResourceUsageAgencyCodeReferenceValue")
	private String physicalResourceUsageAgencyCodeReferenceValue = null;

	public PhysicalResourceUsageAgencyCodeReference codeDescription(String codeDescription) {
	...
	public PhysicalResourceUsageAgencyCodeReference codeListAgencyCode(String codeListAgencyCode) {
	...
	public PhysicalResourceUsageAgencyCodeReference codeListAgencyCodeListVersion(
	...
	public PhysicalResourceUsageAgencyCodeReference codeListAgencyName(String codeListAgencyName) {
	...
	public PhysicalResourceUsageAgencyCodeReference codeListName(String codeListName) {
	...
	public PhysicalResourceUsageAgencyCodeReference codeListURI(String codeListURI) {
	...
	public PhysicalResourceUsageAgencyCodeReference codeListVersion(String codeListVersion) {
	...
	public PhysicalResourceUsageAgencyCodeReference physicalResourceUsageAgencyCodeReferenceValue(
			String physicalResourceUsageAgencyCodeReferenceValue) {
		this.physicalResourceUsageAgencyCodeReferenceValue = physicalResourceUsageAgencyCodeReferenceValue;
		return this;
	}

	/**
	 * Get physicalResourceUsageAgencyCodeReferenceValue
	 * 
	 * @return physicalResourceUsageAgencyCodeReferenceValue
	 **/
	@ApiModelProperty(value = "")
	public String getPhysicalResourceUsageAgencyCodeReferenceValue() {
		return physicalResourceUsageAgencyCodeReferenceValue;
	}

	public void setPhysicalResourceUsageAgencyCodeReferenceValue(String physicalResourceUsageAgencyCodeReferenceValue) {
		this.physicalResourceUsageAgencyCodeReferenceValue = physicalResourceUsageAgencyCodeReferenceValue;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		PhysicalResourceUsageAgencyCodeReference physicalResourceUsageAgencyCodeReference = (PhysicalResourceUsageAgencyCodeReference) o;
		return Objects.equals(this.codeDescription, physicalResourceUsageAgencyCodeReference.codeDescription)
				&& Objects.equals(this.codeListAgencyCode, physicalResourceUsageAgencyCodeReference.codeListAgencyCode)
				&& Objects.equals(this.codeListAgencyCodeListVersion,
						physicalResourceUsageAgencyCodeReference.codeListAgencyCodeListVersion)
				&& Objects.equals(this.codeListAgencyName, physicalResourceUsageAgencyCodeReference.codeListAgencyName)
				&& Objects.equals(this.codeListName, physicalResourceUsageAgencyCodeReference.codeListName)
				&& Objects.equals(this.codeListURI, physicalResourceUsageAgencyCodeReference.codeListURI)
				&& Objects.equals(this.codeListVersion, physicalResourceUsageAgencyCodeReference.codeListVersion)
				&& Objects.equals(this.physicalResourceUsageAgencyCodeReferenceValue,
						physicalResourceUsageAgencyCodeReference.physicalResourceUsageAgencyCodeReferenceValue);
	}

	@Override
	public int hashCode() {
		return Objects.hash(codeDescription, codeListAgencyCode, codeListAgencyCodeListVersion, codeListAgencyName,
				codeListName, codeListURI, codeListVersion, physicalResourceUsageAgencyCodeReferenceValue);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class PhysicalResourceUsageAgencyCodeReference {\n");
		...
		sb.append("    physicalResourceUsageAgencyCodeReferenceValue: ")
				.append(toIndentedString(physicalResourceUsageAgencyCodeReferenceValue)).append("\n");
		sb.append("}");
		return sb.toString();
	}
