...
import org.foodauthent.oneworldsync.client.model.FishMeatPoultryTypeCodeReference;
...
public class FishMeatPoultryContent {
	@JsonProperty("fishMeatPoultryTypeCodeReference")
	private FishMeatPoultryTypeCodeReference fishMeatPoultryTypeCodeReference = null;

	@JsonProperty("minimumFishMeatPoultryContent")
	private QualifiedValues minimumFishMeatPoultryContent = null;

	public FishMeatPoultryContent fishMeatPoultryTypeCodeReference(
			FishMeatPoultryTypeCodeReference fishMeatPoultryTypeCodeReference) {
		this.fishMeatPoultryTypeCodeReference = fishMeatPoultryTypeCodeReference;
		return this;
	}

	/**
	 * Get fishMeatPoultryTypeCodeReference
	 * 
	 * @return fishMeatPoultryTypeCodeReference
	 **/
	@ApiModelProperty(value = "")
	public FishMeatPoultryTypeCodeReference getFishMeatPoultryTypeCodeReference() {
		return fishMeatPoultryTypeCodeReference;
	}

	public void setFishMeatPoultryTypeCodeReference(FishMeatPoultryTypeCodeReference fishMeatPoultryTypeCodeReference) {
		this.fishMeatPoultryTypeCodeReference = fishMeatPoultryTypeCodeReference;
	}

	public FishMeatPoultryContent minimumFishMeatPoultryContent(QualifiedValues minimumFishMeatPoultryContent) {
		this.minimumFishMeatPoultryContent = minimumFishMeatPoultryContent;
		return this;
	}

	/**
	 * Get minimumFishMeatPoultryContent
	 * 
	 * @return minimumFishMeatPoultryContent
	 **/
	@ApiModelProperty(value = "")
	public QualifiedValues getMinimumFishMeatPoultryContent() {
		return minimumFishMeatPoultryContent;
	}

	public void setMinimumFishMeatPoultryContent(QualifiedValues minimumFishMeatPoultryContent) {
		this.minimumFishMeatPoultryContent = minimumFishMeatPoultryContent;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		FishMeatPoultryContent fishMeatPoultryContent = (FishMeatPoultryContent) o;
		return Objects.equals(this.fishMeatPoultryTypeCodeReference,
				fishMeatPoultryContent.fishMeatPoultryTypeCodeReference)
				&& Objects.equals(this.minimumFishMeatPoultryContent,
						fishMeatPoultryContent.minimumFishMeatPoultryContent);
	}

	@Override
	public int hashCode() {
		return Objects.hash(fishMeatPoultryTypeCodeReference, minimumFishMeatPoultryContent);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class FishMeatPoultryContent {\n");

		sb.append("    fishMeatPoultryTypeCodeReference: ").append(toIndentedString(fishMeatPoultryTypeCodeReference))
				.append("\n");
		sb.append("    minimumFishMeatPoultryContent: ").append(toIndentedString(minimumFishMeatPoultryContent))
				.append("\n");
		sb.append("}");
		return sb.toString();
	}
