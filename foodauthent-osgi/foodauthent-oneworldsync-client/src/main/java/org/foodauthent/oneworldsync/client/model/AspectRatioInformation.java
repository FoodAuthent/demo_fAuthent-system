...
public class AspectRatioInformation {
	@JsonProperty("aspectRatioDescriptionCode")
	private CodifiedValue aspectRatioDescriptionCode = null;

	@JsonProperty("aspectRatioDimensionCode")
	private CodifiedValue aspectRatioDimensionCode = null;

	public AspectRatioInformation aspectRatioDescriptionCode(CodifiedValue aspectRatioDescriptionCode) {
		this.aspectRatioDescriptionCode = aspectRatioDescriptionCode;
		return this;
	}

	/**
	 * Get aspectRatioDescriptionCode
	 * 
	 * @return aspectRatioDescriptionCode
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getAspectRatioDescriptionCode() {
		return aspectRatioDescriptionCode;
	}

	public void setAspectRatioDescriptionCode(CodifiedValue aspectRatioDescriptionCode) {
		this.aspectRatioDescriptionCode = aspectRatioDescriptionCode;
	}

	public AspectRatioInformation aspectRatioDimensionCode(CodifiedValue aspectRatioDimensionCode) {
		this.aspectRatioDimensionCode = aspectRatioDimensionCode;
		return this;
	}

	/**
	 * Get aspectRatioDimensionCode
	 * 
	 * @return aspectRatioDimensionCode
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getAspectRatioDimensionCode() {
		return aspectRatioDimensionCode;
	}

	public void setAspectRatioDimensionCode(CodifiedValue aspectRatioDimensionCode) {
		this.aspectRatioDimensionCode = aspectRatioDimensionCode;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		AspectRatioInformation aspectRatioInformation = (AspectRatioInformation) o;
		return Objects.equals(this.aspectRatioDescriptionCode, aspectRatioInformation.aspectRatioDescriptionCode)
				&& Objects.equals(this.aspectRatioDimensionCode, aspectRatioInformation.aspectRatioDimensionCode);
	}

	@Override
	public int hashCode() {
		return Objects.hash(aspectRatioDescriptionCode, aspectRatioDimensionCode);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class AspectRatioInformation {\n");

		sb.append("    aspectRatioDescriptionCode: ").append(toIndentedString(aspectRatioDescriptionCode)).append("\n");
		sb.append("    aspectRatioDimensionCode: ").append(toIndentedString(aspectRatioDimensionCode)).append("\n");
		sb.append("}");
		return sb.toString();
	}
