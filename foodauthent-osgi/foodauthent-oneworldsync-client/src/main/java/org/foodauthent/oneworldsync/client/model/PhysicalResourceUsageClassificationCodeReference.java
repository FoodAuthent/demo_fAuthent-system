...
public class PhysicalResourceUsageClassificationCodeReference {
	...
	@JsonProperty("physicalResourceUsageClassificationCodeReferenceValue")
	private String physicalResourceUsageClassificationCodeReferenceValue = null;

	public PhysicalResourceUsageClassificationCodeReference codeDescription(String codeDescription) {
	...
	public PhysicalResourceUsageClassificationCodeReference codeListAgencyCode(String codeListAgencyCode) {
	...
	public PhysicalResourceUsageClassificationCodeReference codeListAgencyCodeListVersion(
	...
	public PhysicalResourceUsageClassificationCodeReference codeListAgencyName(String codeListAgencyName) {
	...
	public PhysicalResourceUsageClassificationCodeReference codeListName(String codeListName) {
	...
	public PhysicalResourceUsageClassificationCodeReference codeListURI(String codeListURI) {
	...
	public PhysicalResourceUsageClassificationCodeReference codeListVersion(String codeListVersion) {
	...
	public PhysicalResourceUsageClassificationCodeReference physicalResourceUsageClassificationCodeReferenceValue(
			String physicalResourceUsageClassificationCodeReferenceValue) {
		this.physicalResourceUsageClassificationCodeReferenceValue = physicalResourceUsageClassificationCodeReferenceValue;
		return this;
	}

	/**
	 * Get physicalResourceUsageClassificationCodeReferenceValue
	 * 
	 * @return physicalResourceUsageClassificationCodeReferenceValue
	 **/
	@ApiModelProperty(value = "")
	public String getPhysicalResourceUsageClassificationCodeReferenceValue() {
		return physicalResourceUsageClassificationCodeReferenceValue;
	}

	public void setPhysicalResourceUsageClassificationCodeReferenceValue(
			String physicalResourceUsageClassificationCodeReferenceValue) {
		this.physicalResourceUsageClassificationCodeReferenceValue = physicalResourceUsageClassificationCodeReferenceValue;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		PhysicalResourceUsageClassificationCodeReference physicalResourceUsageClassificationCodeReference = (PhysicalResourceUsageClassificationCodeReference) o;
		return Objects.equals(this.codeDescription, physicalResourceUsageClassificationCodeReference.codeDescription)
				&& Objects.equals(this.codeListAgencyCode,
						physicalResourceUsageClassificationCodeReference.codeListAgencyCode)
				&& Objects.equals(this.codeListAgencyCodeListVersion,
						physicalResourceUsageClassificationCodeReference.codeListAgencyCodeListVersion)
				&& Objects.equals(this.codeListAgencyName,
						physicalResourceUsageClassificationCodeReference.codeListAgencyName)
				&& Objects.equals(this.codeListName, physicalResourceUsageClassificationCodeReference.codeListName)
				&& Objects.equals(this.codeListURI, physicalResourceUsageClassificationCodeReference.codeListURI)
				&& Objects.equals(this.codeListVersion,
						physicalResourceUsageClassificationCodeReference.codeListVersion)
				&& Objects.equals(this.physicalResourceUsageClassificationCodeReferenceValue,
						physicalResourceUsageClassificationCodeReference.physicalResourceUsageClassificationCodeReferenceValue);
	}

	@Override
	public int hashCode() {
		return Objects.hash(codeDescription, codeListAgencyCode, codeListAgencyCodeListVersion, codeListAgencyName,
				codeListName, codeListURI, codeListVersion, physicalResourceUsageClassificationCodeReferenceValue);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class PhysicalResourceUsageClassificationCodeReference {\n");
		...
		sb.append("    physicalResourceUsageClassificationCodeReferenceValue: ")
				.append(toIndentedString(physicalResourceUsageClassificationCodeReferenceValue)).append("\n");
		sb.append("}");
		return sb.toString();
	}
