...
public class SizeCode {
	...
	private CodifiedValue sizeCodeListCode = null;

	@JsonProperty("sizeCodeListVersion")
	private String sizeCodeListVersion = null;

	@JsonProperty("sizeCodeValue")
	private String sizeCodeValue = null;

	public SizeCode codeListVersion(String codeListVersion) {
	...
	public SizeCode sizeCodeListCode(CodifiedValue sizeCodeListCode) {
		this.sizeCodeListCode = sizeCodeListCode;
		return this;
	}

	/**
	 * Get sizeCodeListCode
	 * 
	 * @return sizeCodeListCode
	 **/
	@ApiModelProperty(value = "")
	public CodifiedValue getSizeCodeListCode() {
		return sizeCodeListCode;
	}

	public void setSizeCodeListCode(CodifiedValue sizeCodeListCode) {
		this.sizeCodeListCode = sizeCodeListCode;
	}

	public SizeCode sizeCodeListVersion(String sizeCodeListVersion) {
		this.sizeCodeListVersion = sizeCodeListVersion;
		return this;
	}

	/**
	 * Get sizeCodeListVersion
	 * 
	...
	public void setSizeCodeListVersion(String sizeCodeListVersion) {
		this.sizeCodeListVersion = sizeCodeListVersion;
	}

	public SizeCode sizeCodeValue(String sizeCodeValue) {
	...
	public boolean equals(java.lang.Object o) {
		...
		SizeCode sizeCode = (SizeCode) o;
		return Objects.equals(this.codeListVersion, sizeCode.codeListVersion)
				&& Objects.equals(this.sizeCodeListCode, sizeCode.sizeCodeListCode)
				&& Objects.equals(this.sizeCodeListVersion, sizeCode.sizeCodeListVersion)
				&& Objects.equals(this.sizeCodeValue, sizeCode.sizeCodeValue);
	}

	@Override
	public int hashCode() {
		return Objects.hash(codeListVersion, sizeCodeListCode, sizeCodeListVersion, sizeCodeValue);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class SizeCode {\n");

		sb.append("    codeListVersion: ").append(toIndentedString(codeListVersion)).append("\n");
		sb.append("    sizeCodeListCode: ").append(toIndentedString(sizeCodeListCode)).append("\n");
		sb.append("    sizeCodeListVersion: ").append(toIndentedString(sizeCodeListVersion)).append("\n");
		sb.append("    sizeCodeValue: ").append(toIndentedString(sizeCodeValue)).append("\n");
		sb.append("}");
		return sb.toString();
	}
