...
public class DangerousSubstanceHazardSymbolCodeReference {
	...
	@JsonProperty("dangerousSubstanceHazardSymbolCodeReferenceValue")
	private String dangerousSubstanceHazardSymbolCodeReferenceValue = null;

	public DangerousSubstanceHazardSymbolCodeReference codeDescription(String codeDescription) {
	...
	public DangerousSubstanceHazardSymbolCodeReference codeListAgencyCode(String codeListAgencyCode) {
	...
	public DangerousSubstanceHazardSymbolCodeReference codeListAgencyCodeListVersion(
	...
	public DangerousSubstanceHazardSymbolCodeReference codeListAgencyName(String codeListAgencyName) {
	...
	public DangerousSubstanceHazardSymbolCodeReference codeListName(String codeListName) {
	...
	public DangerousSubstanceHazardSymbolCodeReference codeListURI(String codeListURI) {
	...
	public DangerousSubstanceHazardSymbolCodeReference codeListVersion(String codeListVersion) {
	...
	public DangerousSubstanceHazardSymbolCodeReference dangerousSubstanceHazardSymbolCodeReferenceValue(
			String dangerousSubstanceHazardSymbolCodeReferenceValue) {
		this.dangerousSubstanceHazardSymbolCodeReferenceValue = dangerousSubstanceHazardSymbolCodeReferenceValue;
		return this;
	}

	/**
	 * Get dangerousSubstanceHazardSymbolCodeReferenceValue
	 * 
	 * @return dangerousSubstanceHazardSymbolCodeReferenceValue
	 **/
	@ApiModelProperty(value = "")
	public String getDangerousSubstanceHazardSymbolCodeReferenceValue() {
		return dangerousSubstanceHazardSymbolCodeReferenceValue;
	}

	public void setDangerousSubstanceHazardSymbolCodeReferenceValue(
			String dangerousSubstanceHazardSymbolCodeReferenceValue) {
		this.dangerousSubstanceHazardSymbolCodeReferenceValue = dangerousSubstanceHazardSymbolCodeReferenceValue;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		DangerousSubstanceHazardSymbolCodeReference dangerousSubstanceHazardSymbolCodeReference = (DangerousSubstanceHazardSymbolCodeReference) o;
		return Objects.equals(this.codeDescription, dangerousSubstanceHazardSymbolCodeReference.codeDescription)
				&& Objects.equals(this.codeListAgencyCode,
						dangerousSubstanceHazardSymbolCodeReference.codeListAgencyCode)
				&& Objects.equals(this.codeListAgencyCodeListVersion,
						dangerousSubstanceHazardSymbolCodeReference.codeListAgencyCodeListVersion)
				&& Objects.equals(this.codeListAgencyName,
						dangerousSubstanceHazardSymbolCodeReference.codeListAgencyName)
				&& Objects.equals(this.codeListName, dangerousSubstanceHazardSymbolCodeReference.codeListName)
				&& Objects.equals(this.codeListURI, dangerousSubstanceHazardSymbolCodeReference.codeListURI)
				&& Objects.equals(this.codeListVersion, dangerousSubstanceHazardSymbolCodeReference.codeListVersion)
				&& Objects.equals(this.dangerousSubstanceHazardSymbolCodeReferenceValue,
						dangerousSubstanceHazardSymbolCodeReference.dangerousSubstanceHazardSymbolCodeReferenceValue);
	}

	@Override
	public int hashCode() {
		return Objects.hash(codeDescription, codeListAgencyCode, codeListAgencyCodeListVersion, codeListAgencyName,
				codeListName, codeListURI, codeListVersion, dangerousSubstanceHazardSymbolCodeReferenceValue);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class DangerousSubstanceHazardSymbolCodeReference {\n");
		...
		sb.append("    dangerousSubstanceHazardSymbolCodeReferenceValue: ")
				.append(toIndentedString(dangerousSubstanceHazardSymbolCodeReferenceValue)).append("\n");
		sb.append("}");
		return sb.toString();
	}
