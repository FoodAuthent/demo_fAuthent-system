...
import org.foodauthent.oneworldsync.client.model.ReferencedFileHeader;
...
public class ReferencedFileDetailInformationModule {
	...
	private List<ReferencedFileHeader> referencedFileHeader = null;

	public ReferencedFileDetailInformationModule referencedFileHeader(List<ReferencedFileHeader> referencedFileHeader) {
		this.referencedFileHeader = referencedFileHeader;
		return this;
	}

	public ReferencedFileDetailInformationModule addReferencedFileHeaderItem(
			ReferencedFileHeader referencedFileHeaderItem) {
		if (this.referencedFileHeader == null) {
			this.referencedFileHeader = new ArrayList<ReferencedFileHeader>();
		}
		this.referencedFileHeader.add(referencedFileHeaderItem);
		return this;
	}
	 ...
	 * 
	 * @return referencedFileHeader
	 **/
	@ApiModelProperty(value = "")
	public List<ReferencedFileHeader> getReferencedFileHeader() {
		return referencedFileHeader;
	}

	public void setReferencedFileHeader(List<ReferencedFileHeader> referencedFileHeader) {
		this.referencedFileHeader = referencedFileHeader;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		ReferencedFileDetailInformationModule referencedFileDetailInformationModule = (ReferencedFileDetailInformationModule) o;
		return Objects.equals(this.referencedFileHeader, referencedFileDetailInformationModule.referencedFileHeader);
	}

	@Override
	public int hashCode() {
		return Objects.hash(referencedFileHeader);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class ReferencedFileDetailInformationModule {\n");

		sb.append("    referencedFileHeader: ").append(toIndentedString(referencedFileHeader)).append("\n");
		sb.append("}");
		return sb.toString();
	}
