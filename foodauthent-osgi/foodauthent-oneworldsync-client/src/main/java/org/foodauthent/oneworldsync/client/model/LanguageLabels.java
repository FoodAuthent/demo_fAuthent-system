...
public class LanguageLabels {
	@JsonProperty("values")
	private List<LanguageLabel> values = null;

	@JsonProperty("languageDefinition")
	private String languageDefinition = null;

	public LanguageLabels values(List<LanguageLabel> values) {
		this.values = values;
		return this;
	}

	public LanguageLabels addValuesItem(LanguageLabel valuesItem) {
		if (this.values == null) {
			this.values = new ArrayList<LanguageLabel>();
		}
	...
	public List<LanguageLabel> getValues() {
		return values;
	}

	public void setValues(List<LanguageLabel> values) {
		this.values = values;
	}

	public LanguageLabels languageDefinition(String languageDefinition) {
	...
	public boolean equals(java.lang.Object o) {
		...
		LanguageLabels languageLabels = (LanguageLabels) o;
		return Objects.equals(this.values, languageLabels.values)
				&& Objects.equals(this.languageDefinition, languageLabels.languageDefinition);
	}

	@Override
	public int hashCode() {
		return Objects.hash(values, languageDefinition);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class LanguageLabels {\n");

		sb.append("    values: ").append(toIndentedString(values)).append("\n");
		sb.append("    languageDefinition: ").append(toIndentedString(languageDefinition)).append("\n");
		sb.append("}");
		return sb.toString();
	}
