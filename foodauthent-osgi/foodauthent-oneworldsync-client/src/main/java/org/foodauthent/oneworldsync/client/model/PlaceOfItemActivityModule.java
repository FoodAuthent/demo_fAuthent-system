...
import org.foodauthent.oneworldsync.client.model.ImportClassification;
import org.foodauthent.oneworldsync.client.model.PlaceOfProductActivity;
...
public class PlaceOfItemActivityModule {
	@JsonProperty("importClassification")
	private List<ImportClassification> importClassification = null;

	@JsonProperty("placeOfProductActivity")
	private PlaceOfProductActivity placeOfProductActivity = null;

	public PlaceOfItemActivityModule importClassification(List<ImportClassification> importClassification) {
		this.importClassification = importClassification;
		return this;
	}

	public PlaceOfItemActivityModule addImportClassificationItem(ImportClassification importClassificationItem) {
		if (this.importClassification == null) {
			this.importClassification = new ArrayList<ImportClassification>();
		}
		this.importClassification.add(importClassificationItem);
		return this;
	}

	/**
	 * Get importClassification
	 * 
	 * @return importClassification
	 **/
	@ApiModelProperty(value = "")
	public List<ImportClassification> getImportClassification() {
		return importClassification;
	}

	public void setImportClassification(List<ImportClassification> importClassification) {
		this.importClassification = importClassification;
	}

	public PlaceOfItemActivityModule placeOfProductActivity(PlaceOfProductActivity placeOfProductActivity) {
		this.placeOfProductActivity = placeOfProductActivity;
		return this;
	}

	/**
	 * Get placeOfProductActivity
	 * 
	 * @return placeOfProductActivity
	 **/
	@ApiModelProperty(value = "")
	public PlaceOfProductActivity getPlaceOfProductActivity() {
		return placeOfProductActivity;
	}

	public void setPlaceOfProductActivity(PlaceOfProductActivity placeOfProductActivity) {
		this.placeOfProductActivity = placeOfProductActivity;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		PlaceOfItemActivityModule placeOfItemActivityModule = (PlaceOfItemActivityModule) o;
		return Objects.equals(this.importClassification, placeOfItemActivityModule.importClassification)
				&& Objects.equals(this.placeOfProductActivity, placeOfItemActivityModule.placeOfProductActivity);
	}

	@Override
	public int hashCode() {
		return Objects.hash(importClassification, placeOfProductActivity);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class PlaceOfItemActivityModule {\n");

		sb.append("    importClassification: ").append(toIndentedString(importClassification)).append("\n");
		sb.append("    placeOfProductActivity: ").append(toIndentedString(placeOfProductActivity)).append("\n");
		sb.append("}");
		return sb.toString();
	}
