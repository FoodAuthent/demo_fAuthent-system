...
public class SOP extends FaModel {
	...
	SOP ent = (SOP) o;
	return Objects.equals(faId, ent.faId) && Objects.equals(fileLink, ent.fileLink)
		&& Objects.equals(name, ent.name) && Objects.equals(description, ent.description)
		&& Objects.equals(productId, ent.productId);
    }
