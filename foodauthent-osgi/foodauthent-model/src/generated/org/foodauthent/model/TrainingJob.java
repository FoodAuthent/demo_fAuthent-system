...
public class TrainingJob extends FaModel {
	...
	return Objects.equals(faId, ent.faId) && Objects.equals(worklfowId, ent.worklfowId)
		&& Objects.equals(fingerprintsetId, ent.fingerprintsetId)
		&& Objects.equals(predictionWorkflowId, ent.predictionWorkflowId) && Objects.equals(status, ent.status);
    }
