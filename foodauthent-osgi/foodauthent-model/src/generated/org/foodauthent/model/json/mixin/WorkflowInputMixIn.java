 ...
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.EXISTING_PROPERTY, property = "", visible = true, defaultImpl = WorkflowInput.class)
@JsonSubTypes({ @Type(value = WorkflowInput.class, name = "WorkflowInput") })
...
public interface WorkflowInputMixIn {
     ...
     * @author Martin Horn, University of Konstanz
     */
    @JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.EXISTING_PROPERTY, property = "", defaultImpl = WorkflowInputBuilder.class)
    @JsonSubTypes({ @Type(value = WorkflowInput.WorkflowInputBuilder.class, name = "WorkflowInput") })
