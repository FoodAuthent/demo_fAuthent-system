...
import org.foodauthent.model.json.mixin.UserBaseMixIn;
...
public interface UserCreateRequestMixIn {
    ...
    public PostalAddressMixIn getPostalAddress();
    
    @JsonProperty("billingAddress")
    public PostalAddressMixIn getBillingAddress();
    ...
    public static interface UserCreateRequestMixInBuilder {
        ...
        @JsonProperty("postalAddress")
        public UserCreateRequestMixInBuilder setPostalAddress(final PostalAddressMixIn postalAddress);
        
        @JsonProperty("billingAddress")
        public UserCreateRequestMixInBuilder setBillingAddress(final PostalAddressMixIn billingAddress);
