 ...
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.EXISTING_PROPERTY, property = "", visible = true, defaultImpl = WorkflowOutput.class)
@JsonSubTypes({ @Type(value = WorkflowOutput.class, name = "WorkflowOutput") })
...
public interface WorkflowOutputMixIn {
     ...
     * @author Martin Horn, University of Konstanz
     */
    @JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.EXISTING_PROPERTY, property = "", defaultImpl = WorkflowOutputBuilder.class)
    @JsonSubTypes({ @Type(value = WorkflowOutput.WorkflowOutputBuilder.class, name = "WorkflowOutput") })
