 ...
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.EXISTING_PROPERTY, property = "", visible = true, defaultImpl = FingerprintMetadata.class)
@JsonSubTypes({ @Type(value = FingerprintMetadata.class, name = "FingerprintMetadata") })
...
public interface FingerprintMetadataMixIn {
     ...
     * @author Martin Horn, University of Konstanz
     */
    @JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.EXISTING_PROPERTY, property = "", defaultImpl = FingerprintMetadataBuilder.class)
    @JsonSubTypes({ @Type(value = FingerprintMetadata.FingerprintMetadataBuilder.class, name = "FingerprintMetadata") })
