 ...
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.EXISTING_PROPERTY, property = "", visible = true, defaultImpl = MetadataEntries.class)
@JsonSubTypes({ @Type(value = MetadataEntries.class, name = "MetadataEntries") })
...
public interface MetadataEntriesMixIn {
     ...
     * @author Martin Horn, University of Konstanz
     */
    @JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.EXISTING_PROPERTY, property = "", defaultImpl = MetadataEntriesBuilder.class)
    @JsonSubTypes({ @Type(value = MetadataEntries.MetadataEntriesBuilder.class, name = "MetadataEntries") })
