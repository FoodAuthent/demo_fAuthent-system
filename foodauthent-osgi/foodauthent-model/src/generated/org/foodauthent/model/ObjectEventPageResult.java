...
public class ObjectEventPageResult   extends FaModel {
  ...
  private ObjectEventPageResult(ObjectEventPageResultBuilder builder) {
   ...
   /**
    ...
    public boolean equals(final Object o) {
        ...
        ObjectEventPageResult ent = (ObjectEventPageResult)o;
  ...
  public java.util.List<ObjectEvent> getResults() {
	 ...
	 */
	public static ObjectEventPageResultBuilder builder(ObjectEventPageResult entity) {
		ObjectEventPageResultBuilder builder = builder();
    ...
    public static class ObjectEventPageResultBuilder {
        ...
        private java.util.List<ObjectEvent> results = new java.util.ArrayList<>();

        /**
         * Get pageNumber
         * @return pageNumber 
         */
        public ObjectEventPageResultBuilder setPageNumber(Integer pageNumber) {
         ...
         * @return pageCount 
         */
        public ObjectEventPageResultBuilder setPageCount(Integer pageCount) {
         ...
         * @return resultCount 
         */
        public ObjectEventPageResultBuilder setResultCount(Integer resultCount) {
         ...
         * @return results 
         */
        public ObjectEventPageResultBuilder setResults(java.util.List<ObjectEvent> results) {
