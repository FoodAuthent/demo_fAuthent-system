...
public class Workflow extends FaModel {
    ...
    /**
     * The workflow representation, e.g. represented by a scripting language, cwl or
     * a KNIME-workflow.
     */
    ...
    /**
     * The type of the workflow, e.g. a generic one, a model etc. The type might
     * also determine the what inputs/outputs to be expected.
     */
	...
	return Objects.equals(faId, ent.faId) && Objects.equals(name, ent.name)
		&& Objects.equals(description, ent.description) && Objects.equals(author, ent.author)
		&& Objects.equals(date, ent.date) && Objects.equals(version, ent.version)
		&& Objects.equals(representation, ent.representation) && Objects.equals(type, ent.type)
		&& Objects.equals(fileLink, ent.fileLink) && Objects.equals(inputs, ent.inputs)
		&& Objects.equals(outputs, ent.outputs) && Objects.equals(tags, ent.tags)
		&& Objects.equals(workflowfileId, ent.workflowfileId);
    }
