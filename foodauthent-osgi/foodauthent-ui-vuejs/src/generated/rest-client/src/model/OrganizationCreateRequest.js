...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.FoodAuthentSwaggerApi.OrganizationCreateRequest = factory(root.FoodAuthentSwaggerApi.ApiClient, root.FoodAuthentSwaggerApi.OrganizationBase, root.FoodAuthentSwaggerApi.OrganizationalPostalAddress);
  }
  ...
  /**
   * The OrganizationCreateRequest model module.
   * @module model/OrganizationCreateRequest
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>OrganizationCreateRequest</code>.
   * Organization Object
   * @alias module:model/OrganizationCreateRequest
   * @class
   ...
   */
  var exports = function(parentDn, organizationName) {
    var _this = this;
  ...
  /**
   * Constructs a <code>OrganizationCreateRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OrganizationCreateRequest} obj Optional instance to populate.
   * @return {module:model/OrganizationCreateRequest} The populated <code>OrganizationCreateRequest</code> instance.
   */
