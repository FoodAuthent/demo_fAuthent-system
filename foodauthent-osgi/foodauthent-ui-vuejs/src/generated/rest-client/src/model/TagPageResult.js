...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.FoodAuthentSwaggerApi.TagPageResult = factory(root.FoodAuthentSwaggerApi.ApiClient, root.FoodAuthentSwaggerApi.Tag);
  }
  ...
  /**
   * The TagPageResult model module.
   * @module model/TagPageResult
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>TagPageResult</code>.
   * @alias module:model/TagPageResult
   * @class
   */
  ...
  /**
   * Constructs a <code>TagPageResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TagPageResult} obj Optional instance to populate.
   * @return {module:model/TagPageResult} The populated <code>TagPageResult</code> instance.
   */
