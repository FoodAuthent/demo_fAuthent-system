...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FoodAuthentSwaggerApi.TrainingJobPageResult();
  });
  ...
  describe('TrainingJobPageResult', function() {
    it('should create an instance of TrainingJobPageResult', function() {
      // uncomment below and update the code to test TrainingJobPageResult
      //var instane = new FoodAuthentSwaggerApi.TrainingJobPageResult();
      //expect(instance).to.be.a(FoodAuthentSwaggerApi.TrainingJobPageResult);
    });
