...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FoodAuthentSwaggerApi.PredictionJobPageResult();
  });
  ...
  describe('PredictionJobPageResult', function() {
    it('should create an instance of PredictionJobPageResult', function() {
      // uncomment below and update the code to test PredictionJobPageResult
      //var instane = new FoodAuthentSwaggerApi.PredictionJobPageResult();
      //expect(instance).to.be.a(FoodAuthentSwaggerApi.PredictionJobPageResult);
    });
