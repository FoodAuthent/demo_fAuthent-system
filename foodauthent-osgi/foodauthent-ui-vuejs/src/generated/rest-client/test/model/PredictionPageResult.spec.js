...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FoodAuthentSwaggerApi.PredictionPageResult();
  });
  ...
  describe('PredictionPageResult', function() {
    it('should create an instance of PredictionPageResult', function() {
      // uncomment below and update the code to test PredictionPageResult
      //var instane = new FoodAuthentSwaggerApi.PredictionPageResult();
      //expect(instance).to.be.a(FoodAuthentSwaggerApi.PredictionPageResult);
    });
