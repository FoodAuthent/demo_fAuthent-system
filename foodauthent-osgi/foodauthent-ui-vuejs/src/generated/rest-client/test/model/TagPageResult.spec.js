...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FoodAuthentSwaggerApi.TagPageResult();
  });
  ...
  describe('TagPageResult', function() {
    it('should create an instance of TagPageResult', function() {
      // uncomment below and update the code to test TagPageResult
      //var instane = new FoodAuthentSwaggerApi.TagPageResult();
      //expect(instance).to.be.a(FoodAuthentSwaggerApi.TagPageResult);
    });
