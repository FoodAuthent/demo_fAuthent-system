...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FoodAuthentSwaggerApi.WorkflowModule();
  });
  ...
  describe('WorkflowModule', function() {
    it('should create an instance of WorkflowModule', function() {
      // uncomment below and update the code to test WorkflowModule
      //var instane = new FoodAuthentSwaggerApi.WorkflowModule();
      //expect(instance).to.be.a(FoodAuthentSwaggerApi.WorkflowModule);
    });
