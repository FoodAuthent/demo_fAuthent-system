...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FoodAuthentSwaggerApi.ProductPageResult();
  });
  ...
  describe('ProductPageResult', function() {
    it('should create an instance of ProductPageResult', function() {
      // uncomment below and update the code to test ProductPageResult
      //var instane = new FoodAuthentSwaggerApi.ProductPageResult();
      //expect(instance).to.be.a(FoodAuthentSwaggerApi.ProductPageResult);
    });
