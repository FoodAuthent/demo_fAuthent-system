...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FoodAuthentSwaggerApi.ModelPageResult();
  });
  ...
  describe('ModelPageResult', function() {
    it('should create an instance of ModelPageResult', function() {
      // uncomment below and update the code to test ModelPageResult
      //var instane = new FoodAuthentSwaggerApi.ModelPageResult();
      //expect(instance).to.be.a(FoodAuthentSwaggerApi.ModelPageResult);
    });
