...
<div id="sampleTable">
    <b-container fluid>
        ...
        <b-row>
            <!-- TABLE -->
            <b-table bordered striped hover show-empty responsive :sort-by.sync="sortBy" :sort-desc.sync="sortDesc" :items="items" :fields="fields" :current-page="currentPage" :per-page="perPage" @row-clicked="myRowClickHandler">
