package org.foodauthent.ui.vuejs;
...
public class ResourceServlet extends HttpServlet {
	...
	final String requestedResource = uri.substring(uri.lastIndexOf("/ui/") + 4);
	...
	final String resource = String.join("", "/wwwroot/", requestedResource, ".gz");
	URL url = getClass().getResource(resource);
	// use plain resource if .gz not found
	if (url == null) {
	    url = getClass().getResource(String.join("", "/wwwroot/", requestedResource));
	}
	return url;
    }
