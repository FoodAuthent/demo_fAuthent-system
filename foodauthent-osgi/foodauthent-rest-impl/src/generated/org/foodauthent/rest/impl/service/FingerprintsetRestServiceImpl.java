...
import org.foodauthent.rest.api.service.FingerprintsetRestService;
...
@Component(service = FingerprintsetRestService.class, immediate = true)
public class FingerprintsetRestServiceImpl implements FingerprintsetRestService {

	@Reference(cardinality = ReferenceCardinality.MANDATORY)
    private FingerprintsetService service;
