...
class ApiKeyUserPrincipal extends AbstractUserPrincipal {

	ApiKeyUserPrincipal(final String dn, final String userName, final String organizationIdentifier,
			final String organizationName, final String[] groups) {
		super(dn, userName, new ApiKeyOrganizationPrincipal(organizationIdentifier, organizationName),
				ApiKeyUserGroup.fromArray(groups));
	}

	ApiKeyUserPrincipal(final User user) {
