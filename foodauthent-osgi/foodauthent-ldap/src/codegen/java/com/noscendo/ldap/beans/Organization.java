...
/**
 * Ldaptive generated bean for objectClass 'organization'
 * 
 */
...
public class Organization {
    ...
    public String toString() {
        return String.format("[%s@%d::dn=%s, businessCategory=%s, description=%s, destinationIndicator=%s, facsimileTelephoneNumber=%s, internationaliSDNNumber=%s, localityName=%s, organization=%s, physicalDeliveryOfficeName=%s, postOfficeBox=%s, postalAddress=%s, postalCode=%s, preferredDeliveryMethod=%s, registeredAddress=%s, searchGuide=%s, seeAlso=%s, stateOrProvinceName=%s, street=%s, telephoneNumber=%s, teletexTerminalIdentifier=%s, telexNumber=%s, x121Address=%s]", this.getClass().getName(), this.hashCode(), this.dn, this.businessCategory, this.description, this.destinationIndicator, this.facsimileTelephoneNumber, this.internationaliSDNNumber, this.localityName, this.organization, this.physicalDeliveryOfficeName, this.postOfficeBox, this.postalAddress, this.postalCode, this.preferredDeliveryMethod, this.registeredAddress, this.searchGuide, this.seeAlso, this.stateOrProvinceName, this.street, this.telephoneNumber, this.teletexTerminalIdentifier, this.telexNumber, this.x121Address);
    }
